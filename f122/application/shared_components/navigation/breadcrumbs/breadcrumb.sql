...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(555092294947260357)
,p_parent_id=>wwv_flow_imp.id(208969651270360287)
,p_short_name=>unistr('Ubicaciones de Art\00EDculos en Dep\00F3sito')
,p_long_name=>unistr('Ubicaciones de Art\00EDculos en Dep\00F3sito')
