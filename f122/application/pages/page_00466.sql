...
,p_last_upd_yyyymmddhh24miss=>'20230713083754'
);
...
'BEGIN',
'       FOR C IN (select ID_IMG,NRO_IMG,ID_DIRECT,DIRECTORIO,ARCHIVO,IMAGEN,DIR_NAME, MIME_TYPE, :P466_OPERACION||''-''||:P466_ID_IMAGEN||''_''||TO_CHAR(SYSDATE,''DDMMYYYYhh24miss'')||''_''||ARCHIVO RENOMARCHIVO from V_IMAGEN_APEX) LOOP ',
'                   ',
'                   V_IMAGE := C.IMAGEN;',
'',
