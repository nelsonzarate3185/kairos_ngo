...
,p_last_upd_yyyymmddhh24miss=>'20230926145915'
);
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(206985898399678641)
,p_report_id=>wwv_flow_imp.id(17649308803581079)
,p_condition_type=>'FILTER'
,p_allow_delete=>'Y'
,p_column_name=>'DESC_ESTADO_FACTURA'
,p_operator=>'='
,p_expr=>'ACTIVO'
,p_condition_sql=>'"DESC_ESTADO_FACTURA" = #APXWS_EXPR#'
,p_condition_display=>'#APXWS_COL_NAME# = ''ACTIVO''  '
,p_enabled=>'Y'
);
wwv_flow_imp_page.create_page_plug(
