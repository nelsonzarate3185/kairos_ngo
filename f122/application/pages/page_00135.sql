...
,p_last_upd_yyyymmddhh24miss=>'20231229090651'
);
...
' WHERE E.COD_EMPRESA = ''1''----:VARIABLES.COD_EMPRESA',
...
'select cod_articulo||'' - ''||trim(descripcion)descripcion,  cod_articulo',
'from  st_articulos ',
'where cod_empresa=''1''/*:variables.cod_empresa*/ order by cod_articulo'))
,p_lov_display_null=>'YES'
,p_lov_null_text=>'-N/A-'
,p_cSize=>32
,p_cMaxlength=>30
...
'             INTO VEXISTE',
'           FROM ST_ARTICULOS ',
'          WHERE COD_EMPRESA = ''1''-----:VARIABLES.COD_EMPRESA',
...
':P135_P_CAMBIA_FOB         := ''N'';--busca_permiso( NVL(:P_COD_EMPRESA, ''1''),''STARTICU'',:APP_USER,''CAMBIA_FOB'' );',
':P135_P_CAMBIA_PRECIO      := ''N'';--busca_permiso( NVL(:P_COD_EMPRESA, ''1''),''STARTICU'',:APP_USER,''CAMBIA_PRECIO'' );',
':P135_P_MODIFICA_ARTICULOS := ''N'';--busca_permiso( NVL(:P_COD_EMPRESA, ''1''),''STARTICU'',:APP_USER,''MODIFICA_ARTICULOS'' );',
':P135_P_VE_AUD             := ''N'';--busca_permiso( NVL(:P_COD_EMPRESA, ''1''),''STARTICU'',:APP_USER,''VER_AUDITORIA'' );',
'----:P135_P_COD_ARTICULO :=''EDABSX16'';'))
...
'ELSE',
'',
' inv.STARTICU.BUSCA_ARTICULO(''1'',:P135_P_COD_ARTICULO,:P135_COD_ART_CORTO ,',
'                    :P135_COD_EAN ,',
'                    :P135_DESCRIPCION ,',
