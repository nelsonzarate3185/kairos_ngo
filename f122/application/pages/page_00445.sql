...
'',
'                        if ($v("P_COD_USUARIO")===''MONICACAB'' || $v("P_COD_USUARIO")===''ERIVALDO''|| $v("P_COD_USUARIO")===''JUANSA''){ 	     		',
'                                document.getElementById("verificado").disabled = false; ',
'                                document.getElementById("aprobado").disabled = false;  	',
'                        }',
'                }',
...
'                document.getElementById("modificar").disabled = false;',
'',
'                if ( $v("P_COD_USUARIO")===''ERIVALDO'' || $v("P_COD_USUARIO")===''MONICACAB''|| $v("P_COD_USUARIO")===''JUANSA''){ 	     		',
'                                document.getElementById("aprobado").disabled = false; ',
'                    }',
'             }',
'            ',
...
,p_last_upd_yyyymmddhh24miss=>'20230713092657'
);
...
'FROM PERSONAS ',
'WHERE COD_PERSONA IN (''304020'',''347817'',''377123'',''387071'',''387087'')'))
