...
,p_last_upd_yyyymmddhh24miss=>'20231123160005'
);
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(12811993597539003)
...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'PROVEEDOR:NRO_COMPROBANTE:POSICION:ORIGEN:TIPO_DESC:'
,p_break_on=>'ORIGEN:PROVEEDOR:0:0:0:0'
,p_break_enabled_on=>'ORIGEN:PROVEEDOR:0:0:0:0'
