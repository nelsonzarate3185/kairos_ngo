...
,p_last_upd_yyyymmddhh24miss=>'20231122085147'
);
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(195165281863515592)
,p_query_column_id=>1
,p_column_alias=>'ROWID'
,p_column_display_sequence=>1
,p_column_heading=>'<span class="u-VisuallyHidden">Edit</span>'
,p_use_as_row_header=>'N'
,p_column_link=>'f?p=&APP_ID.:588:&APP_SESSION.::&DEBUG.:RP:P588_ROWID:#ROWID#'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(195171221275515590)
