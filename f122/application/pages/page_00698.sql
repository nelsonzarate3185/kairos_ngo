...
,p_last_upd_yyyymmddhh24miss=>'20240202173328'
);
...
'where (/*:P698_PERSONA IS NULL OR*/ cod_persona = :P698_PERSONA )',
'and   (:P698_SER_VIATICO IS NULL OR SER = :P698_SER_VIATICO )',
'and   (:P698_NRO_VIATICO IS NULL OR NRO = :P698_NRO_VIATICO )'))
,p_plug_source_type=>'NATIVE_IR'
,p_ajax_items_to_submit=>'P698_PERSONA,P698_SER_VIATICO,P698_NRO_VIATICO'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_plug_column_width=>' '
...
'AND NVL(I.COD_IDENT,''CI'')=''CI''',
'AND NVL(R.COD_IDENT,''RUC'')=''RUC''',
'order by nombre',
''))
,p_lov_display_null=>'YES'
,p_cSize=>30
...
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_attribute_01=>'$(''#upimag'').attr(''src'',''http://192.168.15.88:8080/apex_ngodes/ngotest/img/getimg/''+$v(''P698_VER_IMG'')); '
);
wwv_flow_imp_page.create_page_da_action(
