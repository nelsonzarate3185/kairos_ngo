...
,p_last_upd_yyyymmddhh24miss=>'20230509105117'
);
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(40228378075418339)
,p_validation_name=>'VA_NOMB_VALIDA_CARACTERES'
,p_validation_sequence=>20
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'DECLARE',
'    vCant NUMBER := 0;',
'BEGIN',
'    select REGEXP_INSTR(:P6_NOMB, ''^[-]?[0-9]+'')',
'      into vCant',
'      from dual;',
'',
'    --apex_debug.error(''Cantidad: ''||vCant);  ',
'    if vCant > 0 then',
'        RETURN FALSE;',
'    end if;',
'    select REGEXP_INSTR(:P6_NOMB, ''[0-9]'')',
...
'      from dual;',
'',
'   -- apex_debug.error(''Cantidad 2: ''||vCant);  ',
'    if vCant > 0 then',
'        RETURN FALSE;',
'    end if;',
'',
...
'   -- apex_debug.error(''Excepcion general: ''||vCant);  ',
'    RETURN FALSE;',
'END;'))
,p_validation2=>'PLSQL'
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>unistr('El campo no puede contener caracteres num\00E9ricos.')
,p_associated_item=>wwv_flow_imp.id(40227082131418326)
,p_error_display_location=>'INLINE_WITH_FIELD'
);
wwv_flow_imp_page.create_page_validation(
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(40228490317418340)
,p_validation_name=>'VA_APEL_VALIDA_CARACTERES'
,p_validation_sequence=>40
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'DECLARE',
'    vCant NUMBER := 0;',
'BEGIN',
'    select REGEXP_INSTR(:P6_APEL, ''^[-]?[0-9]+'')',
'      into vCant',
'      from dual;',
'',
'    if vCant > 0 then',
