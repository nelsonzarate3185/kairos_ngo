...
,p_last_upd_yyyymmddhh24miss=>'20230522111416'
);
...
,p_branch_action=>'f?p=&APP_ID.:365:&SESSION.::&DEBUG.:365:P365_P_NRO:&P365_P_NRO.&success_msg=#SUCCESS_MSG#'
...
,p_action=>'NATIVE_CLEAR'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P365_DESTINO,P365_ESTADO,P365_COD_ARTICULO,P365_FICHA,P365_FECHA,P365_GARANTIA,P365_SERIE,P365_NRO_ENVIO,P365_USUARIO,P365_COD_CORTO,P365_DESCRIPCION,P365_SER_OT,P365_NRO_OT'
);
wwv_flow_imp_page.create_page_da_action(
...
'    	where cant_dispon>0',
'    	and (( ee.cod_sucursal= :P365_SUC_SAL_CAR  AND :P365_DESTINO = ''CARNEO'') OR ( ee.cod_sucursal= :P365_SUC_SAL_DES AND :P365_DESTINO =''DESPIECE'') )',
