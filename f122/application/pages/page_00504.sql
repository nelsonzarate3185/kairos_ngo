...
,p_last_upd_yyyymmddhh24miss=>'20230512105610'
);
...
,p_parent_plug_id=>wwv_flow_imp.id(152872780773770507)
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_plug_template=>wwv_flow_imp.id(40125238939263661)
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(152872944229770509)
,p_plug_name=>'MID'
,p_parent_plug_id=>wwv_flow_imp.id(152872780773770507)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(40096829222263653)
...
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(152872944229770509)
,p_prompt=>'Fec Alta'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_tag_attributes=>'ReadOnly'
...
'  WHEN OTHERS THEN  ',
'        APEX_DEBUG.ERROR(''Error COD_ART_CORTO. '' || SQLERRM);  ',
'END ;',
''))
...
unistr('    APEX_DEBUG.ERROR(''No se encuentra c\00F3digo de l\00EDnea. '' || SQLERRM);'),
'',
'  WHEN OTHERS THEN',
'    :P504_COD_CATEGORIA := NULL;',
'    APEX_DEBUG.ERROR(''Error en la tabla Lineas. '' || SQLERRM);',
'END;',
'',
'',
'',
...
||'OTES,P504_IND_MANTENIMIENTO,P504_GARANTIA,P504_MANEJA_COSTO,P504_IND_NO_DESCUENTO,P504_IND_DISCONTINUADO,P504_IND_NO_CUBRE_GARANTIA,P504_IND_MUESTRA_WEB,P504_IND_PARTICULAR,P504_IND_TECNICO_29,P504_IND_CICLO_VIDA'
,p_attribute_04=>'N'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
...
'    WHEN NO_DATA_FOUND THEN',
'        :P504_DESC_IVA := NULL;',
unistr('        APEX_DEBUG.ERROR(''No se encuentra c\00F3digo de iva'' || SQLERRM);'),
'    WHEN OTHERS THEN',
'        APEX_DEBUG.ERROR(''Error en la tabla de Iva'' || SQLERRM);        ',
'END;'))
