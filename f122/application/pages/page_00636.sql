...
,p_last_upd_yyyymmddhh24miss=>'20240109172923'
);
...
'                                                 when ''S'' then ''checked ''',
'                                             else null',
'                                                 end ) ||''onclick="seleccionar(this)"'' ) as checkbox2,',
'',
...
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'EDITAR:COD_SUCURSAL:COD_BLOQUE:COD_SUB_BLOQUE:COD_ESTANTE:COD_CUERPO:COD_NIVEL:FECHA_ALTA:COD_POSICION:CHECKBOX:CHECKBOX2:IMP_ETIQUETA:ELIMINAR:'
);
wwv_flow_imp_page.create_page_plug(
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(220284680322379707)
...
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'if :P636_COD_BLOQUE_AUX is not null then',
'	',
'	  DECLARE',
...
'		END;',
'end if;'))
,p_attribute_02=>'P636_COD_BLOQUE_AUX'
...
'',
'END;'))
,p_attribute_02=>'P636_TIPO,P636_COD_EMPRESA,P636_COD_SUC_DEPOSITO,P636_COD_BLOQUE_AUX,P636_COD_SUB_BLOQUE,P636_COD_ESTANTE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(219745831967610217)
,p_name=>'DA_PAGE_LOAD'
,p_event_sequence=>80
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(219745978238610218)
,p_event_id=>wwv_flow_imp.id(219745831967610217)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_HIDE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(220286455586379725)
,p_event_id=>wwv_flow_imp.id(219745831967610217)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
,p_attribute_03=>'P636_COD_BLOQUE_AUX,P636_COD_ESTANTE_AUX,P636_COD_SUB_BLOQUE_AUX,P636_COD_CUERPO_AUX,P636_COD_NIVEL_AUX,P636_DATOS_ALTA_AUX,P636_COD_POSICION_AUX'
,p_attribute_04=>'N'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
...
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'DECLARE',
'v_record_id NUMBER := :P636_ELIMINAR;',
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(221290825576777037)
,p_event_id=>wwv_flow_imp.id(219748723245610246)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
':P636_DATOS_ALTA_AUX := null;',
':P636_COD_POSICION_AUX := null;',
':P636_ERR := null;'))
,p_attribute_03=>'P636_EDITAR,P636_COD_SUCURSAL_AUX,P636_COD_BLOQUE_AUX,P636_COD_SUB_BLOQUE_AUX,P636_COD_ESTANTE_AUX,P636_COD_CUERPO_AUX,P636_COD_NIVEL_AUX,P636_DATOS_ALTA_AUX,P636_COD_POSICION_AUX,P636_ERR,P636_DESC_SUCURSAL_AUX,P636_DESC_BLOQUE_AUX,P636_DESC_SUB_BLO'
||'QUE_AUX'
,p_attribute_04=>'N'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(220288802090379749)
,p_name=>'DA_GUARDAR'
,p_event_sequence=>210
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(220284680322379707)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(221288762707777016)
,p_event_id=>wwv_flow_imp.id(220288802090379749)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_CONFIRM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(220288940917379750)
,p_event_id=>wwv_flow_imp.id(220288802090379749)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
'',
'   :P636_ERR := null;',
'   -- APEX_DEBUG.ERROR(''DESPUES DE EDITAR'' || SQLERRM);    ',
'    IF :P636_COD_BLOQUE_AUX is not null and :P636_COD_SUB_BLOQUE_AUX is not null',
'        and :P636_COD_ESTANTE_AUX is not null and :P636_COD_CUERPO_AUX is not null and :P636_COD_NIVEL_AUX is not null ',
'        and :P636_DATOS_ALTA_AUX is not null then',
'',
'            V_CODIGO := V_COD_SUCURSAL||''-''||:P636_COD_BLOQUE_AUX||''-''|| :P636_COD_SUB_BLOQUE_AUX ||''-''|| :P636_COD_ESTANTE_AUX ||''-''||',
'            :P636_COD_CUERPO_AUX ||''-''|| :P636_COD_NIVEL_AUX;',
'            ',
'            STPOSICI.PR_UPDATE_DETALLE(',
'                       PI_SEQ => :P636_EDITAR,   ',
'                       PI_COD_BLOQUE => :P636_COD_BLOQUE_AUX,',
'                       PI_COD_SUB_BLOQUE => :P636_COD_SUB_BLOQUE_AUX,',
'                       PI_COD_ESTANTE => :P636_COD_ESTANTE_AUX,',
'                       PI_COD_CUERPO => :P636_COD_CUERPO_AUX,',
'                       PI_COD_NIVEL => :P636_COD_NIVEL_AUX,',
'                       PI_FECHA_ALTA => :P636_DATOS_ALTA_AUX,',
...
'',
'END;'))
,p_attribute_02=>'P636_COD_SUCURSAL_AUX,P636_COD_BLOQUE_AUX,P636_COD_SUB_BLOQUE_AUX,P636_COD_ESTANTE_AUX,P636_COD_CUERPO_AUX,P636_COD_NIVEL_AUX,P636_DATOS_ALTA_AUX,P636_COD_POSICION_AUX,P636_EDITAR'
,p_attribute_03=>'P636_ERR'
,p_attribute_04=>'N'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(224286364258155418)
,p_event_id=>wwv_flow_imp.id(220288802090379749)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'BEGIN',
'    FOR C IN (SELECT   C001 cod_sucursal,',
'                       C002 cod_bloque,',
'                       C003 cod_sub_bloque,',
'                       C004 cod_estante,',
'                       C005 cod_cuerpo,',
...
'    LOOP',
'    APEX_COLLECTION.UPDATE_MEMBER(P_COLLECTION_NAME => ''ST_BLOQUES'',',
'                                         P_SEQ => :P636_EDITAR_AUX,   ',
'                                         P_C002 => c.cod_bloque, ',
'                                         P_C003 => c.cod_sub_bloque ,',
'                                         P_C004 => c.cod_estante, ',
'                                         P_C005 => c.cod_cuerpo ,',
'                                         P_C006 => c.cod_nivel, ',
'                                         P_C007 => c.cod_posicion,',
'                                         P_C008 => c.alto_mts,',
'                                         P_C009 => c.ancho_mts,',
'                                         P_C010 => c.largo_mts,',
'                                         P_C011 => c.peso_kg,',
'                                         P_C012 => c.fecha_alta,',
'                                         P_C013 => c.fecha_baja,',
'                                         P_C014 => c.cod_usuario_alta,',
'                                         P_C015 => c.estado,',
'                                         P_C016 => c.cod_usuario_baja,',
'                                         P_C017 => c.ind_migrado_os,',
'                                         P_C018 => c.reg_id_orden,',
'                                         P_C019 => c.ind_celda,',
'                                         P_C020 => c.cod_responsable,',
'                                         P_C021 => c.r_id,',
'                                         P_C035 => :P_COD_EMPRESA  );',
'    END LOOP;',
'END;'))
,p_attribute_02=>'P636_EDITAR_AUX'
,p_attribute_03=>'P636_EDITAR_AUX'
,p_attribute_04=>'N'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
,p_server_condition_type=>'NEVER'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(221287381745777002)
,p_event_id=>wwv_flow_imp.id(220288802090379749)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(221287475905777003)
,p_event_id=>wwv_flow_imp.id(220288802090379749)
,p_event_result=>'TRUE'
,p_action_sequence=>50
,p_execute_on_page_init=>'N'
...
'and seq_id = :P636_EDITAR_AUX;'))
,p_attribute_02=>'P636_EDITAR'
,p_attribute_03=>'P636_COD_SUCURSAL_AUX,P636_COD_BLOQUE_AUX,P636_COD_SUB_BLOQUE_AUX,P636_COD_ESTANTE_AUX,P636_COD_CUERPO_AUX,P636_COD_NIVEL_AUX,P636_DATOS_ALTA_AUX,P636_COD_POSICION_AUX'
,p_attribute_04=>'N'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(221288561216777014)
,p_event_id=>wwv_flow_imp.id(221288472335777013)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_CONFIRM'
,p_attribute_01=>unistr('\00BFSeguro que deseas crear el registro?')
,p_attribute_03=>'information'
);
wwv_flow_imp_page.create_page_da_action(
...
'       P_C007 => V_CODIGO,',
'       P_C008 => :P636_ALTO_MTS,',
'       P_C009 => :P636_ANCHO_MTS,',
'       P_C010 => :P636_LARGO_MTS,',
'       P_C011 => :P636_PESO_KG,',
'       P_C012 => :P636_DATOS_ALTA_AUX,',
'       P_C013 => :P636_FECHA_BAJA,',
'       P_C014 => :P636_COD_USUARIO_ALTA,',
'       P_C015 => :P636_CHECKBOX_ESTADO,',
'       P_C016 => :P636_COD_USUARIO_BAJA,',
'       P_C017 => :P636_IND_MIGRADO_OS,',
'       P_C018 => :P636_REG_ID_ORDEN,',
'       P_C019 => :P636_IND_CELDA,',
'       P_C020 => :P636_COD_RESPONSABLE_AUX,',
'       P_C035 => :P_COD_EMPRESA,',
'       P_c050 => ''I''); --  V_CODIGO como P_C036',
'',
'       STPOSICI.PR_GUARDAR_DATOS;',
'',
'',
'',
'   ',
...
'END;',
''))
,p_attribute_02=>'P636_COD_SUCURSAL_AUX,P636_COD_BLOQUE_AUX,P636_COD_SUB_BLOQUE_AUX,P636_COD_ESTANTE_AUX,P636_COD_CUERPO_AUX,P636_COD_NIVEL_AUX,P636_COD_POSICION_AUX,P636_ALTO_MTS,P636_ANCHO_MTS,P636_LARGO_MTS,P636_PESO_KG,P636_DATOS_ALTA_AUX,P636_CHECKBOX_ESTADO,P636'
||'_COD_USUARIO_BAJA,P636_IND_MIGRADO_OS,P636_REG_ID_ORDEN,P636_IND_CELDA,P636_COD_RESPONSABLE_AUX'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
wwv_flow_imp_page.create_page_da_action(
...
'	  end if;',
'	  ',
'	  if :P636_COD_BLOQUE_AUX is null then',
unistr('	  	  :P636_ERR := ''El c\00F3digo de bloque no puede ser nulo. Favor ingrese el dato. '';'),
'	  end if;',
'	  ',
'	  DECLARE',
...
'					  SET_ALERT_BUTTON_PROPERTY( valerta, ALERT_BUTTON1, LABEL, ''Aceptar'' );',
'					  SET_ALERT_BUTTON_PROPERTY( valerta, ALERT_BUTTON2, LABEL, ''Cancelar'' );',
'					  alerta( ''El sub-bloque ''||:P636_COD_SUB_BLOQUE_AUX||'' ya tiene asignado como responsable a ''||vdesc_responsable||',
unistr('					          ''\00BFDesea continuar?'',''Responsables de posiciones'',1, i);'),
'					  SET_ALERT_BUTTON_PROPERTY( valerta, ALERT_BUTTON1, LABEL, ''Aceptar'' );',
'					  SET_ALERT_BUTTON_PROPERTY( valerta, ALERT_BUTTON2, LABEL, '''' );',
'					  ',
...
'		END;',
'end if;'))
,p_attribute_02=>'P636_COD_BLOQUE_AUX,P636_COD_SUB_BLOQUE_AUX,P636_COD_SUCURSAL_AUX'
