...
,p_last_upd_yyyymmddhh24miss=>'20231020104018'
);
...
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'SELECT  C001 CODIGO',
'       ,REPLACE(C002,''OTRAS MARCAS'',''FACTURACION'') NOMBRE_DESCRIPCION ',
'       ,N001 BASE_COMISION',
'       ,N002 PORC_PESO  ',
'       ,N003 OBJETIVO',
'       ,N004 VTA_TOTAL',
...
'    VANIO  VARCHAR2(10);',
'begin ',
'         select to_char(P.FEC_INICIAL,''MM''),to_char(P.FEC_INICIAL,''YYYY'')',
'         INTO VMES, VANIO',
