...
,p_last_upd_yyyymmddhh24miss=>'20231010123207'
);
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(171359067890796142)
,p_db_column_name=>'MONTO2'
,p_display_order=>100
,p_column_identifier=>'J'
,p_column_label=>'Monto2'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_use_as_row_header=>'N'
);
...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'COD_VENDEDOR:FEC_INICIAL:FEC_FINAL:MONTO:MONTO2:EDITAR:ELIMINAR:'
);
wwv_flow_imp_page.create_page_plug(
...
,p_button_plug_id=>wwv_flow_imp.id(49165178352859546)
...
,p_branch_action=>'f?p=&APP_ID.:216:&SESSION.::&DEBUG.:Y,:P216_FEC_INICIO,P216_FEC_FIN:&P212_INICIO.,&P212_FIN.&success_msg=#SUCCESS_MSG#'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(50485747900520912)
,p_name=>'P212_PERIODO'
,p_item_sequence=>20
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(50485853669520913)
,p_name=>'P212_INICIO'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(50485670057520911)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(50485905406520914)
,p_name=>'P212_FIN'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(50485670057520911)
,p_prompt=>'Fecha Fin'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(50576901497785816)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(50577021337785817)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(50577408442785821)
,p_name=>'P212_INDICADOR_ALERT'
,p_item_sequence=>230
,p_item_plug_id=>wwv_flow_imp.id(49165178352859546)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(171356570889796117)
,p_name=>'P212_TIPO'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(50485670057520911)
...
'END;'))
,p_attribute_02=>'P212_PERIODO,P212_INICIO,P212_FIN'
,p_attribute_03=>'P212_INICIO,P212_FIN'
,p_attribute_04=>'N'
...
'BEGIN',
'',
'    IF :P212_INICIO IS NULL OR :P212_FIN IS NULL THEN',
'        :P212_INDICADOR_ALERT := ''1'';',
'    ELSE',
'        :P212_INDICADOR_ALERT := ''0'';',
'        :P212_FEC_INICIO_CR_ED := :P212_INICIO;',
'        :P212_FEC_FIN_CR_ED := :P212_FIN;',
'    END IF;',
'',
'EXCEPTION',
'    WHEN OTHERS THEN',
...
'END;'))
,p_attribute_02=>'P212_FIN,P212_INICIO,P212_INDICADOR_ALERT'
,p_attribute_03=>'P212_FEC_INICIO_CR_ED,P212_FEC_FIN_CR_ED,P212_INDICADOR_ALERT'
,p_attribute_04=>'N'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
...
,p_client_condition_element=>'P212_INDICADOR_ALERT'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(50577743793785824)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(50577868367785825)
,p_event_id=>wwv_flow_imp.id(50489591110520950)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
'BEGIN',
'',
'    IF :P212_COD_VENDEDOR_CR_ED IS NULL OR :P212_MONTO_CR_ED IS NULL THEN',
'        :P212_INDICADOR_ALERT := ''1'';',
'    ELSE',
'        :P212_INDICADOR_ALERT := ''0'';',
...
'        APEX_DEBUG.ERROR(SQLERRM);',
'END;'))
,p_attribute_02=>'P212_INDICADOR_ALERT,P_COD_EMPRESA,P212_COD_VENDEDOR_CR_ED,P212_FEC_INICIO_CR_ED,P212_FEC_FIN_CR_ED,P212_MONTO_CR_ED'
,p_attribute_03=>'P212_INDICADOR_ALERT'
,p_attribute_04=>'N'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
...
,p_attribute_03=>'P212_COD_VENDEDOR_CR_ED,P212_FEC_INICIO_CR_ED,P212_FEC_FIN_CR_ED,P212_MONTO_CR_ED'
,p_attribute_04=>'N'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
...
'        --APEX_DEBUG.ERROR(:P212_SEQ_ID_EDITAR);',
...
'        APEX_DEBUG.ERROR(SQLERRM);',
'END;'))
,p_attribute_02=>'P212_INDICADOR_ALERT,P_COD_EMPRESA,P212_COD_VENDEDOR_CR_ED,P212_FEC_INICIO_CR_ED,P212_FEC_FIN_CR_ED,P212_MONTO_CR_ED,P212_SEQ_ID_EDITAR'
,p_attribute_03=>'P212_INDICADOR_ALERT'
,p_attribute_04=>'N'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
...
,p_event_id=>wwv_flow_imp.id(52576204610271012)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
'BEGIN',
' ',
'        FVMETVEN.pr_crear_col_vendedor ( :P212_INICIO,',
'                                         :P212_FIN,',
'                                         :P_COD_EMPRESA);',
'                                        ',
'',
...
'',
''))
,p_attribute_02=>'P212_INICIO,P212_FIN,P_COD_EMPRESA'
...
,p_name=>'DA_LIMPIA_FECHA1'
,p_event_sequence=>140
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P212_MES'
,p_condition_element=>'P212_MES'
,p_triggering_condition_type=>'NOT_NULL'
,p_bind_type=>'bind'
,p_bind_event_type=>'change'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(171357888031796130)
...
,p_action=>'NATIVE_CLEAR'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P212_INICIO,P212_FIN,P212_ANIO'
);
wwv_flow_imp_page.create_page_da_event(
...
,p_action=>'NATIVE_CLEAR'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P212_PERIODO,P212_INICIO,P212_MES,P212_ANIO,P212_FIN'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(171358656943796138)
,p_name=>'DA_SETEA_FECHA'
,p_event_sequence=>160
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P212_ANIO'
,p_condition_element=>'P212_ANIO'
,p_triggering_condition_type=>'NOT_NULL'
,p_bind_type=>'bind'
,p_bind_event_type=>'change'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(171358768002796139)
...
'BEGIN',
'',
'    IF :P212_MES IS NOT NULL THEN ',
'    	BEGIN',
'                select to_date(''01''||''/''||:P212_mes||''/''||:P212_anio,''DD/MM/YYYY''),LAST_DAY(to_date(''01''||''/''||:P212_mes||''/''||:P212_anio,''DD/MM/YYYY''))',
'                INTO 	:P212_INICIO, :P212_FIN',
'                from dual;',
' ',
'    		EXCEPTION ',
...
'        APEX_DEBUG.ERROR(SQLERRM);',
'END;'))
,p_attribute_02=>'P212_INICIO,P212_MES,P212_ANIO,P212_FIN'
,p_attribute_03=>'P212_INICIO,P212_FIN'
,p_attribute_04=>'N'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
...
'        APEX_DEBUG.ERROR(SQLERRM);',
'END;'))
,p_attribute_02=>'P216_FEC_INICIO,P212_FIN'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
