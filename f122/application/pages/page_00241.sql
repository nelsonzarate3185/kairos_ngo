...
,p_last_upd_yyyymmddhh24miss=>'20230510083802'
);
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(61220566445647315)
,p_validation_name=>'VI_FECHAS_MAYOR_MENOR'
,p_validation_sequence=>30
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'BEGIN',
'',
'    IF :P241_FECHA_INICIO < :P241_FECHA_FIN THEN',
'        RETURN TRUE;',
'    ELSE',
'        RETURN FALSE;',
'    END IF;',
...
'    	WHERE s.cod_empresa= :P241_COD_EMPRESA',
