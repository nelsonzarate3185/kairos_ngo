...
,p_last_upd_yyyymmddhh24miss=>'20240124144355'
);
...
,p_sum_columns_on_break=>'IMP_COMISION:BASE_COMISION:PORC_PESO:OBJETIVO:VTA_TOTAL'
);
wwv_flow_imp_page.create_page_plug(
...
,p_column_type=>'NUMBER'
,p_column_alignment=>'CENTER'
,p_format_mask=>'999G999G999G990D90'
,p_use_as_row_header=>'N'
);
wwv_flow_imp_page.create_worksheet_column(
...
'  and ( ( v.cod_vendedor = :P580_VENDEDOR and :P580_VENDEDOR not in (''94'',''73'',''151''))',
'        or ',
'        (:P580_VENDEDOR in (''94'',''73'',''151'') and EXISTS (SELECT DISTINCT ''1''',
'                                                    FROM FV_AGRUPACION_VENDEDORES_VEN g',
'                                                    WHERE g.COD_VENDEDOR=:P580_VENDEDOR',
'                                                    AND g.COD_VENDEDOR_REL= v.cod_vendedor',
'                                                    AND g.COD_EMPRESA=''1'')',
'        )',
'      )'))
,p_ajax_enabled=>'Y'
...
'',
' ',
'               :P580_VTA_TOTAL :=inv.fvcomisionp.fn_cancula_vtas(:P580_VENDEDOR,:P580_MES,:P580_ANIO);',
'        END IF;',
'    END IF;',
'EXCEPTION',
'    WHEN VERROR THEN',
...
'',
'',
'              inv.fvcomisionp.pr_genera_comision(:P580_VENDEDOR,:P580_MES,:P580_ANIO,vmensaje);',
'',
'',
'                if vmensaje is not null then',
'                    raise verror;',
