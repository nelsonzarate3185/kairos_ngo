...
,p_last_upd_yyyymmddhh24miss=>'20231229083452'
);
...
'select NRO_PROMO,FECHA,ESTADO,NRO_DESPACHO,NRO_EMBARQUE, COD_USUARIO creado_por, USUARIO_VERIFICACION verificado_por,',
'USUARIO_AUT_COMERCIAL,USUARIO_CONFIRMADO_DEPOSITO,USUARIO_CONFIRMADO_COMERCIAL,',
'(select m.descripcion from fv_margen_det d, st_articulos s, st_marcas m where d.cod_empresa=c.cod_empresa and c.nro_promo=d.nro_promo and d.cod_empresa=s.cod_empresa and d.cod_articulo=s.cod_articulo and s.cod_marca=m.cod_marca and rownum=1) marca',
'  ',
'',
' from inv.Fv_Margen_CAB c',
...
,p_detail_link=>'f?p=&APP_ID.:59:&SESSION.::&DEBUG.:59:P59_P_NRO_PROMO:#NRO_PROMO#'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(390609367591583050)
...
,p_is_default=>'Y'
,p_display_rows=>20
,p_report_columns=>'NRO_PROMO:FECHA:ESTADO:NRO_DESPACHO:NRO_EMBARQUE:MARCA:CREADO_POR:VERIFICADO_POR:USUARIO_AUT_COMERCIAL:USUARIO_CONFIRMADO_COMERCIAL:'
