...
,p_dialog_height=>'1550'
,p_dialog_width=>'1150'
,p_protection_level=>'C'
,p_page_component_map=>'18'
,p_last_updated_by=>'FCARDOZO'
,p_last_upd_yyyymmddhh24miss=>'20230904140356'
);
...
,p_prn_page_header=>'AGENDA DE VISITAS'
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(80548192647746017)
...
,p_owner=>'EMILIANOP'
,p_internal_uid=>80548192647746017
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(80548244797746018)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(80548311611746019)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(80548463692746020)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(80548563561746021)
,p_db_column_name=>'CLIENTE_FINAL'
,p_display_order=>40
,p_column_identifier=>'D'
,p_column_label=>'Cliente Final'
,p_column_type=>'STRING'
,p_column_alignment=>'CENTER'
,p_use_as_row_header=>'N'
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(80548643825746022)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(80548796795746023)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(80548866324746024)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(80548945740746025)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(80549010328746026)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(80549154210746027)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(81605854431131037)
,p_db_column_name=>'UBICACION'
,p_display_order=>110
,p_column_identifier=>'K'
,p_column_label=>'Ver Ubicacion'
,p_column_link=>'javascript:$s(''P329_VER_UBIC_ROW_ID'',''#ROW_ID#'');'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(81605949378131038)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(80647466185262143)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'806475'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'DIA:FEC_VISITA:HORA_VISITA:COD_CLIENTE:COD_ARTICULO:CLIENTE_FINAL:DIRECCION:COORDENADAS:UBICACION:'
);
wwv_flow_imp_page.create_page_plug(
...
,p_button_template_id=>wwv_flow_imp.id(40187749278263678)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Guardar Movimiento'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(201060481031163725)
,p_branch_name=>'GO TO PAGE 596'
,p_branch_action=>'f?p=&APP_ID.:596:&SESSION.::&DEBUG.:596::&success_msg=#SUCCESS_MSG#'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(201058133473163702)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(201059527048163716)
,p_name=>'P329_URL'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(79902535578686307)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(201060524201163726)
,p_name=>'P329_LON'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(79902535578686307)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(201060651912163727)
,p_name=>'P329_LAT'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(79902535578686307)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(201061248795163733)
,p_name=>'P329_BANDERA'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(79902535578686307)
,p_display_as=>'NATIVE_HIDDEN'
...
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'BEGIN',
'IF :P329_FEC_VISITA IS NOT NULL THEN',
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(201061197356163732)
...
,p_attribute_03=>'P329_NRO_MOVIMIENTO,P329_BANDERA'
,p_attribute_04=>'N'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
,p_client_condition_type=>'EQUALS'
,p_client_condition_element=>'P329_ACCION_CONSULTA'
,p_client_condition_expression=>'3'
,p_server_condition_type=>'NEVER'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(201061375535163734)
,p_event_id=>wwv_flow_imp.id(81221136914464301)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
,p_attribute_01=>':P329_BANDERA:=1;'
,p_attribute_03=>'P329_BANDERA'
,p_attribute_04=>'N'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
,p_client_condition_type=>'EQUALS'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(201059462165163715)
,p_event_id=>wwv_flow_imp.id(81221136914464301)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'SELECT APEX_PAGE.GET_URL (  p_page   => 596,',
'                            p_items  => ''P596_ACTUALIZAR'',',
'                            p_values => (''''||1||'''')) f_url_1',
'    INTO :P329_URL',
'     FROM DUAL;',
''))
,p_attribute_03=>'P329_URL'
,p_attribute_04=>'N'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
,p_server_condition_type=>'NEVER'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(201060101101163722)
,p_event_id=>wwv_flow_imp.id(81221136914464301)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(201058237684163703)
,p_name=>'DA_SET_CONSULTA'
,p_event_sequence=>270
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P329_ACCION_CONSULTA'
,p_bind_type=>'bind'
,p_bind_event_type=>'change'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(201058399884163704)
,p_event_id=>wwv_flow_imp.id(201058237684163703)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
,p_attribute_01=>'NULL;'
,p_attribute_02=>'P329_ACCION_CONSULTA'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(201058413083163705)
,p_name=>'DA_ACCION_CONSULTA'
,p_event_sequence=>280
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P329_ACCION_CONSULTA'
,p_condition_element=>'P329_ACCION_CONSULTA'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(201058693826163707)
,p_event_id=>wwv_flow_imp.id(201058413083163705)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(201058916170163710)
,p_event_id=>wwv_flow_imp.id(201058413083163705)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
'           -- :P329_ID_VISITA_SF,  ',
'      from CA_VISITA_PROMOTOR',
'      where NRO_MOVIMIENTO = :P329_P_NRO_MOVIMIENTO;',
'      EXCEPTION',
'        when others then',
'        apex_debug.error(''error coleccion''||sqlerrm);',
'end;'))
,p_attribute_02=>'P329_P_NRO_MOVIMIENTO'
,p_attribute_03=>'P329_COD_USUARIO,P329_FEC_VISITA,P329_HORA_VISITA,P329_COD_CLIENTE,P329_CLIENTE_FINAL,P329_NRO_TELEF,P329_DIRECCION,P329_COORDENADAS,P329_COD_ARTICULO,P329_COD_PROMOTOR,P329_OBSERVACION,P329_ESTADO,P329_MOTIVO,P329_COD_SUCURSAL'
,p_attribute_04=>'N'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(201060210462163723)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(201060364331163724)
,p_event_id=>wwv_flow_imp.id(201060210462163723)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
,p_attribute_03=>'P329_FEC_VISITA,                  P329_HORA_VISITA,                     P329_COD_CLIENTE,    P329_CLIENTE_FINAL,P329_NRO_TELEF,  P329_DIRECCION,P329_COORDENADAS, P329_COD_ARTICULO,  P329_COD_PROMOTOR,  P329_OBSERVACION,P329_ESTADO,                 P3'
||'29_MOTIVO,  P329_COD_SUCURSAL,P329_COD_USUARIO,P329_INDICADOR_REPORT_VISITA'
,p_attribute_04=>'N'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(81221464457464304)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'PR_LIMPIAR_DATOS_INICIO'
...
'    vnumero NUMBER(8);',
'/*    BEGIN',
'    IF :P329_ACCION_CONSULTA=''3'' THEN',
'         BEGIN',
'',
'          SELECT max( nro_movimiento )',
'            INTO vnumero',
...
'         END;    ',
'END IF;    ',
'    APEX_DEBUG.ERROR(:P329_NRO_MOVIMIENTO||:P329_COD_PROMOTOR||:P329_COD_CLIENTE);',
...
'                                        PI_HORA_VISITA => TO_DATE(:P329_FEC_VISITA,''DD/MM/YYYY''),--TO_DATE(:P329_FEC_VISITA||'' ''||:P329_HORA_VISITA, ''DD/MM/YYYY HH24:MI''),          	',
