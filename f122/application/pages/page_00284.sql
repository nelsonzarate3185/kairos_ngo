...
,p_last_upd_yyyymmddhh24miss=>'20230725105011'
);
...
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'NRO_MOV:COD_VENDEDOR:NOMBRE:NRO_PROMO:DESCRIPCION:FEC_ALTA:FEC_CIERRE:NRO_FACTURA:CANTIDAD:PUNTOS_UNITARIOS:PUNTOS_VALE:PUNTOS:'
...
,p_button_template_id=>wwv_flow_imp.id(40187749278263678)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Conf. Importacion'
,p_button_position=>'EDIT'
);
wwv_flow_imp_page.create_page_button(
...
'                    PI_NRO_MOVIMIENTO              => :P284_AUX_REGISTRO,',
'                    PO_NRO_MOVIMIENTO              => :P284_NRO_MOVIMIENTO,',
'                    PI_FEC_CARGA                   => TO_DATE(:P284_FEC_CARGA,''DD/MM/YYYY''),',
'                    PI_COD_ARTICULO                => :P284_COD_ARTICULO,                     ',
...
'                    PI_COD_VENDEDOR                => :P284_COD_VENDEDOR,',
'                    PI_NRO_PROMO                   => :P284_NRO_PROMO,',
'                    PI_FEC_ALTA                    => TO_DATE(:P284_FEC_ALTA,''DD/MM/YYYY''),',
'                    PI_NRO_FACTURA                 => :P284_NRO_FACTURA,    ',
