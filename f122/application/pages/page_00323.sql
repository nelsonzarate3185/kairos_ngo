...
,p_name=>unistr('Notas de Env\00EDo - STENVIO')
,p_alias=>'STENVIO'
...
,p_last_upd_yyyymmddhh24miss=>'20230710120613'
);
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(80053438618183132)
,p_name=>'DA_SOLO_NUM'
,p_event_sequence=>80
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P323_CAB_REFERENCIA,P323_CANTIDAD'
,p_bind_type=>'bind'
,p_bind_event_type=>'keypress'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(80053504982183133)
,p_event_id=>wwv_flow_imp.id(80053438618183132)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
