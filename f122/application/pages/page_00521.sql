...
,p_last_upd_yyyymmddhh24miss=>'20230502114522'
);
...
'select distinct P.PROBLEMA_CABECERA||'' - ''||NVL( C.descripcion, ''Sin Datos'') D,',
'                P.PROBLEMA_CABECERA R',
'from problemas_conformidad C, CA_PROBLEMAS_CONFORMIDAD P',
'where C.cod_empresa   =  P.cod_empresa',
'and C.cod_motivo = P.PROBLEMA_CABECERA '))
,p_lov_display_null=>'YES'
,p_cSize=>30
,p_field_template=>wwv_flow_imp.id(40186634462263678)
,p_item_template_options=>'#DEFAULT#'
...
'                ESTADO = :P521_ESTADO,',
'                FECHA_ALTA = SYSDATE,',
'                CODIGO_USUARIO = :P521_COD_USUARIO,',
...
'',
'END;'))
,p_attribute_02=>'P521_EDITAR,P521_COD_MOTIVO,P521_MOTIVO,P521_PROBLEMA,P521_DEPARTAMENTO,P521_ESTADO,P521_COD_USUARIO,P521_COD_EMPRESA'
