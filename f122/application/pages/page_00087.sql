...
,p_last_upd_yyyymmddhh24miss=>'20240124114916'
);
...
'v.observation, ''NGO'' EMPRESA, V.LATITUD_LONGITUD, CASE WHEN COD_GRUPO= ''COBRA'' THEN ''C'' ',
...
'pc.nombre nombre, ',
'e.descripcion motivo,',
'v.observation, ''CPH'' EMPRESA, V.LATITUD_LONGITUD, CASE WHEN COD_GRUPO= ''COBRA'' THEN ''C'' ',
'  WHEN COD_GRUPO= ''PEDIDO'' THEN ''V'' ',
'      WHEN COD_GRUPO= ''PROM'' THEN ''P''  ELSE ''P'' END TIPO',
