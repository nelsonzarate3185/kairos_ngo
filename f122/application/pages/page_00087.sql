...
,p_last_upd_yyyymmddhh24miss=>'20230413125152'
);
...
'cus.descripcion nombre, ',
'e.descripcion motivo,',
'v.observation, ''NGO'' EMPRESA, V.LATITUD_LONGITUD',
' FROM cc_visit_cast V , cc_clientes cli, personas p,cc_estado_visita e, cc_custodios cus',
...
'cus.descripcion nombre, ',
'e.descripcion motivo,',
'v.observation, ''CPH'' EMPRESA, V.LATITUD_LONGITUD',
' FROM cc_visit_cast@dblink_cph V , cc_clientes@dblink_cph cli, personas@dblink_cph p,cc_estado_visita e, cc_custodios cus',
' where trunc(v.fecha_visita) between :P87_FECHA_DESDE AND :P87_FECHA_HASTA',
' AND (v.codigo_usuario = :P87_COD_usuario OR :P87_COD_usuario IS NULL) ',
'  AND (v.cod_usuario = :P87_COD_usuario OR :P87_COD_usuario IS NULL) ',
' and v.cod_empresa=''1''',
...
,p_ajax_enabled=>'Y'
,p_ajax_items_to_submit=>'P87_COD_USUARIO,P87_FECHA_DESDE,P87_FECHA_HASTA,P87_EMPRESA'
