...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'COD_SUCURSAL:COD_ART_CORTO:COD_ARTICULO:DESC_ARTICULO:FECHA_ALTA:FECHA_FACT:FECHA_ENTREGA:FACTURA:COD_CLIENTE:NOMBRE:PEDIDO:CANT_FACT:CANT_REM:CANT_NCR:SALDO:VOLUMEN:VENDEDOR_FACTURA:'
