...
,p_last_upd_yyyymmddhh24miss=>'20230626145829'
);
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(140553984336848723)
,p_name=>'P474_DESC_SUCURSAL'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(140553699305848720)
,p_prompt=>unistr('Descripci\00F3n Suc. Salida')
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(140554147862848725)
,p_name=>'P474_DESC_SUCURSAL_ENT'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(140553699305848720)
,p_prompt=>unistr('Descripci\00F3n Suc. Entrada')
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_named_lov=>'LV_SUC_ENT_STPEREPR'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(142010169535292805)
,p_name=>'P474_COD_ART_CORTO'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(142010856285292812)
,p_prompt=>'Cod. Corto'
,p_display_as=>'NATIVE_POPUP_LOV'
,p_named_lov=>'LV_ART_CORTO_STPEREPR'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(142010320286292807)
,p_name=>'P474_CANTIDAD_CONFIRMADA'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(142010856285292812)
,p_prompt=>'Cant. Conf.'
,p_display_as=>'NATIVE_TEXT_FIELD'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(142010453875292808)
,p_name=>'P474_NRO_ENVIO_PEND'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(142010856285292812)
,p_prompt=>'Nro Envio Pend'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_field_template=>wwv_flow_imp.id(40186937130263678)
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(142010524332292809)
,p_name=>'P474_SER_ENVIO_PEND'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(142010856285292812)
,p_prompt=>'Ser Envio Pend'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_begin_on_new_line=>'N'
,p_field_template=>wwv_flow_imp.id(40186937130263678)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(142013879030292842)
,p_name=>'P474_EDITAR'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_imp.id(140553699305848720)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(141423902868155326)
,p_name=>'DA_COD_SUCURSAL_SAL'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P474_COD_SUCURSAL_SAL'
,p_bind_type=>'bind'
,p_bind_event_type=>'change'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(141424027186155327)
,p_event_id=>wwv_flow_imp.id(141423902868155326)
,p_event_result=>'TRUE'
...
'  ',
'    select descripcion',
'    INTO :P474_DESC_SUCURSAL',
'    from sucursales ',
'    where cod_empresa = :p_cod_empresa ',
'    and ( (cod_sucursal = :P474_COD_SUCURSAL_SAL) );',
'    EXCEPTION',
'        WHEN OTHERS THEN',
'         APEX_DEBUG.ERROR(SQLERRM);',
'END;'))
,p_attribute_02=>'P474_COD_SUCURSAL_SAL'
,p_attribute_03=>'P474_DESC_SUCURSAL'
,p_attribute_04=>'N'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(141424237121155329)
,p_name=>'DA_COD_SUCURSAL_ENT'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P474_COD_SUCURSAL_ENT'
,p_bind_type=>'bind'
,p_bind_event_type=>'change'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(141424320552155330)
,p_event_id=>wwv_flow_imp.id(141424237121155329)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select descripcion ',
'INTO :P474_DESC_SUCURSAL_ENT',
'from sucursales ',
'where cod_empresa = :p_cod_empresa and cod_sucursal = :P474_COD_SUCURSAL_ENT; ',
''))
,p_attribute_02=>'P474_COD_SUCURSAL_ENT'
,p_attribute_03=>'P474_DESC_SUCURSAL_ENT'
,p_attribute_04=>'N'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
...
,p_attribute_03=>'P474_NRO_ENVIO_PEND,P474_SER_ENVIO_PEND,P474_IND_ANULADO,P474_COD_ART_CORTO,P474_COD_ARTICULO,P474_CANTIDAD,P474_CANTIDAD_CONFIRMADA'
,p_attribute_04=>'N'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
...
'    APEX_DEBUG.ERROR(''Entro a Agregar'');',
...
'                    PI_CANTIDAD_CONFIRMADA => :P474_CANTIDAD_CONFIRMADA,',
'                    PI_NRO_ENVIO_PEND => :P474_NRO_ENVIO_PEND,',
'                    PI_SER_ENVIO_PEND => :P474_SER_ENVIO_PEND,',
'                    PI_SER_COMPROBANTE => :P474_SER_COMPROBANTE,',
...
'',
'END;'))
,p_attribute_02=>'P474_COD_EMPRESA,P474_TIP_COMPROBANTE,P474_NRO_COMPROBANTE,P474_COD_ART_CORTO,P474_COD_ARTICULO,P474_CANTIDAD,P474_CANTIDAD_CONFIRMADA,P474_NRO_ENVIO_PEND,P474_SER_ENVIO_PEND,P474_SER_COMPROBANTE,P474_IND_ANULADO,P474_EDITAR_AUX,P474_SEQ_ID'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
wwv_flow_imp_page.create_page_da_action(
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(142013085859292834)
...
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
':P474_EDITAR_AUX:=null;',
':P474_NRO_COMPROBANTE:=STPEREPR.FN_NRO_COMPROBANTE;'))
,p_attribute_03=>'P474_EDITAR_AUX,P474_NRO_COMPROBANTE'
,p_attribute_04=>'N'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(142013591823292839)
,p_name=>'DA_CONFIRMAR'
,p_event_sequence=>90
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(142013493377292838)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(142013624852292840)
,p_event_id=>wwv_flow_imp.id(142013591823292839)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
'    IF :P474_NRO_COMPROBANTE is not null ',
'    and :P474_FEC_COMPROBANTE is not null and :P474_ESTADO is not null ',
'    and :P474_FEC_ESTADO is not null and :P474_OBSERVACION is not null ',
'    and :P474_TIP_COMPROBANTE is not null and :P474_FEC_ALTA is not null ',
'    and :P474_COD_USUARIO_AUX is not null and :P474_FEC_ESTADO is not null THEN',
'            IF :P474_EDITAR IS NULL THEN',
'                :P474_IND_ANULADO:=''S'';',
'                --INSERTAR REGISTRO',
'',
...
'                    PI_FEC_ALTA =>:P474_FEC_ALTA,',
'                    PI_FEC_ESTADO =>:P474_FEC_ESTADO,',
'                    PI_OBSERVACION =>:P474_OBSERVACION,',
'                    PI_COD_USUARIO =>:P474_COD_USUARIO_AUX);',
'',
'            ELSE ',
'                ',
'                --ACTUALIZO EL REGISTRO',
'                UPDATE ST_PED_REPOSICION_CAB SET',
'                        COD_SUCURSAL_SAL=:P474_COD_SUCURSAL_SAL,',
'                        FEC_COMPROBANTE =:P474_FEC_COMPROBANTE,',
'                        COD_SUCURSAL_ENT =:P474_COD_SUCURSAL_ENT,',
'                        ESTADO =:P474_ESTADO,',
'                        FEC_ALTA =:P474_FEC_ALTA,',
'                        FEC_ESTADO =:P474_FEC_ESTADO,',
'                        OBSERVACION = :P474_OBSERVACION,',
'                        COD_USUARIO = :P474_COD_USUARIO_AUX',
'                WHERE ROWID = :P474_EDITAR;',
'            END IF;',
'    ELSE',
'        :P474_ERR:=''Por favor: ingrese todos los campos obligatorio '';',
'    END IF;',
'EXCEPTION',
'    WHEN OTHERS THEN ',
'        APEX_DEBUG.ERROR(SQLERRM);',
'',
'END;'))
,p_attribute_02=>'P474_COD_EMPRESA,P474_COD_SUCURSAL_SAL,P474_NRO_COMPROBANTE,P474_TIP_COMPROBANTE,P474_SER_COMPROBANTE,P474_FEC_COMPROBANTE,P474_COD_SUCURSAL_ENT,P474_ESTADO,P474_FEC_ALTA,P474_FEC_ESTADO,P474_OBSERVACION,P474_COD_USUARIO_AUX'
,p_attribute_03=>'P474_ERR'
,p_attribute_04=>'N'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(142013713938292841)
,p_event_id=>wwv_flow_imp.id(142013591823292839)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(140553699305848720)
);
wwv_flow_imp_page.create_page_da_event(
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(143556198859623002)
,p_event_id=>wwv_flow_imp.id(143556088220623001)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
,p_attribute_01=>'apex_collection.create_or_truncate_collection(p_collection_name => ''COL_DET_STPEREPR'');'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
wwv_flow_imp_page.create_page_da_action(
...
' :P474_TIP_COMPROBANTE:= NULL;',
' :P474_SER_COMPROBANTE:= NULL;',
' :P474_FEC_COMPROBANTE:= NULL;',
' :P474_COD_SUCURSAL_ENT:= NULL;',
' :P474_ESTADO:= NULL;',
' :P474_FEC_ALTA:= NULL;',
