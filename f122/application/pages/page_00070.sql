...
,p_last_upd_yyyymmddhh24miss=>'20231123082235'
);
...
' GROUP BY  COD_VENDEDOR,to_char(fec_factura,''MM''),to_char(fec_factura,''YYYY'')',
' ORDER BY 1'))
...
wwv_flow_imp_page.create_worksheet_group_by(
 p_id=>wwv_flow_imp.id(450423695445701188)
...
wwv_flow_imp_page.create_worksheet_pivot(
 p_id=>wwv_flow_imp.id(450424061911701189)
,p_report_id=>wwv_flow_imp.id(114744873338806523)
,p_pivot_columns=>'ANIO'
,p_row_columns=>'NOMBRE_VENDEDOR'
);
wwv_flow_imp_page.create_worksheet_pivot_agg(
 p_id=>wwv_flow_imp.id(450424478423701189)
,p_pivot_id=>wwv_flow_imp.id(450424061911701189)
,p_display_seq=>1
,p_function_name=>'SUM'
,p_column_name=>'MONTO'
...
wwv_flow_imp_page.create_worksheet_pivot_sort(
 p_id=>wwv_flow_imp.id(450424881654701190)
,p_pivot_id=>wwv_flow_imp.id(450424061911701189)
,p_sort_seq=>1
