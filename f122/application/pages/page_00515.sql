...
,p_last_upd_yyyymmddhh24miss=>'20230502101924'
);
...
'               where a.cod_empresa=:p_cod_empresa and a.cod_motivo=c.cod_motivo',
'                ) DESCRIPCION,',
'       c.COD_USUARIO,',
'       (select p.nombre',
...
,p_attribute_03=>'P515_COD_MOTIVO_AUX,P515_DESCRIPCION_AUX,P515_COD_AREA_AUX'
,p_attribute_04=>'N'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
...
'                         :P515_COD_AREA,',
'                         :P515_FEC_HOR_INS_AUX,',
'                         :P515_COD_USR_INS_AUX',
'                );',
'            ELSE ',
...
'',
'END;'))
,p_attribute_02=>'P515_COD_MOTIVO_AUX,P515_COD_AREA_AUX'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
wwv_flow_imp_page.create_page_da_action(
...
'   from problemas_conformidad',
'   where cod_empresa   = :P_cod_empresa and cod_motivo=:P515_COD_MOTIVO_AUX;',
'    exception',
'            when no_data_found  then',
