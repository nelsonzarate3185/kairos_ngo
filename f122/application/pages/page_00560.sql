...
,p_name=>'cargar_articulos_stgeinmo'
,p_alias=>'CARGAR-ARTICULOS-STGEINMO'
,p_page_mode=>'MODAL'
,p_step_title=>'cargar_articulos_stgeinmo'
,p_autocomplete_on_off=>'OFF'
,p_page_template_options=>'#DEFAULT#'
,p_protection_level=>'C'
,p_page_component_map=>'03'
,p_last_updated_by=>'ANDRESDI'
,p_last_upd_yyyymmddhh24miss=>'20230710165846'
);
...
'                   art.cod_Art_corto,',
'                   (select sum(CANT_DISPON) from ST_EXISTENCIA_ART  where cod_articulo = art.cod_articulo) cantidad,',
'                   (select SUM(CANT_DISPON * nvl(art.COSTO_PROM,0)) from ST_EXISTENCIA_ART  where cod_articulo = art.cod_articulo) costo ',
'             INTO   V_DESCRIPCION,',
'                   V_COD_ART_CORTO,',
'                   V_CANT,',
'                   V_COSTO',
