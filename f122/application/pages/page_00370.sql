...
,p_last_upd_yyyymmddhh24miss=>'20240222162743'
);
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(202719888645500558)
...
||'tos;CR,En Proceso;EP,Rendidas;RN,Reclamo Mostrador;RMO,Reclamo SPP;RSPP,Reclamo Reingreso;RRE,Reclamo STA;RSTA'
,p_lov_display_null=>'YES'
,p_cHeight=>1
,p_begin_on_new_line=>'N'
,p_field_template=>wwv_flow_imp.id(40186634462263678)
...
'            RETURN ''No existe MO cargada para el Tecnico'';',
'        when others then',
'            RETURN sqlerrm;',
'    end;',
'END IF;'))
...
||'ERIOR,P370_ESTADO_RECLAMO,P370_ESTADO_PRESU'
,p_attribute_04=>'N'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
...
,p_attribute_03=>'P370_ESTADO_PRESU,P370_ESTADO_AUX,P370_COSTO_SERVICIO,P370_GARANTIA,P370_FEC_ESTADO,P370_ESTADO,P370_FEC_CIERRE,P370_COD_PROVEEDOR,P370_COD_MOTIVO_RECHAZO_PRESU,P370_NRO_TICKET,P370_CERRADO,P370_IND_RECLAMO'
,p_attribute_04=>'N'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
...
'',
'    if :P370_cod_origen  in  (''1'',''20'',''3'',''9'',''32'',''36'',''42'',''103'')  then     ',
...
'INTO :P370_IND_RECLAMO, :P370_IND_GARANTIA,:P370_COD_PROVEEDOR',
'from vt_ordenes_trabajo c',
'where cod_empresa     = ''1''',
'and c.tip_comprobante = :P370_TIP_COMPROBANTE',
'AND C.GARANTIA_OT     = :P370_NRO_GARANTIA',
...
'and rownum=1;',
'',
'if :P370_IND_RECLAMO =''S'' then',
'IF NVL(:P370_IND_GARANTIA,''N'')=''S'' THEN',
...
':P370_COD_PROVEEDOR := NULL;',
'end;'))
,p_attribute_02=>'P370_NRO_GARANTIA,P370_SER_COMPROBANTE,P370_NRO_COMPROBANTE,P370_TIP_COMPROBANTE,P370_COD_PROVEEDOR'
...
'if :P370_cod_origen is not null and :P370_cod_origen  is not null then',
'',
'    if :P370_cod_origen  in  (''1'',''20'',''3'',''9'',''32'',''36'',''42'')  then     ',
'        :P370_COD_PROVEEDOR:=f_asigna_tecnico(:P370_COD_ARTICULO_OT , null);  ',
'',
'    elsif :P370_cod_origen  in  (''38'',''15'')  then  ',
'            begin',
...
||'MPROBANTE,P370_FECHA_ABANDONADO,P370_FEC_APROBACION,P370_FEC_CIERRE,P370_COD_USUARIO_RENDICION,P370_FEC_PENDIENTE,P370_IND_ADICIONAL,P370_COD_PROVEEDOR,P370_LINEA_PRODUCTO,P370_TIPO,P370_ESTADO_AUX,P370_ESTADO_PRESU'
...
'',
''))
,p_attribute_02=>'P370_NRO_COMPROBANTE,P370_SER_COMPROBANTE,P_COD_EMPRESA,P370_PARAM_NRO_OT'
...
'',
'',
'  inv.caordtra.pr_sumar_totales_rep(p_cod_empresa  =>  ''1'',',
...
,p_attribute_03=>'P370_ESTADO_PRESU,P370_COD_MOTIVO_RECLAMO_SPP,P370_ESTADO_RECLAMO'
,p_attribute_04=>'N'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
...
'BEGIN',
'  IF NVL(:P370_ANULADO, ''N'') <> ''S'' OR NVL(:P370_IND_RETIRADO, ''N'') <> ''S'' OR',
'     NVL(:P370_IND_ENTREGA, ''N'') <> ''S'' OR NVL(:P370_COD_ORIGEN, ''N'') = ''1''',
'  ',
'   THEN',
'  ',
'    DECLARE',
...
'      ELSE',
'      ',
'        IF /*VGRUPO NOT IN (''TECNIC'') AND */:P370_NRO_COMPROBANTE IS NOT NULL THEN',
'          IF NVL(:P370_TICKET, ''N'') = ''S'' THEN',
'            :P370_SOLICITA := ''S'';',
'            NULL;',
'          ELSE',
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(379342669146055029)
...
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    :P370_IR_A_MO := apex_page.get_url(  p_page   => 402,',
'                                               p_items  => ''P402_COD_ARTICULO_OT,P402_ORIGEN,P402_COD_PROVEEDOR'',',
'                                               p_values => :P370_COD_ARTICULO_OT||'',''||:P370_COD_ORIGEN_AUX||'',''||:P370_COD_PROVEEDOR',
'                                             );     '))
,p_attribute_02=>'P402_COD_ARTICULO_OT,P402_ORIGEN,P402_COD_PROVEEDOR'
,p_attribute_03=>'P370_IR_A_MO'
,p_attribute_04=>'N'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
...
'                                        p_celular =>  :P370_PREFIJO||:P370_TEL_CLIENTE,--p_celular => :p_celular,',
