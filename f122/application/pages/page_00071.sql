...
,p_last_upd_yyyymmddhh24miss=>'20230228124123'
);
...
' factura,',
' PLANILLA_REPARTO,cantidad_pendiente , importe_pendiente, factura_cantidad',
'',
...
,p_is_default=>'Y'
,p_view_mode=>'REPORT'
,p_report_columns=>'FEC_COMPROBANTE:NOMBRE:COMPROBANTE:COD_ART_CORTO:COD_ARTICULO:DESC_ARTICULO:CANTIDAD:SIGLAS:IMPORTE:DESC_VENDEDOR:OBSERVACION_PEDIDO:ESTADO:AUTORIZACION:AREA_AUTORIZACION:FLETE:PLANILLA_REPARTO:FACTURA:CANTIDAD_PENDIENTE:IMPORTE_PENDIENTE:NRO_COMPROB'
||'ANTE:SER_COMPROBANTE:'
,p_chart_type=>'bar'
...
wwv_flow_imp_page.create_worksheet_group_by(
 p_id=>wwv_flow_imp.id(65188484822499640)
...
,p_function_sum_04=>'Y'
,p_function_05=>'SUM'
,p_function_column_05=>'NRO_COMPROBANTE'
,p_function_db_column_name_05=>'APXWS_GBFC_05'
,p_function_label_05=>'nro'
...
wwv_flow_imp_page.create_worksheet_pivot(
 p_id=>wwv_flow_imp.id(65188801968499641)
,p_report_id=>wwv_flow_imp.id(110615947981790545)
,p_pivot_columns=>'AUTORIZACION'
,p_row_columns=>'COD_CLIENTE:NOMBRE'
);
wwv_flow_imp_page.create_worksheet_pivot_agg(
 p_id=>wwv_flow_imp.id(65189289930499641)
,p_pivot_id=>wwv_flow_imp.id(65188801968499641)
,p_display_seq=>1
,p_function_name=>'SUM'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(13117104195518226)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(13117649250518227)
,p_event_id=>wwv_flow_imp.id(13117104195518226)
,p_event_result=>'TRUE'
...
'  ',
'  END;'))
,p_attribute_02=>'P71_USUARIO'
,p_attribute_03=>'P71_COD_VENDEDOR'
,p_attribute_04=>'N'
