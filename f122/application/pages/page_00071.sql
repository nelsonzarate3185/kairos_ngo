...
,p_last_upd_yyyymmddhh24miss=>'20231229073440'
);
...
' factura,',
' PLANILLA_REPARTO,cantidad_pendiente , importe_pendiente, factura_cantidad, margen',
'',
...
wwv_flow_imp_page.create_worksheet_group_by(
 p_id=>wwv_flow_imp.id(502557393052715162)
...
wwv_flow_imp_page.create_worksheet_pivot(
 p_id=>wwv_flow_imp.id(502557773658715163)
,p_report_id=>wwv_flow_imp.id(110615947981790545)
,p_pivot_columns=>'AUTORIZACION'
,p_row_columns=>'COD_CLIENTE:NOMBRE'
);
wwv_flow_imp_page.create_worksheet_pivot_agg(
 p_id=>wwv_flow_imp.id(502558180454715163)
,p_pivot_id=>wwv_flow_imp.id(502557773658715163)
,p_display_seq=>1
,p_function_name=>'SUM'
