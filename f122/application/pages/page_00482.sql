...
,p_last_upd_yyyymmddhh24miss=>'20230413082511'
);
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(144666491471406848)
...
'    EXCEPTION',
'            WHEN OTHERS THEN',
'                    APEX_DEBUG.ERROR(''Error cargando coleccion en reporte''||SQLERRM);',
'END;'))
,p_attribute_02=>'P482_PENDIENTE_OT,P482_DEPOSITO'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
wwv_flow_imp_page.create_page_da_action(
...
':P482_Cod_Empresa  := :P_Cod_Empresa;',
