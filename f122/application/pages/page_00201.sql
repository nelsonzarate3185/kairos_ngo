...
,p_last_upd_yyyymmddhh24miss=>'20221121081532'
);
...
'WHERE B.COD_EMPRESA = :P201_COD_EMPRESA',
'AND A.COD_EMPRESA=B.COD_EMPRESA',
'AND A.COD_ARTICULO=B.COD_ARTICULO',
'ORDER BY B.FEC_ALTA;  '))
,p_plug_source_type=>'NATIVE_IR'
,p_ajax_items_to_submit=>'P201_COD_EMPRESA'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
...
,p_column_link=>'javascript:$s(''P201_ABRE_REGION'',''#COD_ARTICULO#'');'
...
,p_column_link=>'javascript:$s(''P201_ELIMINA_REGISTRO'',''#COD_ARTICULO#'');'
...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'COD_CORTO_ART:COD_ARTICULO:DESCRIPCION:DESCUENTO:PRECIO_DESCUENTO:FEC_ALTA:FEC_CIERRE:ACTIVO:EDITAR:ELIMINAR:'
,p_sort_column_1=>'DESCUENTO'
...
'           and (a.cod_articulo = B.COD_ARTICULO or a.cod_art_corto = B.COD_ARTICULO)) DESCRIPCION',
' INTO :P201_ACTIVO, :P201_FEC_ALTA, :P201_FEC_CIERRE, :P201_COD_ARTICULO_1, :P201_DESCUENTO, :P201_PRECIO_DESCUENTO, :P201_COD_CORTO_ART_1, :P201_DESCRIPCION',
' FROM VT_OFERTAS_OUTLET B',
'WHERE COD_EMPRESA = :P201_COD_EMPRESA',
'  AND COD_ARTICULO = :P201_ABRE_REGION;  ',
''))
,p_attribute_02=>'P201_COD_EMPRESA,P201_ABRE_REGION'
,p_attribute_03=>'P201_ACTIVO,P201_FEC_ALTA,P201_FEC_CIERRE,P201_COD_ARTICULO_1,P201_DESCUENTO,P201_PRECIO_DESCUENTO,P201_COD_CORTO_ART_1,P201_DESCRIPCION'
,p_attribute_04=>'N'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
...
'    VTOFERTA.ACTUALIZA_REGISTRO(PI_COD_EMPRESA      => :P201_COD_EMPRESA, ',
...
'END IF;                                    ',
'                             '))
,p_attribute_02=>'P201_ACTIVO,P201_COD_EMPRESA,P201_ABRE_REGION,P201_FEC_ALTA,P201_FEC_CIERRE,P201_DESCUENTO,P201_PRECIO_DESCUENTO'
...
'END IF;    ',
'                             '))
,p_attribute_02=>'P201_ACTIVO,P201_COD_EMPRESA,P201_COD_ARTICULO,P201_FEC_ALTA,P201_FEC_CIERRE,P201_DESCUENTO,P201_PRECIO_DESCUENTO,P201_COD_CORTO_ART'
,p_attribute_03=>'P201_AUX_MSJ'
,p_attribute_04=>'N'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
