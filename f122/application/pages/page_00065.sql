...
,p_last_upd_yyyymmddhh24miss=>'20230520094408'
);
...
'   PEDIDOS_AUTORIZADOS,  PEDIDOS_PENIENTES, precio_web(cod_articulo,''1'',0) precio_lista,largo_cm, ancho_cm, alto_cm, cod_ean, peso_gr',
'',
...
,p_is_default=>'Y'
,p_view_mode=>'REPORT'
,p_report_columns=>'COD_SUCURSAL:DESC_SUCURSAL:MARCA:COD_ART_CORTO:COD_ARTICULO:DESC_ARTICULO:CANT_DISPON:VOLUMEN:PEDIDOS_AUTORIZADOS:PEDIDOS_PENIENTES:ALTO_CM:ANCHO_CM:LARGO_CM:COD_EAN:'
,p_sum_columns_on_break=>'CANT_DISPON:VOLUMEN'
);
wwv_flow_imp_page.create_worksheet_group_by(
 p_id=>wwv_flow_imp.id(112673425596239689)
