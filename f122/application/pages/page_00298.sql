...
,p_prn_page_header=>'REPORTE ARTICULOS'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(78109249865254419)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(78109549728254422)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(78109620588254423)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(78109756815254424)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(78109828796254425)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(78109966967254426)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(78110096156254427)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(78110182774254428)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(78110206076254429)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(78110316276254430)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(78110427142254431)
,p_db_column_name=>'CI'
,p_display_order=>160
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(78110503589254432)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(78110690561254433)
...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'SELECCIONAR:TIP_COMPROBANTE:SER_COMPROBANTE:NRO_COMPROBANTE:NRO_DIARIO:COD_SUCURSAL:FEC_COMPROBANTE:COD_CLIENTE:COD_USUARIO:FEC_ALTA:OBSERVACION:'
);
wwv_flow_imp_page.create_page_plug(
...
'   	 FROM cc_clientes',
'   	 WHERE cod_empresa = :P298_COD_EMPRESA',
...
||'_TIP_NCR,P298_TRASLADO,P298_NRO_COMPROBANTE_REF,P298_SER_COMPROBANTE_REF,P298_TIP_COMPROBANTE_REF'
,p_attribute_04=>'N'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
...
'    --APEX_DEBUG.ERROR(:P298_COD_ARTICULO_ENVIAR);',
'',
'EXCEPTION',
'    WHEN OTHERS THEN',
'        APEX_DEBUG.ERROR(SQLERRM);',
...
'    ',
'    --APEX_DEBUG.ERROR(:P298_TIP_COMPROBANTE_ENVIAR);',
'    --APEX_DEBUG.ERROR(:P298_NRO_COMPROBANTE_ENVIAR);',
'    --APEX_DEBUG.ERROR(:P298_SER_COMPROBANTE_ENVIAR);',
'',
'EXCEPTION',
'    WHEN OTHERS THEN',
'        APEX_DEBUG.ERROR(SQLERRM);',
...
'',
''))
,p_attribute_02=>'P298_TIP_COMPROBANTE_REF,P298_NRO_COMPROBANTE_REF,P298_SER_COMPROBANTE_REF'
,p_attribute_03=>'P298_TIP_COMPROBANTE_ENVIAR,P298_NRO_COMPROBANTE_ENVIAR,P298_SER_COMPROBANTE_ENVIAR'
,p_attribute_04=>'N'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
