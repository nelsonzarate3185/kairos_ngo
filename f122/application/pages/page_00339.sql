...
,p_last_upd_yyyymmddhh24miss=>'20231016141611'
);
...
,p_button_redirect_url=>'f?p=&APP_ID.:323:&SESSION.::&DEBUG.::P323_P_ENVIO_PEND,P323_P_COD_VEHICULO,P323_P_COD_REPARTIDOR,P323_P_COD_ZONA,P323_P_COD_AYUDANTE_1,P323_P_COD_AYUDANTE_2,P323_CAB_COD_SUCURSAL_ENT,P323_CAB_COD_SUCURSAL:&P339_C_NRO_ENVIO.,&P339_C_COD_VEHICULO.,&P339_C_COD_REPARTIDOR.,&P339_C_COD_ZONA_REPARTO.,&P339_C_COD_AYUDANTE_1.,&P339_C_COD_AYUDANTE_2.,&P339_C_COD_SUCURSAL_ENT.,&P339_COD_SUCURSAL.'
,p_grid_new_row=>'N'
,p_grid_new_column=>'N'
);
wwv_flow_imp_page.create_page_button(
...
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'doDescarga(apex.item(''P339_COD_EMPRESA'').getValue(),apex.item(''P339_P_COD_SUC_ENTRADA'').getValue(),apex.item(''P339_P_COD_SUC_SAL'').getValue(), apex.item(''P339_A_COSTO'').getValue(), ',
