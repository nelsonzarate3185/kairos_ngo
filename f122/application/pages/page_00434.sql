...
'    apex.item(''P434_DESC_MOTIVO'').disable();',
...
'   apex.item(''P434_DESC_MOTIVO'').enable();',
...
,p_last_upd_yyyymmddhh24miss=>'20230322163933'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(126308675720686831)
,p_plug_name=>unistr('Gesti\00F3n de Visitas  - CAGESVIS')
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(128436263480744744)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(128513221539228205)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(129090527306898122)
...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'DIA:FEC_VISITA:HORA_VISITA:COMPROBANTE:DETALLE:'
);
wwv_flow_imp_page.create_page_plug(
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(128517176301228244)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(128517455550228247)
,p_plug_name=>'Contenedor 2.4'
,p_parent_plug_id=>wwv_flow_imp.id(128434030987744722)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(40096829222263653)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(129092023809898137)
...
,p_button_plug_id=>wwv_flow_imp.id(128436263480744744)
...
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(128517176301228244)
...
,p_button_plug_id=>wwv_flow_imp.id(128513221539228205)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(128434507544744727)
,p_name=>'P434_COD_TECNICO'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(128433970265744721)
,p_prompt=>unistr('Cod. T\00E9cnico')
,p_display_as=>'NATIVE_POPUP_LOV'
,p_named_lov=>'LV_TECNICO_CAGESVIS'
...
,p_attribute_05=>'Y'
,p_attribute_06=>'0'
,p_attribute_10=>'NOMBRE:P434_DESC_TECNICO'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(128434687963744728)
,p_name=>'P434_DESC_TECNICO'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(128433970265744721)
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(128434796045744729)
,p_name=>'P434_NOM_CLIENTE'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(128433970265744721)
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(128434844420744730)
,p_name=>'P434_COD_CLIENTE'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(128433970265744721)
,p_prompt=>'Cod. Cliente'
,p_display_as=>'NATIVE_POPUP_LOV'
,p_named_lov=>'LV_CLIENTES_CAGESVIS'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_attribute_05=>'Y'
,p_attribute_06=>'0'
,p_attribute_10=>'NOMBRE:P434_NOM_CLIENTE'
);
wwv_flow_imp_page.create_page_item(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(128435551706744737)
,p_name=>'P434_COD_PROVINCIA'
,p_item_sequence=>170
,p_item_plug_id=>wwv_flow_imp.id(128433970265744721)
,p_prompt=>'Cod. Provincia'
,p_display_as=>'NATIVE_POPUP_LOV'
,p_named_lov=>'LV_PROVINCIAS_CAGESVIS'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select descripcion, ',
'       cod_provincia ',
'  from provincias ',
...
,p_attribute_05=>'Y'
,p_attribute_06=>'0'
,p_attribute_10=>'DESCRIPCION:P434_DESC_PROVINCIA'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(128435661378744738)
,p_name=>'P434_DESC_PROVINCIA'
,p_item_sequence=>180
,p_item_plug_id=>wwv_flow_imp.id(128433970265744721)
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(128435797452744739)
,p_name=>'P434_BARRIO'
,p_item_sequence=>220
,p_item_plug_id=>wwv_flow_imp.id(128433970265744721)
,p_display_as=>'NATIVE_TEXT_FIELD'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(128435873312744740)
,p_name=>'P434_COD_BARRIO'
,p_item_sequence=>210
,p_item_plug_id=>wwv_flow_imp.id(128433970265744721)
,p_prompt=>'Cod. Barrio'
,p_display_as=>'NATIVE_POPUP_LOV'
,p_named_lov=>'LV_BARRIO_CAGESVIS'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select descripcion, ',
'       cod_barrio ',
'  from barrios ',
...
'order by descripcion'))
,p_lov_display_null=>'YES'
,p_lov_cascade_parent_items=>'P434_COD_CIUDAD'
,p_ajax_items_to_submit=>'P434_COD_CIUDAD'
...
,p_attribute_05=>'Y'
,p_attribute_06=>'0'
,p_attribute_10=>'DESCRIPCION:P434_BARRIO'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(128435902235744741)
,p_name=>'P434_CIUDAD'
,p_item_sequence=>200
,p_item_plug_id=>wwv_flow_imp.id(128433970265744721)
,p_display_as=>'NATIVE_TEXT_FIELD'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(128436016133744742)
,p_name=>'P434_COD_CIUDAD'
,p_item_sequence=>190
,p_item_plug_id=>wwv_flow_imp.id(128433970265744721)
,p_prompt=>'Cod. Ciudadd'
,p_display_as=>'NATIVE_POPUP_LOV'
,p_named_lov=>'LV_CIUDADES_CAGESVIS'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select descripcion, ',
'       cod_ciudad ',
'  from ciudades ',
...
'order by descripcion'))
,p_lov_display_null=>'YES'
,p_lov_cascade_parent_items=>'P434_COD_PROVINCIA'
,p_ajax_items_to_submit=>'P434_COD_PROVINCIA'
,p_ajax_optimize_refresh=>'Y'
,p_cSize=>30
,p_field_template=>wwv_flow_imp.id(40186634462263678)
,p_item_template_options=>'#DEFAULT#'
...
,p_attribute_05=>'Y'
,p_attribute_06=>'0'
,p_attribute_10=>'DESCRIPCION:P434_CIUDAD'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(128436161759744743)
,p_name=>'P434_COORDENADAS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(128436263480744744)
...
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(128436819571744750)
...
,p_item_sequence=>250
,p_item_plug_id=>wwv_flow_imp.id(128513221539228205)
...
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(128517176301228244)
,p_prompt=>unistr('Direcci\00F3n')
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_colspan=>8
...
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(128517455550228247)
,p_prompt=>'Fecha Agendada'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_tag_attributes=>'readonly'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(129088666745898103)
,p_name=>'P434_COD_MOTIVO_VISITA'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_imp.id(128433970265744721)
,p_prompt=>'Cod. Motivo'
,p_display_as=>'NATIVE_POPUP_LOV'
,p_named_lov=>'LV_MOT_VISITA_CAGESVIS'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select descripcion, ',
'       cod_motivo',
...
,p_attribute_05=>'Y'
,p_attribute_06=>'0'
,p_attribute_10=>'DESCRIPCION:P434_DESC_MOT_VIS'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(129088795957898104)
,p_name=>'P434_DESC_MOT_VIS'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_imp.id(128433970265744721)
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
...
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(129092023809898137)
,p_prompt=>unistr('Observaci\00F3n')
,p_display_as=>'NATIVE_TEXTAREA'
,p_cSize=>30
,p_cHeight=>5
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(129088861313898105)
,p_name=>'DA_SOLO_NUMEROS'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P434_HORA,P434_MINU'
,p_bind_type=>'bind'
,p_bind_event_type=>'keydown'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(129088934047898106)
,p_event_id=>wwv_flow_imp.id(129088861313898105)
,p_event_result=>'TRUE'
...
'EXCEPTION',
'    WHEN OTHERS THEN',
'    APEX_DEBUG.ERROR(''DA_FEC_VISITAS ''||SQLERRM);',
'END;'))
,p_attribute_02=>'P434_FEC_VISITA'
...
'END;'))
,p_attribute_02=>'P434_COD_CLIENTE,P_COD_EMPRESA'
,p_attribute_03=>'P434_DIRECCION,P434_COD_BARRIO,P434_COD_CIUDAD,P434_CONTACTO,P434_COD_PROVINCIA'
,p_attribute_04=>'N'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
,p_client_condition_type=>'NOT_NULL'
...
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
,p_attribute_01=>'NULL;'
,p_attribute_02=>'P434_COD_TECNICO,P434_FEC_VISITA'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
wwv_flow_imp_page.create_page_da_action(
...
'EXCEPTION',
'    WHEN OTHERS THEN',
'    APEX_DEBUG.ERROR(''DA_COD_TECNICO ''||SQLERRM);',
'END;'))
,p_attribute_02=>'P_COD_EMPRESA,P434_COD_TECNICO,P434_FEC_VISITA'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
,p_client_condition_type=>'NOT_NULL'
...
'EXCEPTION',
'    WHEN OTHERS THEN',
'    APEX_DEBUG.ERROR(''DA_NRO_COMPROBANTE ''||SQLERRM);',
'END;'))
,p_attribute_02=>'P_COD_EMPRESA,P434_TIP_COMPROBANTE,P434_SER_COMPROBANTE,P434_NRO_COMPROBANTE'
,p_attribute_03=>'P434_COD_TECNICO,P434_COD_CLIENTE,P434_ORIGEN'
,p_attribute_04=>'N'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
,p_client_condition_type=>'NOT_NULL'
...
'EXCEPTION',
'    WHEN OTHERS THEN',
'    APEX_DEBUG.ERROR(''DA_MOTIVO_DET ''||SQLERRM);',
'END;'))
,p_attribute_02=>'P434_MOTIVO'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(132542725789400105)
,p_event_id=>wwv_flow_imp.id(132542547547400103)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
'    BEGIN',
'        SELECT DESCRIPCION',
'          INTO :P434_DESC_MOT_VIS',
'          FROM  CA_MOTIVO_VISITA',
'         WHERE COD_MOTIVO = :P434_COD_MOTIVO_VISITA;',
'    EXCEPTION',
'        WHEN NO_DATA_FOUND THEN',
'        :P434_DESC_MOT_VIS := NULL;',
'    END;',
'EXCEPTION',
'    WHEN OTHERS THEN',
'    APEX_DEBUG.ERROR(''DA_COD_MOTIVO_VISITA ''||SQLERRM);',
'END;'))
,p_attribute_02=>'P434_COD_MOTIVO_VISITA'
,p_attribute_03=>'P434_DESC_MOT_VIS'
,p_attribute_04=>'N'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
...
'                EXCEPTION',
'                    WHEN OTHERS THEN',
'                    APEX_DEBUG.ERROR(''ERROR AL ACTUALIZAR REGISTRO EN CA_GESTIONES_VISITAS ''||SQLERRM);',
'                END;',
'            END IF;',
'        END IF;',
...
'    WHEN OTHERS THEN',
'    APEX_DEBUG.ERROR(''DA_BTACEPTAR ''||SQLERRM);',
'END;'))
,p_attribute_02=>'P434_CONTROL,P434_REAGENDAR,P434_FECHA_REA,P434_HORA_REA,P434_OBSERVACION,P434_RESULTADO_VISITA,P_COD_USUARIO,P434_MOTIVO_CAN,P434_DIR_ARCHIVO,P_COD_EMPRESA,P434_COD_CLIENTE,P434_SER_COMPROBANTE,P434_NRO_COMPROBANTE,P434_NOM_CLIENTE,P434_DIRECCION'
...
'        WHEN OTHERS THEN',
'        APEX_DEBUG.ERROR(''ERROR EN LA TABLA CABECERA ''||SQLERRM);',
'    END;',
...
'EXCEPTION',
'    WHEN OTHERS THEN',
'    APEX_DEBUG.ERROR(''PR_ADD ''||SQLERRM);',
'END;'))
,p_process_clob_language=>'PLSQL'
...
'          into :P434_DESC_TECNICO',
'          from vt_tecnicos v, personas p ',
'         where v.cod_empresa = :P_COD_EMPRESA ',
'           and v.cod_persona = p.cod_persona',
'           and v.cod_tecnico = :P434_COD_TECNICO;',
'    EXCEPTION',
'        WHEN NO_DATA_FOUND THEN',
'        :P434_DESC_TECNICO := NULL;',
'    END;',
'',
'    BEGIN',
'        select ltrim(rtrim(nvl(p.nombre, p.nomb_fantasia)))',
'          into :P434_NOM_CLIENTE',
'          from cc_clientes c,',
'               personas p, ',
'               ident_personas i',
'         where c.cod_empresa = :P_COD_EMPRESA',
...
'           and i.cod_persona(+) = p.cod_persona',
'           and i.cod_ident(+)=''CI''',
'           and c.cod_cliente = :P434_COD_CLIENTE;',
'    EXCEPTION',
'        WHEN NO_DATA_FOUND THEN',
'        :P434_NOM_CLIENTE := NULL;',
'    END;',
'EXCEPTION',
'    WHEN OTHERS THEN',
'    APEX_DEBUG.ERROR(''PR_EDTI ''||SQLERRM);',
'END;'))
,p_process_clob_language=>'PLSQL'
,p_process_when=>'P434_V_CONTROL'
,p_process_when_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
