...
,p_last_upd_yyyymmddhh24miss=>'20230608112416'
);
...
'          from v_stock_apex e',
'         where e.COD_ARTICULO = s2.cod_articulo) stock_promo,',
...
'          AND P.COD_ARTICULO_PRINCIPAL = DD.COD_ARTICULO',
'          and nvl(cc.estado, ''P'') <> ''A''),',
'       0) CANTIDAD_PROMO_VENDIDA,*/',
