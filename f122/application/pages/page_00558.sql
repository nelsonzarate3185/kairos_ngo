...
,p_last_upd_yyyymmddhh24miss=>'20240202122702'
);
...
'  nvl(cu,0)-CANTIDAD_SISTEMA DIFERENCIA, zona_almacenada,   costo_stock*CANTIDAD_sistema total_sistema_monto,',
'                              costo_stock*CANTIDAD_inventario total_inventario_monto,',
'                                (((costo_stock*CANTIDAD_inventario)-(costo_stock*CANTIDAD_sistema))) diferencia_monto',
'',
' FROM (  ',
...
'           0) COSTO_STOCK,*/NVL(ROUND(GD.COSTO  ),',
'           0) COSTO_STOCK, ',
'       g.nro_comprobante,',
'       g.sucursal,',
'       a.cod_Art_corto,',
...
'           and ex.cant_dispon>=0)*/null lote_1,',
'            /*(select max(ex.nro_lote)',
'           from st_existencia_art ex',
'           where ex.cod_empresa=a.cod_empresa',
'           and ex.cod_articulo=a.cod_articulo',
'           and ex.cod_sucursal=g.cod_sucursal',
'           and ex.cant_dispon>=0)*/null lote_2,''1'' ORDEN,',
...
'           and ex.cod_articulo=a.cod_articulo',
'           and ex.cod_sucursal=g.cod_sucursal',
'           and ex.cant_dispon>=0)*/null lote_2,''2'', ',
'                        ubicacion_real(gd.cod_articulo,g.cod_sucursal,null)  zona_almacenada,',
'            NVL((SELECT  ''SI''',
'          FROM SM_INVENTARIO_DET E, ST_POSICIONES P, ST_BLOQUE_PRODUCTOS BL',
'         WHERE g.Nro_Comprobante = e.inventory_id',
...
' order by 1, 3 asc',
')',
'WHERE (ZONA LIKE ''%''||:P558_P_COD_POSICION||''%'' OR :P558_P_COD_POSICION IS NULl)'))
,p_plug_source_type=>'NATIVE_IR'
,p_ajax_items_to_submit=>'P558_P_COD_ARTICULO,P558_P_BLOQUE,P558_P_SUB_BLOQUE,P558_P_NRO_COMPROBANTE,P558_P_COD_EMPRESA,P558_P_SER_COMPROBANTE,P558_P_TIP_COMPROBANTE,P558_EJECUTAR_REPORTE_1,P558_P_COD_POSICION'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(258025095863182515)
,p_db_column_name=>'TOTAL_SISTEMA_MONTO'
,p_display_order=>610
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(258025150258182516)
,p_db_column_name=>'TOTAL_INVENTARIO_MONTO'
,p_display_order=>620
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(258025257191182517)
...
,p_report_columns=>'COD_SUCURSAL:SUCURSAL:NRO_COMPROBANTE:COD_ART_CORTO:COD_ARTICULO:DESC_ART:CANTIDAD_SISTEMA:CANTIDAD_INVENTARIO:DIFERENCIA:COSTO_INVENTARIO:COSTO_STOCK:TOTAL_SISTEMA_MONTO:TOTAL_INVENTARIO_MONTO:DIFERENCIA_MONTO:USUARIO:ZONA:ZONA_ALMACENADA:HORARIO:CO'
||'RRESPONDE_BLOQUE:'
,p_sum_columns_on_break=>'CANTIDAD_SISTEMA:CANTIDAD_INVENTARIO'
);
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(553519680053568343)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(553520024820568344)
,p_report_id=>wwv_flow_imp.id(178685587651329149)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(553520436843568344)
,p_report_id=>wwv_flow_imp.id(178685587651329149)
,p_name=>'Row text contains ''P374'''
...
'            AND BL.COD_BLOQUE=P.COD_BLOQUE',
'            AND BL.COD_SUB_BLOQUE=P.COD_SUB_BLOQUE',
'              and (p.cod_sub_bloque=:P558_sub_bloque or :P558_sub_bloque is null)',
'            and ( p.cod_bloque= :P558_P_BLOQUE or :P558_P_BLOQUE is null) ',
'            AND ROWNUM=1',
'            ) ,''NO'')CORRESPONDE_BLOQUE,',
...
'     and nvl(:P558_EJECUTAR_REPORTE_1,''2'')<>''1''',
'   and g.cod_empresa = gd.cod_empresa',
'   and g.tip_comprobante = gd.tip_comprobante',
'   and g.ser_comprobante = gd.ser_comprobante',
'   and g.nro_comprobante = gd.nro_comprobante',
...
'   union ALL ',
'   SELECT ub.cod_articulo ',
'   from st_ubic_articulos@dblink_cph ub ',
'   where ub.cod_empresa=gd.cod_empresa ',
'   and ub.cod_sucursal=g.cod_sucursal',
'    and ub.cod_articulo=gd.cod_articulo',
'     and ( ub.cod_bloque= :P558_P_BLOQUE or :P558_P_BLOQUE is null)',
...
'  ',
'       and (  :P558_P_BLOQUE is not null',
'     or   :P558_sub_bloque is not null)',
'   ',
'   ',
'   ',
'---------------------------------------------------------------------------------',
...
')'))
,p_plug_source_type=>'NATIVE_IR'
,p_ajax_items_to_submit=>'P558_P_COD_ARTICULO,P558_P_BLOQUE,P558_P_SUB_BLOQUE,P558_P_NRO_COMPROBANTE,P558_P_COD_EMPRESA,P558_P_SER_COMPROBANTE,P558_P_TIP_COMPROBANTE,P558_EJECUTAR_REPORTE_2,P558_EJECUTAR_REPORTE_1'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_plug_display_condition_type=>'ITEM_IS_NOT_NULL'
...
'  cu-CANTIDAD_SISTEMA DIFERENCIA, zona_almacenada,',
'   costo_stock*CANTIDAD_sistema total_sistema_monto,',
'                              costo_stock*CANTIDAD_inventario total_inventario_monto,',
'                                (((costo_stock*CANTIDAD_inventario)-(costo_stock*CANTIDAD_sistema))) diferencia_monto',
'',
' FROM (   ',
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(258024704838182512)
,p_db_column_name=>'TOTAL_SISTEMA_MONTO'
,p_display_order=>380
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(258024896350182513)
,p_db_column_name=>'TOTAL_INVENTARIO_MONTO'
,p_display_order=>390
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(258024922275182514)
,p_db_column_name=>'DIFERENCIA_MONTO'
,p_display_order=>400
...
,p_is_default=>'Y'
,p_display_rows=>100000
,p_report_columns=>'SUCURSAL:NRO_COMPROBANTE:COD_ART_CORTO:COD_ARTICULO:DESC_ART:CANTIDAD_SISTEMA:CANTIDAD_INVENTARIO:DIFERENCIA:COSTO_STOCK:COSTO_PROM:COSTO_INVENTARIO:ZONA:ZONA_ALMACENADA:USUARIO:HORARIO:CORRESPONDE_BLOQUE:TOTAL_SISTEMA_MONTO:TOTAL_INVENTARIO_MONTO:DI'
||'FERENCIA_MONTO:'
,p_sum_columns_on_break=>'CANTIDAD_SISTEMA:DIFERENCIA:CANTIDAD_INVENTARIO:TOTAL_SISTEMA_MONTO:TOTAL_INVENTARIO_MONTO:DIFERENCIA_MONTO'
);
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(322959265638216880)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(322959646913216880)
,p_report_id=>wwv_flow_imp.id(254505858396548005)
,p_name=>'Diferencia Positiva'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(258023698498182501)
...
,p_lov_display_null=>'YES'
,p_lov_null_text=>'...'
,p_lov_cascade_parent_items=>'P558_P_BLOQUE,P558_P_COD_SUCURSAL,P558_P_SUB_BLOQUE'
,p_ajax_optimize_refresh=>'Y'
,p_cSize=>30
,p_begin_on_new_line=>'N'
,p_field_template=>wwv_flow_imp.id(40186634462263678)
...
'    END;',
'END IF;'))
,p_attribute_02=>'P558_P_IND_INVENTARIO_CPH,P558_P_NRO_COMPROBANTE'
