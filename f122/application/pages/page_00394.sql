...
'function doDescarga(p_ser_comprobante, p_nro_comprobante){',
'   var vURL = ''https://ngosaeca.com.py/reportes/rest_v2/reports/reports/ccrecibo.pdf?''',
'            + ''P_SER_COMPROBANTE='' + p_ser_comprobante + ''&P_NRO_COMPROBANTE='' + p_nro_comprobante + ''&j_username=jasperadmin&j_password=jasperadmin'';',
'',
'    console.log(vURL);',
...
,p_last_upd_yyyymmddhh24miss=>'20230905162008'
);
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(118479353816648231)
,p_event_id=>wwv_flow_imp.id(116871259119812579)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(149491172204830920)
,p_event_id=>wwv_flow_imp.id(116871259119812579)
,p_event_result=>'TRUE'
,p_action_sequence=>60
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_attribute_01=>'document.getElementById("BTNUEV").disabled = false;'
,p_client_condition_type=>'EQUALS'
,p_client_condition_element=>'P394_CONTROL_GUARDADO'
,p_client_condition_expression=>'1'
);
...
||'MPRESA,P394_V_TIPO_TRAN,P394_TIP_FACTURA_REF_ADD'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
,p_client_condition_type=>'NULL'
...
'END;'))
,p_attribute_02=>'P394_TIPO_TRANSAC,P394_TIP_FACTURA_REF_ADD_AUX,P394_SER_FACTURA_REF_ADD,P394_NRO_FACTURA_REF_ADD,P394_NRO_CUOTA_ADD,P394_FEC_VENCIMIENTO_ADD,P394_COD_MONEDA_CUOTA_ADD,P394_TIP_CAMBIO_ADD,P394_MONTO_CUOTA_ADD,P394_IMPORTE_ADD,P394_V_COD_MODULO,P_COD_E'
||'MPRESA,P394_V_TIPO_TRAN,P394_EDIT_DATA_DET'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
,p_client_condition_type=>'NOT_NULL'
,p_client_condition_element=>'P394_EDIT_DATA_DET'
...
'        :P394_IMPORTE_ADD := NVL(:P394_MONTO_CUOTA_ADD,0) * NVL(:P394_TIP_CAMBIO_ADD,1) / NVL(:P394_TIP_CAMBIO,1);',
'    ELSE',
'        :P394_IMPORTE_ADD := NVL(:P394_MONTO_CUOTA_ADD,0);',
'    END IF;',
'    ',
'    :P394_TOTAL_AUX := REPLACE(REPLACE(:P394_TOTAL_AUX,''.'',''''),'','',''.'');',
'',
...
'',
'    :P394_TOTAL := TO_CHAR(:P394_TOTAL, ''999G999G999G999G999D00'');',
'    ',
'EXCEPTION',
'    WHEN OTHERS THEN',
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(117371676118768844)
,p_name=>'DA_TOTAL'
,p_event_sequence=>700
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P394_TOTAL'
,p_bind_type=>'bind'
,p_bind_event_type=>'change'
,p_display_when_type=>'NEVER'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(117371755797768845)
,p_event_id=>wwv_flow_imp.id(117371676118768844)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
,p_attribute_01=>'NULL;'
,p_attribute_02=>'P394_TOTAL'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(117371852617768846)
,p_event_id=>wwv_flow_imp.id(117371676118768844)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
,p_attribute_01=>':P394_TOTAL := TO_CHAR(:P394_TOTAL, ''999G999G999G990D00'');'
,p_attribute_02=>'P394_TOTAL'
...
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_attribute_01=>'doDescarga(apex.item(''P394_SER_RECIBO'').getValue(), apex.item(''P394_NRO_RECIBO'').getValue());'
);
wwv_flow_imp_page.create_page_da_event(
...
'        :P394_IMPORTE_ADD := NVL(:P394_MONTO_CUOTA_ADD,0);',
'    END IF;  ',
'--APEX_DEBUG.ERROR(''P394_TOTAL_AUX ''||:P394_TOTAL_AUX);  ',
'--APEX_DEBUG.ERROR(''P394_IMPORTE_ADD ''||:P394_IMPORTE_ADD);',
'--APEX_DEBUG.ERROR(''P394_V_IMPORTE_ANT ''||:P394_V_IMPORTE_ANT);',
'    :P394_TOTAL_AUX := NVL(:P394_TOTAL_AUX,0) + NVL(:P394_IMPORTE_ADD,0) - NVL(:P394_V_IMPORTE_ANT,0);',
'    :P394_V_IMPORTE_ANT := NVL(:P394_IMPORTE_ADD,0);',
'    :P394_TOTAL := :P394_TOTAL_AUX;',
'    :P394_TOTAL := TO_CHAR(:P394_TOTAL, ''999G999G999G999G999D00'');',
