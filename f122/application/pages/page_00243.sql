...
,p_last_upd_yyyymmddhh24miss=>'20221220084811'
);
...
'and :P243_AUX_CONTROL_REPORTE is not null;',
' ',
'',
''))
,p_plug_source_type=>'NATIVE_IR'
,p_ajax_items_to_submit=>'P243_AUX_CONTROL_REPORTE'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
...
,p_prn_page_header=>'CONSULTA_DATOS'
...
,p_is_default=>'Y'
,p_display_rows=>10
,p_report_columns=>'TIP_COMPROBANTE:SER_COMPROBANTE:NRO_COMPROBANTE:COD_ARTICULO:COD_ART_CORTO:DESC_ARTICULO:COD_CLIENTE:NRO_GARANTIA:IND_DEVUELTO:DETALLE:'
);
wwv_flow_imp_page.create_page_plug(
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(58988202878344149)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(59100201370479720)
,p_name=>'P243_AUX_CONTROL_REPORTE'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_imp.id(58418540054106143)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(59100384117479721)
,p_name=>'P243_AUX_MSJ_CONTROL'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_imp.id(58418540054106143)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(59099752276479715)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(59099832182479716)
,p_event_id=>wwv_flow_imp.id(59099752276479715)
,p_event_result=>'TRUE'
...
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(61697614632624302)
);
wwv_flow_imp_page.create_page_da_action(
...
'IF (:P243_NRO_COMPROBANTE IS NULL ',
'    AND :P243_NRO_GARANTIA IS NULL ',
'    AND :P243_COD_ARTICULO IS NULL ',
'    AND :P243_COD_CLIENTE IS NULL  ',
'    AND :P243_FECHA_FACTURA IS NULL) THEN',
'    :P243_AUX_MSJ_CONTROL := ''INTRODUZCA UN VALOR'';',
' ELSE    ',
'    :P243_AUX_MSJ_CONTROL := null;',
'    BEGIN',
'        STCONGAR.pr_crear_collection(PI_NRO_FACTURA => :P243_NRO_COMPROBANTE,',
...
'        :P243_AUX_CONTROL_REPORTE := ''EJECUTAR'';',
'        EXCEPTION',
'            WHEN OTHERS THEN',
'            APEX_DEBUG.ERROR(''ERROR EN PROCEDIMIENTO CREAR COLLECTION'');',
'            APEX_DEBUG.ERROR(SQLERRM);',
'    END;',
'END IF;'))
,p_attribute_02=>'P243_NRO_COMPROBANTE,P243_COD_ARTICULO,P243_NRO_GARANTIA,P243_FECHA_FACTURA,P243_COD_CLIENTE'
,p_attribute_03=>'P243_AUX_CONTROL_REPORTE,P243_AUX_MSJ_CONTROL'
,p_attribute_04=>'N'
...
,p_attribute_01=>'&P243_AUX_MSJ_CONTROL.'
,p_attribute_02=>'ERROR'
,p_attribute_03=>'warning'
,p_client_condition_type=>'NOT_NULL'
,p_client_condition_element=>'P243_AUX_MSJ_CONTROL'
);
wwv_flow_imp_page.create_page_da_action(
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(59103022760479748)
,p_event_id=>wwv_flow_imp.id(59099964685479717)
,p_event_result=>'TRUE'
...
,p_affected_elements=>'P243_COD_CLIENTE,P243_FECHA_FACTURA,P243_NRO_COMPROBANTE,P243_NRO_GARANTIA,P243_COD_ARTICULO'
);
wwv_flow_imp_page.create_page_da_event(
