...
,p_last_upd_yyyymmddhh24miss=>'20230209175802'
);
...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'COD_ARTICULO:DESCRIPCION:CANT:OK:CANT_ENVIAR:EDITAR:DETALLE:MAS:'
);
wwv_flow_imp_page.create_page_plug(
...
,p_plug_name=>'Agregar/Editar Cantidad Enviar'
,p_region_template_options=>'#DEFAULT#:js-dialog-autoheight:js-dialog-size600x400'
,p_plug_template=>wwv_flow_imp.id(40117728043263659)
...
,p_button_template_id=>wwv_flow_imp.id(40187749278263678)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Editar Cantidad a Enviar'
,p_button_position=>'BELOW_BOX'
,p_warn_on_unsaved_changes=>null
);
wwv_flow_imp_page.create_page_button(
...
,p_named_lov=>'LV_SUCURSALES_STREPED1'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(107762231976856122)
,p_event_id=>wwv_flow_imp.id(107762067547856120)
,p_event_result=>'TRUE'
...
'EXCEPTION',
'    WHEN OTHERS THEN',
'    APEX_DEBUG.ERROR(''DA_ACTUALIZAR ''||SQLERRM);',
'END;'))
,p_attribute_02=>'P379_COD_SUCURLSA_SAL ,P379_COD_SUCURSAL_ENT,P_COD_EMPRESA'
,p_attribute_03=>'P379_CONTROL_NULL'
,p_attribute_04=>'N'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
...
'EXCEPTION',
'    WHEN OTHERS THEN',
'    APEX_DEBUG.ERROR(''DA_SELECCIONAR ''||SQLERRM);',
'END;'))
,p_attribute_02=>'P379_AUX_SEQ_ID,P379_ACCION'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
...
'EXCEPTION',
'    WHEN OTHERS THEN',
'    APEX_DEBUG.ERROR(''DA_SELECCIONAR CAMBIAR_CANT_ENVIO ''||SQLERRM);',
'END;'))
...
'EXCEPTION',
'    WHEN OTHERS THEN',
'    APEX_DEBUG.ERROR(''DA_AGREGAR_EDITAR_CANT ''||SQLERRM);',
'END;'))
...
'EXCEPTION',
'    WHEN OTHERS THEN',
'    APEX_DEBUG.ERROR(''DA_GUARDAR_OBS ''||SQLERRM);',
'END;'))
...
'                                 pmensaje          => :P379_MENSAJE_ERROR_GEN_ENV,',
'                                 pcont             => VCONT);',
'        ',
'        IF NVL(VCONT,0) > 0 THEN',
'            :P379_URL := ''https://ngosaeca.com.py/reportes/rest_v2/reports/reports/STREPOREP.pdf?P_SUC_ENT=''||:P379_COD_SUCURSAL_ENT||''&P_SUC_SAL=''||:P379_COD_SUCURLSA_SAL||''&P_COD_EMPRESA=''||:P_COD_EMPRESA;--ACA LLAMA AL REPORTE',
'        END IF;',
'    END IF;',
'EXCEPTION',
'    WHEN OTHERS THEN',
'    APEX_DEBUG.ERROR(''DA_GENERAR_ENVIO ''||SQLERRM);',
'END;'))
