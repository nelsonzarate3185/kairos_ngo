...
,p_last_upd_yyyymmddhh24miss=>'20230308134803'
);
...
,p_lov=>'STATIC:NGO;NGO,CHP;CHP,GONZALITO;GONZALITO'
,p_lov_display_null=>'YES'
...
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
'SELECT case when ESTADO =''P'' THEN ''PENDIENTE''',
' WHEN ESTADO=''F'' THEN ''FIRMA BOLETA''',
' WHEN ESTADO=''A'' THEN ''ANULADO''',
' WHEN ESTADO=''R'' THEN ''CON RECIBO''',
' WHEN ESTADO=''N'' THEN ''DEVUELTO''',
'END D , ESTADO r',
'FROM vt_comprobantes_cabecera f',
'where  f.tip_comprobante = :P31_TIP_COMPROBANTE',
'and f.ser_comprobante = :P31_SER_COMPROBANTE',
...
||',P31_IMPORTE,P31_VOLUMEN,P31_ESTADO1,P31_ORDEN_ENTREGA,P31_MODIFICA_PLANILLA,P31_OLD_ESTADO_REPARTO,P31_FEC_CAMBIO_ESTADO,P31_COD_USUARIO_CAMBIO'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(10077891983914931)
,p_event_id=>wwv_flow_imp.id(10077562238914928)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_CONFIRM'
,p_attribute_01=>'Cambios guardados correctamente.'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(10077963863914932)
,p_event_id=>wwv_flow_imp.id(10077562238914928)
,p_event_result=>'TRUE'
,p_action_sequence=>50
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(95615113529774841)
,p_event_id=>wwv_flow_imp.id(10077562238914928)
,p_event_result=>'TRUE'
,p_action_sequence=>60
,p_execute_on_page_init=>'N'
...
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'doDescarga(apex.item(''P_COD_EMPRESA'').getValue(), apex.item(''P31_NRO_PLANILLA'').getValue(), ',
'           apex.item(''P31_FEC_PLANILLA'').getValue(),apex.item(''P31_COD_ZONA_REPARTO'').getValue(),',
'            apex.item(''P31_COD_REPARTIDOR'').getValue(), apex.item(''P31_NRO_COMPROBANTE'').getValue(),',
'            apex.item(''P31_SER_COMPROBANTE'').getValue())'))
);
wwv_flow_imp_page.create_page_da_event(
...
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(14068841772863734)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
...
,p_attribute_01=>'FUNCTION_BODY'
,p_attribute_06=>':P31_EMPRESA_ORIGEN :=null;'
,p_attribute_07=>'P31_EMPRESA_ORIGEN'
,p_attribute_08=>'N'
,p_attribute_09=>'Y'
,p_wait_for_result=>'Y'
);
