...
,p_last_upd_yyyymmddhh24miss=>'20240223151650'
);
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(268952797706157536)
,p_query_column_id=>7
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(268952893940157537)
,p_query_column_id=>8
...
,p_use_as_row_header=>'N'
,p_column_link=>'javascript:$s(''P716_DEL'',''#COD_VENDEDOR#''+''-''+''#ANIO#''+''-''+''#MES#'');'
...
,p_use_as_row_header=>'N'
,p_column_link=>'javascript:$s(''P716_EDT'',''#COD_VENDEDOR#''+''-''+''#ANIO#''+''-''+''#MES#'');'
...
'begin',
' select cod_vendedor, anio, mes, meta_mes_cerrado, nvl(cod_marca,''0''), nvl(porc_peso ,100)',
' into :P716_ABM_VENDEDOR, :P716_ABM_ANIO, :P716_ABM_MES, :P716_META, :P716_MARCA, :P716_PESO',
' from inv.fv_metas_vend_mensual',
' where cod_empresa = :P_COD_EMPRESA',
' and cod_vendedor||''-''||anio||''-''|| mes = :P716_EDT; ',
'exception',
'    when others then',
'        null;',
'end;'))
,p_attribute_02=>'P716_EDT'
,p_attribute_03=>'P716_ABM_VENDEDOR,P716_ABM_ANIO,P716_ABM_MES,P716_PESO,P716_MARCA,P716_META'
,p_attribute_04=>'N'
...
'      where cod_empresa= :P_COD_EMPRESA',
'      and cod_vendedor||''-''||anio||''-''||mes = :P716_DEL',
'      ;',
'  exception',
'    when others then',
'        null;',
...
,p_affected_elements=>'P716_ABM_VENDEDOR,P716_ABM_MES,P716_ABM_ANIO,P716_PESO,P716_MARCA,P716_META,P716_EDT'
...
'                                   (cod_empresa, cod_vendedor, anio, mes, meta_mes_cerrado, cod_marca, porc_peso)',
'                                 values',
'                                   (:P_COD_EMPRESA, :P716_ABM_VENDEDOR, :P716_ABM_ANIO, :P716_ABM_mes, replace(:P716_meta,''.'','''') , nvl(:P716_marca,''0''), nvl(:P716_peso,100));',
'                                 ',
'                        ELSE',
...
'                                    cod_marca = nvl(:P716_marca,''0''),',
'                                    porc_peso = nvl(:P716_peso,100)',
'                              where  cod_empresa = :P_COD_EMPRESA                              ',
'                              and   cod_vendedor||''-''||anio||''-''|| mes = :P716_EDT;                              ',
'',
'                        END IF;',
...
'',
''))
,p_attribute_02=>'P716_ABM_VENDEDOR,P716_ABM_ANIO,P716_ABM_MES,P716_MARCA,P716_PESO,P716_META,P716_DEL,P716_EDT'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
wwv_flow_imp_page.create_page_da_action(
