...
,p_last_upd_yyyymmddhh24miss=>'20231218094739'
);
...
,p_is_default=>'Y'
,p_display_rows=>20
,p_report_columns=>'FEC_COMPROBANTE:SER_COMPROBANTE:NRO_COMPROBANTE:COD_CLIENTE:NOM_CLIENTE:COD_VENDEDOR:COD_CONDICION_VENTA:COD_LISTA_PRECIO:TOT_COMPROBANTE:ESTADO:ESTADO_DISTRIBUCION_LOG:DESC_FLETE:DESC_TIPO_ENTREGA:AUTORIZADO:NRO_ORDEN_COMPRA:MARGEN:'
