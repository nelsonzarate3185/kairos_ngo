...
,p_last_upd_yyyymmddhh24miss=>'20230330155540'
);
...
'            p_values => r.id_catalogo||'',''||R.ID_IMAGEN )CARD_LINK-- "URL",',
'       --null CARD_LINK',
...
,p_link_target=>'f?p=&APP_ID.:416:&SESSION.::&DEBUG.::P416_ID_CATALOGO,P416_ID_IMAGEN:&ID_CATALOGO.,&ID_IMAGEN.'
);
