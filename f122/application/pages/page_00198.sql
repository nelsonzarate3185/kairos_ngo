...
,p_last_upd_yyyymmddhh24miss=>'20230419105317'
);
...
'      ',
'       VTRCARTE.calcular_porcentaje_por_marca(:P198_COD_EMPRESA, :P198_COD_CLIENTE, :P198_COD_VENDEDOR, ',
...
'       CS.COD_CATEG,',
'       CS.DESC_CATEGORIA,',
'       VTRCARTE.cal_porcentaje_VTRCARTC(:P198_COD_EMPRESA,CS.COD_CLIENTE, :P198_COD_VENDEDOR, ',
'       :P198_COD_LINEA_DES, CS.COD_MARCA, :P198_COD_CATEGORIA, :P198_PERIODO, :P198_FECHA_INI,',
...
'       CS.MONTO_VTA,       ',
'',
'       VTRCARTE.cal_porc_total_VTRCARCOM(:P198_COD_EMPRESA, :P198_COD_CLIENTE,CS.NOMBRE,  :P198_COD_VENDEDOR, ',
'       :P198_COD_LINEA_DES, :P198_COD_MARCA_DES, :P198_COD_CATEGORIA, :P198_PERIODO, :P198_FECHA_INI,',
'       :P198_FECHA_FIN)||''%'' PORC_TOTAL_VEND_EJEC, --PORC% ',
'       ',
'       ',
'       ',
'      VTRCARTE.cal_porcentaje_VTRCARCOM(:P198_COD_EMPRESA, :P198_COD_CLIENTE,  :P198_COD_VENDEDOR, ',
'        cs.cod_marca, CS.COD_CATEG, :P198_PERIODO, :P198_FECHA_INI,',
'      :P198_FECHA_FIN)||''%'' PORC_marca, -- PORC%',
'',
'',
'',
'       CASE WHEN (VTRCARTE.cal_porcentaje_VTRCARCOM(:P198_COD_EMPRESA, :P198_COD_CLIENTE,   :P198_COD_VENDEDOR, ',
'          cs.cod_marca, CS.COD_CATEG, :P198_PERIODO, :P198_FECHA_INI,',
'       :P198_FECHA_FIN)  ) >= 100 THEN',
'            0.1||''%''',
'            WHEN (VTRCARTE.cal_porcentaje_VTRCARCOM(:P198_COD_EMPRESA, :P198_COD_CLIENTE,   :P198_COD_VENDEDOR, ',
'          cs.cod_marca, CS.COD_CATEG, :P198_PERIODO, :P198_FECHA_INI,',
...
'',
'',
'      TO_NUMBER(CASE WHEN VTRCARTE.cal_porcentaje_VTRCARCOM(:P198_COD_EMPRESA, :P198_COD_CLIENTE,  :P198_COD_VENDEDOR, ',
'        cs.cod_marca, CS.COD_CATEG, :P198_PERIODO, :P198_FECHA_INI,',
'      :P198_FECHA_FIN)>= 100 THEN',
'            0.1',
'           WHEN VTRCARTE.cal_porcentaje_VTRCARCOM(:P198_COD_EMPRESA, :P198_COD_CLIENTE,  :P198_COD_VENDEDOR, ',
...
'           ELSE',
'            0',
'           END) * (VTRCARTE.cal_totalventa_marca_carcom(:P198_COD_EMPRESA, :P198_COD_CLIENTE,  :P198_COD_VENDEDOR, ',
'        :P198_COD_MARCA_DES, CS.COD_CATEG, :P198_PERIODO, :P198_FECHA_INI,',
'      :P198_FECHA_FIN)) COMISION_x_marca,  --COMISION',
'',
'         VTRCARTE.cal_totalventa_marca_carcom(:P198_COD_EMPRESA, :P198_COD_CLIENTE,  :P198_COD_VENDEDOR, ',
'        cs.cod_marca, CS.COD_CATEG, :P198_PERIODO, :P198_FECHA_INI,',
'      :P198_FECHA_FIN) total_ventas_x_marca, --TOTAL VENTA POR CATEG',
'      ',
'            VTRCARTE.cal_totalventa_VTRCARCOM(:P198_COD_EMPRESA, :P198_COD_CLIENTE,CS.NOMBRE,  :P198_COD_VENDEDOR, ',
'      :P198_COD_LINEA_DES, :P198_COD_MARCA_DES, :P198_COD_CATEGORIA, :P198_PERIODO, :P198_FECHA_INI,',
'      :P198_FECHA_FIN) sum_total_ventas,--TOTAL VENTAS',
'      ',
'      VTRCARTE.comision_vendedor_vtrcarcom(:P198_COD_EMPRESA, :P198_COD_CLIENTE, ',
'      ',
'        CASE WHEN (VTRCARTE.cal_porcentaje_VTRCARCOM(:P198_COD_EMPRESA, :P198_COD_CLIENTE,   :P198_COD_VENDEDOR, ',
'          cs.cod_marca, CS.COD_CATEG, :P198_PERIODO, :P198_FECHA_INI,',
'       :P198_FECHA_FIN)  ) >= 100 THEN',
