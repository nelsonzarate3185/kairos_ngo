...
,p_last_upd_yyyymmddhh24miss=>'20230907110528'
);
...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'COD_GRUPO_COMISION:DESCRIPCION:IMPORTE_BASE_COMISION:COD_ESCALA_FACT:PORC_PESO_FACT:APXWS_CC_001:COD_ESCALA_CUMP:PORC_PESO_CUMP:APXWS_CC_002:COD_USUARIO:FECHA_ALTA:COD_EMPRESA:'
);
wwv_flow_imp_page.create_worksheet_computation(
 p_id=>wwv_flow_imp.id(261967986488689124)
...
wwv_flow_imp_page.create_worksheet_computation(
 p_id=>wwv_flow_imp.id(261968320997689124)
,p_report_id=>wwv_flow_imp.id(187783688587550862)
