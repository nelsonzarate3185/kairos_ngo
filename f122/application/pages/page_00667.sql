...
,p_last_upd_yyyymmddhh24miss=>'20240202113421'
);
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(237966744430662605)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(237967352541662611)
,p_db_column_name=>'FECHA'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>'Fecha'
...
,p_button_template_options=>'t-Button--large:t-Button--stretch:t-Button--gapTop'
...
'where c.cod_banco = :P667_COD_BANCO and c.nro_cuenta = :P667_CUENTA_BANCO',
'group by c.fec_conciliacion',
'order by c.fec_conciliacion desc'))
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(237968812135662626)
,p_name=>'DA_LISTAR'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(237968716366662625)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(237968900697662627)
,p_event_id=>wwv_flow_imp.id(237968812135662626)
,p_event_result=>'TRUE'
...
'end;'))
,p_attribute_02=>'P667_COD_BANCO,P667_CUENTA_BANCO,P667_PERIODO'
,p_attribute_03=>'P667_TOTAL_EXTRACTO,P667_TOTAL_SISTEMA'
,p_attribute_04=>'N'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(237969310520662631)
,p_event_id=>wwv_flow_imp.id(237968812135662626)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(237970029351662638)
,p_event_id=>wwv_flow_imp.id(237968812135662626)
,p_event_result=>'TRUE'
...
'    elsif v_monto_extracto != v_monto_sistema then',
'        RAISE_APPLICATION_ERROR(-20001, ''La suma de operaciones de banco y sistema deben coincidir'');',
'    else',
...
'    end if;',
'end;'))
,p_attribute_02=>'P667_MARCADO_EXTRACTO,P667_MARCADO_SISTEMA,P667_COD_BANCO,P667_CUENTA_BANCO,P667_PERIODO'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
wwv_flow_imp_page.create_page_da_action(
