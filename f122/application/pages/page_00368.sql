...
,p_last_upd_yyyymmddhh24miss=>'20230309095109'
);
...
'and   cca.tip_comprobante_ref=''ORT'')  ref',
...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'COD_ARTICULO:DESC_ART:FEC_ENT_SAL:HORA_ALTA:REF:NRO_LOTE:DESC_MOTIVO:COD_CLIENTE:CANT_ENT:CANT_SAL:'
);
wwv_flow_imp_page.create_page_plug(
...
'        s.descripcion desc_sucursal, upper( t.descripcion ), c.nro_comprobante, ',
...
'',
'  Select lpad( a.cod_articulo, 20, '' '' ) cod_articulo, a.descripcion desc_art,'''',',
unistr('        s.descripcion desc_sucursal, ''NOTA DE ENV\00CDO'', c.nro_envio,'),
...
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select descripcion,cod_art_corto, cod_articulo',
'from st_articulos ',
'where cod_empresa = :p_cod_empresa ',
'order by descripcion'))
,p_lov_display_null=>'YES'
