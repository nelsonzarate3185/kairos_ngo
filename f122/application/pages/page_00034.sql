...
,p_last_upd_yyyymmddhh24miss=>'20240227103002'
);
...
',PORC_IVA',
',NRO_promo      ',
', (inv.vtpedido_34.fn_agrega_estilos(p_ser_comprobante    => NVL(SER_PEDIDO,:P34_SER_COMPROBANTE),',
...
'</div>'))
,p_ajax_enabled=>'Y'
,p_ajax_items_to_submit=>'P34_NRO_COMPROBANTE,P34_SER_COMPROBANTE,P34_ESTADO'
,p_lazy_loading=>false
,p_query_row_template=>wwv_flow_imp.id(40147995650263667)
,p_query_num_rows=>15
,p_query_options=>'DERIVED_REPORT_COLUMNS'
...
'end if;',
'END;'))
,p_attribute_02=>'P34_COD_ARTICULO_ENTREGA,P34_CANTIDAD_ENTREGA,P34_SUCURSAL_DIST_ENTREGA,P34_FECHA_ENTREGA_DETALLE,P34_FECHA_ENTREGA'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
wwv_flow_imp_page.create_page_da_action(
...
'end;'))
,p_attribute_02=>'P34_COD_CONDICION_VENTA,P34_COD_LISTA_PRECIO'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
wwv_flow_imp_page.create_page_da_action(
...
'  END IF;',
'--  redondeo',
'VMONTO_TOTAL:=round(VMONTO_TOTAL / nvl( :P34_CANTIDAD,1)+ (VTOTAL_IVA / nvl( :P34_CANTIDAD,1)), 0 ) * :P34_CANTIDAD- VTOTAL_IVA;',
...
'',
'END;'))
,p_attribute_02=>'P34_MONTO_TOTAL,P34_TOTAL_IVA,P34_TOTAL,P34_COD_IVA,P34_COD_ARTICULO_DET,P34_COD_CLIENTE'
...
'      vtpedido_34.vtpedido_add_det(p12_ser_comprobante => :P34_ser_comprobante,',
...
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'BEGIN',
'  SELECT TRIM(to_char(PRECIO_web_APEX(:P34_COD_ARTICULO_DET,',
'                         :P34_COD_CLIENTE,',
'                         :P34_COD_LISTA_PRECIO,',
...
'FROM (',
'select nvl(f_descuento_tipo_cliente(:P34_cod_cliente, :P34_cod_condicion_venta,:P34_cod_lista_precio,:P34_cantidad ,:P34_cod_articulo_det, NULL),0) descuento',
'from dual ',
...
'   vunitario:=round(nvl(replace(:P34_precio_unitario,''.'',''''),0)/(1+(nvl(Vporc_iva,0))),nvl(Vdecimales,0));  ',
'end if;   ',
'--- raise_application_error(-20000, :P34_PORC_DESCUENTO );',
...
'END IF; ',
'--VMONTO_TOTAL:=round(VMONTO_TOTAL / nvl( :P34_CANTIDAD,1)+ (VTOTAL_IVA / nvl( :P34_CANTIDAD,1)), 0 ) *nvl( :P34_CANTIDAD,1)- VTOTAL_IVA;',
'--VTOTAL_IVA:=ROUND(VMONTO_TOTAL*:P34_PORC_IVA);',
'--VMONTO_TOTAL:=round(VMONTO_TOTAL / nvl( :P34_CANTIDAD,1)+ (VTOTAL_IVA / nvl( :P34_CANTIDAD,1)), 0 ) *nvl( :P34_CANTIDAD,1)- VTOTAL_IVA;',
':P34_COD_IVA    := VCOD_IVA;',
':P34_PORC_IVA   := nvl(VPORC_IVA,0.1);',
...
,p_attribute_01=>'SQL_STATEMENT'
,p_attribute_03=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select nvl(f_descuento_tipo_cliente(:P34_cod_cliente, :P34_cod_condicion_venta,:P34_cod_lista_precio,NVL(:P34_cantidad,0) ,:P34_cod_articulo_det, NULL),0) descuento',
'from dual',
'WHERE NVL(:P34_SUCURSAL,''01'') NOT IN (''105'',''105.1'')',
'',
'UNION ALL',
...
'                VMSJ VARCHAR2(3500);',
'            BEGIN',
'              inv.vtpedido_34.crea_pedido(p34_sucursal => :p34_sucursal,',
...
'    VMJS VARCHAR2(3500);',
'begin ',
'  inv.vtpedido_34.actualiza_pedido(p34_sucursal => :p34_sucursal,',
'                                   p34_ser_comprobante => :p34_ser_comprobante,',
