...
,p_ajax_items_to_submit=>'P527_COD_EJERCICIO,P527_IND_REP_EJERCICIOS,P527_EMPRESA_NGO,P527_EMPRESA_CPH,P527_EMPRESA_TF'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
...
,p_column_label=>'Cod Auditor Asignado'
,p_column_type=>'STRING'
...
,p_column_label=>'Cod Auditor Realizado'
,p_column_type=>'STRING'
,p_display_text_as=>'LOV_ESCAPE_SC'
,p_column_alignment=>'CENTER'
,p_rpt_named_lov=>wwv_flow_imp.id(157718662397356757)
...
,p_column_label=>'Ind Planificado'
,p_column_type=>'STRING'
,p_column_alignment=>'CENTER'
,p_use_as_row_header=>'N'
);
...
'END;',
''))
,p_attribute_02=>'P527_EMPRESA_NGO,P527_EMPRESA_CPH,P527_EMPRESA_TF'
