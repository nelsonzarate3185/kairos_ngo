...
,p_name=>'Modificacion de datos Clientes - CCCLIMOD'
,p_alias=>'CCCLIMOD'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(207201055000570117)
...
,p_plug_name=>'REPORT DIRECCIONES'
,p_parent_plug_id=>wwv_flow_imp.id(207201055000570117)
...
,p_prn_page_header=>'REPORT DIRECCIONES'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(208338385565827007)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(209023027211930702)
,p_event_id=>wwv_flow_imp.id(208342695534827050)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(207201055000570117)
);
wwv_flow_imp_page.create_page_da_event(
