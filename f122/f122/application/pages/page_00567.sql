...
'                      a.FEC_CIERRE IS NOT NULL  AND a.NRO_SOL_CONF IS NOT NULL THEN',
'                  ''DONACION''',
'                  ',
...
'                  ',
'                  ',
'                  when a.cod_origen=''20'' and  a.tipo_cierre IN',
'                      (''CSR'', ''CSS'')  then ''RENTA''',
'                       when a.cod_origen=''20'' and  a.tipo_cierre IN',
'                      (''CR'')  then ''OFERTA''',
'               END RESOLUCION ',
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(188211937461298017)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(188212281757298020)
,p_query_column_id=>6
...
,p_button_redirect_url=>'f?p=&APP_ID.:566:&SESSION.::&DEBUG.:566::'
);
wwv_flow_imp_page.create_page_button(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(188212109257298019)
,p_name=>'P567_RESOLUCION_OT'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_imp.id(750134758899338367)
,p_prompt=>'Resolucion OT'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_tag_attributes=>'readonly'
,p_field_template=>wwv_flow_imp.id(40186634462263678)
