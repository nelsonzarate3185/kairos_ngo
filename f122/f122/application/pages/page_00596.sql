...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(199628163948447032)
,p_plug_name=>'C2'
,p_parent_plug_id=>wwv_flow_imp.id(104819363715095917)
...
,p_parent_plug_id=>wwv_flow_imp.id(104819600044095920)
,p_region_css_classes=>'u-color-17-border '
,p_region_template_options=>'#DEFAULT#:t-Region--removeHeader:t-Region--scrollBody:margin-top-sm:margin-left-sm:margin-right-sm'
,p_plug_template=>wwv_flow_imp.id(40125238939263661)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(199627848462447029)
,p_plug_name=>'R1'
,p_parent_plug_id=>wwv_flow_imp.id(104819503248095919)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(199627962000447030)
,p_plug_name=>'R2'
,p_parent_plug_id=>wwv_flow_imp.id(104819503248095919)
,p_region_template_options=>'#DEFAULT#:t-Region--removeHeader:t-Region--noBorder:t-Region--scrollBody'
,p_plug_template=>wwv_flow_imp.id(40125238939263661)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(199628009277447031)
,p_plug_name=>'R3'
,p_parent_plug_id=>wwv_flow_imp.id(104819503248095919)
,p_region_template_options=>'#DEFAULT#:t-Region--removeHeader:t-Region--scrollBody'
,p_plug_template=>wwv_flow_imp.id(40125238939263661)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(199628323531447034)
,p_plug_name=>'REPORT'
,p_parent_plug_id=>wwv_flow_imp.id(104819600044095920)
,p_region_template_options=>'#DEFAULT#:t-Region--removeHeader:t-Region--scrollBody'
,p_plug_template=>wwv_flow_imp.id(40125238939263661)
...
,p_plug_name=>'REPORT'
,p_parent_plug_id=>wwv_flow_imp.id(199628323531447034)
...
' )',
'*/',
'and (ESTADO=:P596_ESTADO OR :P596_ESTADO IS NULL )--OR :P596_ESTADO=''T'')',
'',
'AND (FEC_VISITA >= :P596_FECHA_INI OR :P596_FECHA_INI IS NULL )',
'AND (FEC_VISITA <= :P596_FECHA_FIN OR :P596_FECHA_FIN IS NULL )',
'',
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(199625427629447005)
...
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(199628163948447032)
,p_prompt=>'Fecha Fin'
...
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(199627848462447029)
...
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(199627962000447030)
,p_prompt=>'Motivo Aux'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_field_template=>wwv_flow_imp.id(40186634462263678)
,p_item_template_options=>'#DEFAULT#'
...
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(199628009277447031)
