...
,p_last_upd_yyyymmddhh24miss=>'20230310140457'
);
...
'IF :P63_TIPO_SOLICITUD =''SOLICITUD TECNICO'' AND :P63_UBICACION_DESTINO IS NULL THEN',
'    RETURN FALSE;',
'ELSE',
'    RETURN TRUE;',
'END IF;'))
...
'                SET F.OBSERVACION=:P63_COMENTARIO,',
'                F.ESTADO = ''S'',',
'                f.cod_usuario_proc = :P_COD_USUARIO,',
'                f.fec_proceso = sysdate ,',
'                f.hora_proceso = to_char( sysdate , ''hh24:mm:ss'')',
'                WHERE F.COD_EMPRESA  = ''1''',
'                AND F.SER_COMPROBANTE = :P63_SER_COMPROBANTE',
