...
,p_last_upd_yyyymmddhh24miss=>'20230119114921'
);
...
,p_region_template_options=>'#DEFAULT#:t-Region--removeHeader:t-Region--accent4:t-Region--textContent:t-Region--scrollBody'
,p_plug_template=>wwv_flow_imp.id(40125238939263661)
,p_plug_display_sequence=>10
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_attribute_01=>'N'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(61168218536524410)
...
,p_report_columns=>'TOTAL:MENU:ITEM:SER_COMPROBANTE:NRO_COMPROBANTE:FEC_COMPROBANTE:COD_CLIENTE:DESC_CLIENTE:TIPO_CLIENTE:DESC_MONEDA:VENDEDOR:TOT_COMPROBANTE:SELECCIONAR:'
,p_sort_column_1=>'0'
...
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:js-showMaximizeButton:t-Region--removeHeader:t-Region--textContent:t-Region--scrollBody'
...
||'TE,DISTRIBUCION;RP,GENTE CPH;GC,PENDIENTE DE RIESGOS;PR'
...
':P240_FECHA_DESDE:= ''10/10/2015''; --LAST_DAY(ADD_MONTHS(SYSDATE,-1))+1;',
'END IF;',
