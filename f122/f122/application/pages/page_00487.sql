...
'            + ''P_COD_EMPRESA='' + p_cod_empresa + ''&P_COD_SUCURSAL_HAS='' + p_cod_sucursal_has  + ''&P_COD_LINEA=''+ p_cod_linea',
'            + ''&P_GRUPO=''+ p_grupo + ''&P_COD_FAMILIA=''+ p_cod_familia + ''&P_IND_RESERVA=''+ p_ind_reserva',
'            + ''&P_COD_PROVEEDOR=''+ p_cod_proveedor + ''&P_INCLUYE_EXISTENCIA_CERO=''+ p_incluye_existencia_cero + ''&P_COD_CATEGORIA=''+ p_cod_categoria + ''&P_COD_SUB_BLOQUE=''+ p_cod_sub_bloque',
'            + ''&P_COD_SUCURSAL_DES=''+ p_cod_sucursal_des+ ''&P_NOMBRE1=''+ p_nombre1+''&P_NOMBRE2=''+ p_nombre2+''&P_NOMBRE3=''+ p_nombre3',
'            +''&P_NOMBRE4=''+ p_nombre4 +''&P_VER_EXISTENCIA=''+ p_ver_existencia +''&P_COD_BARRA=''+ p_cod_barra+''&P_COD_LOTE=''+ p_cod_lote+''&P_COD_EMPRESA=''+ p_cod_empresa+''&P_ORDEN=''+ p_orden',
'            +''&P_COD_ARTICULO_HAS=''+ p_cod_articulo_has+''&P_COD_MARCA=''+ p_cod_marca+''&P_COD_BLOQUE=''+ p_cod_bloque+''&P_COD_ARTICULO_DES=''+ p_cod_articulo_des+''&P_COD_RUBRO=''+ p_cod_rubro+''&j_username=jasperadmin&j_password=jasperadmin'';*/',
'',
'    var vURL = ''https://ngosaeca.com.py/reportes/rest_v2/reports/reports/STEXISINVEN.pdf?''',
...
,p_last_upd_yyyymmddhh24miss=>'20230512145500'
);
...
'   where e.cod_empresa  = :p487_cod_empresa',
...
'       cod_rubro R',
'from st_rubro ',
'where cod_empresa = :P487_COD_EMPRESA',
'order by 1;'))
,p_cSize=>30
,p_begin_on_new_line=>'N'
,p_field_template=>wwv_flow_imp.id(40186634462263678)
