...
,p_last_upd_yyyymmddhh24miss=>'20230803080439'
);
...
'   and cod_sucursal in (select deposito',
'                          from mo_usuarios M',
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(188212001828298018)
,p_query_column_id=>6
,p_column_alias=>'INVENTARIO_OT'
,p_column_display_sequence=>70
,p_column_heading=>'Inventario Ot'
,p_use_as_row_header=>'N'
,p_disable_sort_column=>'N'
,p_derived_column=>'N'
,p_include_in_export=>'Y'
