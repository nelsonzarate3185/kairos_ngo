...
,p_last_upd_yyyymmddhh24miss=>'20230914081833'
);
...
,p_value_alignment=>'LEFT'
,p_link_target=>unistr('f?p=&APP_ID.:322:&SESSION.::&DEBUG.::P322_P_SER_COMPROBANTE,P322_P_NRO_COMPROBANTE,P322_P_COD_MARCA:&"Serie".,&"N\00FAmero".,')
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(110449279374068116)
,p_name=>'NUMERO'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(110449359525068117)
,p_name=>'COD_MARCA'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(205487263715264377)
,p_view_id=>wwv_flow_imp.id(5339731613581044)
,p_display_seq=>16
,p_column_id=>wwv_flow_imp.id(110449279374068116)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(205602414479196684)
,p_view_id=>wwv_flow_imp.id(5339731613581044)
,p_display_seq=>17
,p_column_id=>wwv_flow_imp.id(110449359525068117)
,p_is_visible=>true
,p_is_frozen=>false
);
