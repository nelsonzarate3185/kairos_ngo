...
,p_rpt_named_lov=>wwv_flow_imp.id(188203058888461716)
...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'COD_GRUPO_COMISION:DESCRIPCION:TIPO_CALCULO_FACT:COD_ESCALA_FACT:COD_ESCALA_CUMP:IMPORTE_BASE_COMISION:PORC_PESO_FACT:APXWS_CC_001:PORC_PESO_CUMP:APXWS_CC_002:FECHA_ALTA:COD_USUARIO:COD_EMPRESA:'
);
wwv_flow_imp_page.create_worksheet_computation(
 p_id=>wwv_flow_imp.id(188255775887829366)
...
wwv_flow_imp_page.create_worksheet_computation(
 p_id=>wwv_flow_imp.id(188256181047829365)
,p_report_id=>wwv_flow_imp.id(187783688587550862)
...
,p_plug_name=>'NUEVO GRUPO COMISION'
...
,p_name=>'P579_N_TIPO_CALCULO'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(187802356103448419)
,p_prompt=>'Tipo Calculo'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>'STATIC:POR CLIENTE;CLIENTE,POR MARCA;MARCA'
,p_lov_display_null=>'YES'
,p_cHeight=>1
,p_field_template=>wwv_flow_imp.id(40186634462263678)
,p_item_template_options=>'#DEFAULT#'
...
,p_attribute_01=>'null;'
,p_attribute_02=>'P579_N_ESCALA_FACT'
...
,p_affected_elements=>'P579_N_DESCRIPCION,P579_N_ESCALA_FACT,P579_N_PORC_FACT,P579_N_ESCALA_CUMP,P579_N_PORC_CUMP,P579_N_TIPO_CALCULO,P579_N_BASE_COM'
...
'                            raise verror;',
'                    else',
'                        if :P579_N_TIPO_CALCULO is null or :P579_N_BASE_COM is null then',
'                                vmensaje:=''Debe cargar correctamente el Importe Base de Comision y el Tipo para la Forma de Calculo.'';',
'                                raise verror;',
'',
'                        else    ',
'                            begin',
...
'                            end;',
'   /*',
'                            vmensaje:=REPLACE(TO_CHAR(:P579_N_PORC_fact),'','',''.'')||'' -- ''||REPLACE(TO_CHAR(:P579_N_PORC_cump),'','',''.'')||'' -- ''|| REPLACE(TO_CHAR(:P579_N_BASE_COM),''.'','''')  ;',
'                           ',
'                            raise verror;            ',
'    */          ',
'                                insert into inv.fv_grupos_comision',
'                                  (cod_empresa, cod_grupo_comision,  cod_usuario, descripcion, fecha_alta, tipo_calculo_fact, ',
'                                  cod_escala_fact, cod_escala_cump, porc_peso_fact, porc_peso_cump, importe_base_comision)',
'                                values',
'                                  (:P_COD_EMPRESA, vcodigo, NVL(:P_COD_USUARIO,USER), :P579_N_DESCRIPCION , sysdate, :P579_N_TIPO_CALCULO ,',
...
'end;'))
,p_attribute_02=>'P579_N_DESCRIPCION,P579_N_ESCALA_FACT,P579_N_PORC_FACT,P579_N_ESCALA_CUMP,P579_N_PORC_CUMP,P579_N_TIPO_CALCULO,P579_N_BASE_COM'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
