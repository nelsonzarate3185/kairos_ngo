...
,p_last_upd_yyyymmddhh24miss=>'20230907091950'
);
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(202410617394397803)
,p_name=>'AREA'
,p_source_type=>'DB_COLUMN'
...
,p_is_required=>false
,p_lov_type=>'STATIC'
,p_lov_source=>'STATIC:COMERCIAL;COMERCIAL,MARKETING;MARKETING'
,p_lov_display_extra=>true
,p_lov_display_null=>true
,p_enable_filter=>true
,p_filter_operators=>'C:S:CASE_INSENSITIVE:REGEXP'
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(202733206154263335)
,p_view_id=>wwv_flow_imp.id(68346445717457766)
,p_display_seq=>13
,p_column_id=>wwv_flow_imp.id(202410617394397803)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_page_plug(
