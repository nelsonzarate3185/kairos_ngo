...
,p_last_upd_yyyymmddhh24miss=>'20230915114109'
);
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(207266528024334546)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(207266949794334545)
,p_report_id=>wwv_flow_imp.id(207140666719834473)
...
'values (:p_cod_empresa,:P93_COD_ARTICULO,:P93_COD_LISTA_PRECIO,:P93_FEC_VIGENCIA,:P93_COD_MONEDA,:P93_PRECIO_FIJO,:P93_ACTIVO);',
'end; ',
'ELSE',
'UPDATE vt_precios_fijos',
'SET PRECIO_FIJO=:P93_PRECIO_FIJO, ACTIVO= :P93_ACTIVO,fec_vigencia=:P93_FEC_VIGENCIA',
'WHERE ROWID=:P93_ROWID_PRECIOS_FIJOS;',
'END IF;'))
