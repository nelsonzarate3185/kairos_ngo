...
'                    pageId:370,',
'                    itemNames: ["P370_COD_CLIENTE", "P370_PARAM_NRO_OT", "P370_PARAM_SER_OT", "P370_OPERACION", "P370_COD_ARTICULO_OT", "P370_COD_ARTICULO_OT_1", "P370_NRO_COMPROBANTE_REF", "P370_COD_ORIGEN_AUX","P370_GARANT"],',
'                    itemValues: [p_cod_cliente, p_nro_comprobante, p_ser_comprobante, "MODIFICAR", p_cod_articulo, p_cod_articulo, p_nro_comprobante,p_origen,p_garantia]',
'                }));',
'',
'}'))
...
' where collection_name = ''VT_ORDEN_TRABAJO''',
' order by to_date(c005, ''DD/MM/YYYY'') DESC;'))
,p_plug_source_type=>'NATIVE_IR'
,p_ajax_items_to_submit=>'P400_FECHA_INI,P400_PROVEEDOR'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(131434766077373222)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(131434837009373223)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(131434957554373224)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(131435002779373225)
...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'FINALIZAR:OT:ESTADO:NOM_CLIENTE:TIPO_CLIENTE:IND_GARANTIA:COD_ARTICULO:DESC_ARTICULO:FECHA:HORA_CREACION:'
,p_sort_column_1=>'0'
...
,p_button_redirect_url=>'f?p=&APP_ID.:370:&SESSION.::&DEBUG.:CR,400,370:P370_OPERACION,P370_NRO_PAGINA:AGREGAR,&P400_PAGINA.'
...
,p_event_sequence=>50
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P400_FECHA_INI'
,p_bind_type=>'bind'
,p_bind_event_type=>'change'
);
wwv_flow_imp_page.create_page_da_action(
