...
'       SYSDATE,',
'       NULL,',
'       :P342_OBSERVACION_ADD,',
'       :P342_TIP_COMPROBANTE_REF,',
'       :P342_SER_COMPROBANTE_REF,',
'       :P342_NRO_COMPROBANTE_REF,',
...
'EXCEPTION',
'    WHEN OTHERS THEN',
'    APEX_DEBUG.ERROR(''DA_AGREGAR_EDITAR ADD_DET ''||SQLERRM);',
'END;'))
...
'EXCEPTION',
'    WHEN OTHERS THEN',
'    APEX_DEBUG.ERROR(''DA_AGREGAR_EDITAR EDIT_DET ''||SQLERRM);',
'END;'))
...
'EXCEPTION',
'    WHEN OTHERS THEN',
'    APEX_DEBUG.ERROR(''DA_AGREGAR_EDITAR CALCULAR_TOTAL ''||SQLERRM);',
'END;'))
,p_attribute_02=>'P342_NUM_ENT_SAL,P_COD_EMPRESA'
...
'EXCEPTION',
'    WHEN OTHERS THEN',
'    APEX_DEBUG.ERROR(''DA_AGREGAR_EDITAR CALCULAR_CANTIDAD ''||SQLERRM);',
'END;'))
,p_attribute_02=>'P342_NUM_ENT_SAL,P_COD_EMPRESA'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(99675241430806509)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(99675328330806510)
,p_event_id=>wwv_flow_imp.id(99675241430806509)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
'EXCEPTION',
'    WHEN OTHERS THEN',
'    APEX_DEBUG.ERROR(''PR_INIT PAG. 342 ''||SQLERRM);',
'END;'))
,p_process_clob_language=>'PLSQL'
);
wwv_flow_imp_page.create_page_process(
...
'EXCEPTION',
'    WHEN OTHERS THEN',
'    APEX_DEBUG.ERROR(''PR_INIT_2 ''||SQLERRM);',
'END;'))
,p_process_clob_language=>'PLSQL'
);
wwv_flow_imp_page.create_page_process(
