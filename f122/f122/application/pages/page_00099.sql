...
||'EMPRESA=''+p_cod_empresa+''&P_TIP_COMPROBANTE=''+p_tip_comprobante+''&P_SER_COMPROBANTE=''+p_ser_comprobante+''&P_NRO_COMPROBANTE=''+p_nro_comprobante+''&P_COD_CLIENTE=''+p_cod_cliente+''&P_REIMPRESO=''+p_reimpreso+''&P_IMPRIME_CONDICION=S''+''&P_PAGADO=''+p_pagado'
...
'             ''&standAlone=true&j_username=jasperadmin&j_password=jasperadmin&output=pdf&P_COD_EMPRESA='' + p_cod_empresa + ''&P_TIP_COMPROBANTE='' + p_tip_comprobante  + ',
...
,p_last_upd_yyyymmddhh24miss=>'20230809153934'
);
...
'   from talonarios ',
'  where cod_empresa = :P_COD_EMPRESA ',
'    and tip_talonario = :P99_TIP_CONTADO ',
...
,p_client_condition_type=>'EQUALS'
,p_client_condition_element=>'P99_SHOW_LOV_CRE'
,p_client_condition_expression=>'1'
);
wwv_flow_imp_page.create_page_da_action(
...
,p_client_condition_type=>'EQUALS'
,p_client_condition_element=>'P99_SHOW_LOV_TCK'
,p_client_condition_expression=>'1'
);
wwv_flow_imp_page.create_page_da_action(
...
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
,p_attribute_01=>':P99_TOTAL_1 := :P99_TOTAL;'
...
'END IF;',
'',
':P99_SER_COMPROBANTE_REF := ''A'';--:P99_SER_COMPROBANTE; --''A'' ; --=--=--=--',
'',
...
unistr('              RAISE_APPLICATION_ERROR(-20001, ''El art\00EDculo no cuenta con Nro. de Lote'');'),
'          END IF;',
'      END LOOP;',
'',
'  END;',
...
'         IF nvl( vplazo, 0 ) > 1 AND :P99_TIP_COMPROBANTE=''FCO'' THEN',
'            ',
unistr('            RAISE_APPLICATION_ERROR(-20001, ''Condici\00F3n de Ventas no V\00E1lida para la venta de tipo contado'');'),
'             ',
'           ',
'        END IF;',
'',
'     IF nvl( vplazo, 0 ) =0 AND :P99_TIP_COMPROBANTE=''FCR'' THEN',
unistr('                  RAISE_APPLICATION_ERROR(-20001, ''Condici\00F3n de Ventas no V\00E1lida para la venta de tipo credito'');'),
'           ',
'        END IF;',
'',
'    EXCEPTION',
'     when xbloqueado then',
unistr('               RAISE_APPLICATION_ERROR(-20001, ''Condici\00F3n de Ventas no V\00E1lida para el tipo de venta'');'),
'      when others then ',
'         null;',
'    END;    ',
'',
...
'pkg_factura_electronica.sp_factura_electronica_metodos(P_ENTIDAD => null,',
