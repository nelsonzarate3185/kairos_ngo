...
,p_last_upd_yyyymmddhh24miss=>'20230712153736'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(140579693720633944)
,p_plug_name=>unistr('Pedidos para Reposici\00F3n de Productos')
...
'            				    p_items  => ''P339_P_NRO_COMPROBANTE,P193_SER_COMPROBANTE,P339_P_SER_COMPROBANTE'', ',
'            				    p_values =>  ''''||:P479_P_NRO_COMP_ENVIAR||'',',
'                                              ''''A'''''') f_url_1',
'		INTO :P479_URL',
'		FROM DUAL;        ',
'	  ',
...
'    ELSIF to_number(:P479_CANTIDAD_A_ENVIAR) < 0 THEN',
...
' ',
'',
'    IF nvl(:P479_CANTIDAD_A_ENVIAR, 0) > 0 THEN ',
'		:P479_VOL_TOTAL := nvl(:P479_VOL_TOTAL,0) - (V_CANT_ANT * V_VOL_UNIT);',
'		V_CANT_ANT := :P479_CANTIDAD_A_ENVIAR;',
'		:P479_VOL_TOTAL := nvl(:P479_VOL_TOTAL,0)+(:P479_CANTIDAD_A_ENVIAR * V_VOL_UNIT); ',
'    END IF;',
'',
'    APEX_COLLECTION.UPDATE_MEMBER_ATTRIBUTE (P_COLLECTION_NAME => ''PED_REP'',',
'                                             P_SEQ             => :P479_SEQ_ID_PED_EDITAR ,',
