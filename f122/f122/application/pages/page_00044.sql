...
,p_last_upd_yyyymmddhh24miss=>'20230706151456'
);
...
'AND C.COD_PERSONA=P.COD_PERSONA',
'and activo=''S''',
'and cod_cobrador in (''38'',''10'',''119'',''46'',''95'',''96'',''49'',''97'',''123'',''107'')',
'UNION ALL',
...
'and activo=''S''',
' ',
'and cod_cobrador in( ''51'',''50'',''104'',''53'',''67'',''65'',''52'',''68'',''123'',''107'')',
' order by 1'))
,p_lov_display_null=>'YES'
,p_cSize=>30
,p_field_template=>wwv_flow_imp.id(40186937130263678)
...
'and cod_cobrador in (''38'',''10'',''119'',''46'',''95'',''96'',''49'',''97'')',
'UNION ALL',
'select    C.COD_COBRADOR',
'  from CC_COBRADORES@DBLINK_CPH C, PERSONAS@DBLINK_CPH P',
'WHERE C.COD_EMPRESA=''1''',
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(11408695976001501)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(11409103945001501)
,p_event_id=>wwv_flow_imp.id(11408695976001501)
,p_event_result=>'TRUE'
...
'BEGIN',
'SELECT COD_CLIENTE, COD_COBRADOR, COD_MONEDA, COD_CUSTODIO, FEC_RECIBO, ',
'case when anulado=''S'' THEN ''S'' WHEN NRO_MOV_CAJ IS NOT NULL THEN ''C'' ELSE ''P'' END ESTADO',
'INTO :P44_COD_CLIENTE,:P44_COD_COBRADOR,:P44_COD_MONEDA,:P44_COD_CUSTODIO,:P44_FEC_COMPROBANTE,:P44_anulado',
'FROM CC_RECIBOS A WHERE COD_EMPRESA=''1'' AND :P44_SER_COMPROBANTE=SER_RECIBO',
'AND :P44_NRO_COMPROBANTE=NRO_RECIBO;',
...
'case when anulado=''S'' THEN ''S'' WHEN NRO_MOV_CAJ IS NOT NULL THEN ''C'' ELSE ''P'' END ESTADO',
'INTO :P44_COD_CLIENTE,:P44_COD_COBRADOR,:P44_COD_MONEDA,:P44_COD_CUSTODIO,:P44_FEC_COMPROBANTE,:P44_anulado',
'FROM CC_RECIBOS@DBLINK_CPH A WHERE COD_EMPRESA=''1'' AND :P44_SER_COMPROBANTE=SER_RECIBO',
'AND :P44_NRO_COMPROBANTE=NRO_RECIBO;',
'EXCEPTION WHEN OTHERS THEN ',
'NULL;',
'END;',
...
'END IF;',
'END IF;  '))
,p_attribute_02=>'P44_COD_CLIENTE,P44_NRO_COMPROBANTE,P44_EMPRESA_ORIGEN,P44_SER_COMPROBANTE,P_COD_USUARIO'
,p_attribute_03=>'P44_SER_COMPROBANTE,P44_FEC_COMPROBANTE,P44_COD_CUSTODIO,P44_COD_CLIENTE,P44_COD_MONEDA,P44_ANULADO'
,p_attribute_04=>'N'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(11409653338001501)
,p_event_id=>wwv_flow_imp.id(11408695976001501)
,p_event_result=>'TRUE'
...
'	declare',
'   cursor xsal is',
'     select c.TIP_FACTURA_REF tipo_comprobante, c.SER_FACTURA_REF ser_comprobante, c.NRO_FACTURA_REF nro_comprobante,',
'      c.nro_cuota,  c.MONTO_CUOTA as saldo_cuota, c.monto_cuota, c.cod_moneda_cuota, c.fec_vencimiento, anulado',
'from CC_DETALLE_RECIBOS c , cc_recibos rec',
'where c.cod_empresa = ''1''',
'and c.tip_recibo = ''REC''',
'and c.ser_recibo=:P44_SER_COMPROBANTE',
'and c.nro_recibo=:P44_NRO_COMPROBANTE',
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(11410196431001502)
,p_event_id=>wwv_flow_imp.id(11408695976001501)
,p_event_result=>'TRUE'
