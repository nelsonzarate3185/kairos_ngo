...
,p_last_upd_yyyymmddhh24miss=>'20230510174358'
);
...
'begin',
'    :P524_MENSAJE := NULL;',
'    if :P524_FEC_ALTA_INI IS NOT NULL or :P524_FEC_ALTA_FIN IS NOT NULL then',
...
'  ',
''))
,p_attribute_02=>'P524_FEC_ALTA_INI,P524_FEC_ALTA_FIN'
...
'',
'end;'))
,p_attribute_02=>'P524_COD_EMPRESA,                           P524_NRO_CANJE,P524_FEC_ALTA_INI,P524_FEC_ALTA_FIN,P524_COD_VENDEDOR,P524_COD_DISTRIBUIDOR,P524_COD_CLIENTE,P524_FEC_CARGA_INI,P524_FEC_CARGA_FIN,P524_IND_PUNTOS,P524_FEC_CANJE'
