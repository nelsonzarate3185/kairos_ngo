...
,p_last_upd_yyyymmddhh24miss=>'20230802124325'
);
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(180077557106026349)
...
,p_button_css_classes=>'u-color-7-border'
...
,p_button_position=>'RIGHT_OF_IR_SEARCH_BAR'
,p_button_redirect_url=>'f?p=&APP_ID.:560:&SESSION.::&DEBUG.:560::'
);
...
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
'SELECT M.DESCRIPCION, M.cod_marca',
'FROM st_marcas M',
...
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
'SELECT C.DESCRIPCION, C.COD_CATEGORIA',
...
||'CIERRE, P556_SUCURSAL, P556_OBSERVACION, P556_ID_INVENTURY_LOC, P556_INVENTARIOOT, P556_IND_INVENTARIO_CPH, P556_IND_ABIERTO, P556_USUARIO, P556_NRO_PLAN_INVENTARIO, P556_NRO_INVENTARIO_RECONTEO,P556_ERR,P556_INVENTARIOT'
,p_attribute_04=>'N'
...
'        PI_FECHA_ACTUALIZA => :P556_FECHA_ACTUALIZA,',
...
||'TUALIZA,P556_FECHA_CIERRE,P556_ID_INVENTURY,P_COD_EMPRESA,P556_INVENTARIOT,P556_INVENTARIOT'
...
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'begin',
'    IF NVL(:P556_INVENTARIOOT,''N'')=''N'' THEN',
'      if :P556_POLITICA_INVENTARIO=''FREE'' THEN     ',
...
'          STGEINMO.PR_OBTENER_TF (PI_COD_EMPRESA=> :P556_COD_EMPRESA,',
'                                PI_TIP_COMPROBANTE=> :P556_TIP_COMPROBANTE, ',
'                                PI_SER_COMPROBANTE=> :P556_SER_COMPROBANTE,',
'                                PI_NRO_COMPROBANTE => :P556_NRO_COMPROBANTE,',
'                                PI_COD_RUBRO=> :P556_COD_RUBRO,',
...
'        ELSE',
'            --CARGA_DETALLES;',
'             apex_debug.error(''entro a obtener detalles'');',
'            :P556_DETALLE_AUX:=''3'';',
'             STGEINMO.PR_OBTENER_DET (PI_COD_EMPRESA=> :P556_COD_EMPRESA,',
'                                PI_TIP_COMPROBANTE=> :P556_TIP_COMPROBANTE, ',
'                                PI_SER_COMPROBANTE=> :P556_SER_COMPROBANTE,',
'                                PI_NRO_COMPROBANTE => :P556_NRO_COMPROBANTE,',
'                                PI_COD_RUBRO=> :P556_COD_RUBRO,',
...
||'_INVENTARIO,P556_INVENTARIOOT,P556_IND_INVENTARIO_CPH'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(180187527249478501)
...
'    	/*		 INV.sp_reprocesa_conteo(                           :P_cod_empresa ,',
'    				                                            ''PR'',',
'    			                                                TO_DATE(:P556_FEC_COMPROBANTE -2,''dd/mm/yyyy'') ,',
'    			                                                TO_DATE(:P556_FEC_COMPROBANTE +5,''dd/mm/yyyy'')   ,',
'                                                                :P556_nro_comprobante  );*/',
'',
'        SELECT APEX_PAGE.GET_URL (  p_page   => 562,',
'                p_items  => ''P558_P_TIP_COMPROBANTE,P558_P_SER_COMPROBANTE,P558_P_NRO_COMPROBANTE,P558_P_COD_EMPRESA,P558_P_BLOQUE,P558_P_SUB_BLOQUE,P558_P_COD_ARTICULO,P558_P_IND_INVENTARIO_CPH,P558_EJECUTAR_REPORTE_1,P558_EJECUTAR_REPORTE_2,P558_EJ'
||'ECUTAR'',',
'                p_values => (''''||:P556_TIP_COMPROBANTE||'',''||:P556_SER_COMPROBANTE||'',''||:P556_NRO_COMPROBANTE||'',''||:P556_COD_EMPRESA||'',''||:P556_BLOQUE||'',''||:P556_SUB_BLOQUE||'',''||:P556_COD_ARTICULO||'',''||:P556_IND_INVENTARIO_CPH||'',''||null||'',''||'
||'null||'',''||''N''||'''')) f_url_1',
'                INTO :P556_URL ',
'                FROM DUAL;                                                       ',
'       :P556_BANDERA:=''1'';',
...
'                                    p_items  => ''P558_P_TIP_COMPROBANTE,P558_P_SER_COMPROBANTE,P558_P_NRO_COMPROBANTE,P558_P_COD_EMPRESA,P558_P_BLOQUE,P558_P_SUB_BLOQUE,P558_P_COD_ARTICULO,P558_P_IND_INVENTARIO_CPH,P558_EJECUTAR_REPORTE_1,P558_EJECUT'
||'AR_REPORTE_2,P558_EJECUTAR'',',
...
'                :P556_BANDERA:=''3'';',
'                SELECT APEX_PAGE.GET_URL (  p_page   => 558,',
'                                p_items  => ''P558_P_TIP_COMPROBANTE,P558_P_SER_COMPROBANTE,P558_P_NRO_COMPROBANTE,P558_P_COD_EMPRESA,P558_P_BLOQUE,P558_P_SUB_BLOQUE,P558_P_COD_ARTICULO,P558_P_IND_INVENTARIO_CPH,P558_EJECUTAR_REPORTE_1,P558_EJECUTAR_R'
||'EPORTE_2,P558_EJECUTAR'',',
...
'    END IF;',
'end;'))
,p_attribute_02=>'P556_FEC_COMPROBANTE,P556_NRO_COMPROBANTE,P556_INVENTARIOOT,P556_TIP_COMPROBANTE,P556_SER_COMPROBANTE,P556_BLOQUE,P556_SUB_BLOQUE,P556_COD_ARTICULO,P556_COD_EMPRESA'
...
||' P556_IND_ABIERTO, P556_USUARIO, P556_NRO_PLAN_INVENTARIO, P556_NRO_INVENTARIO_RECONTEO,P556_ERR,P556_FECHA_ACTUALIZADA,P556_FECHA_CIERRE,P556_FECHA_ACTUALIZADA,P556_USUARIO_CREADOR,P556_FECHA_ACTUALIZA,P556_INVENTARIOT'
,p_attribute_04=>'N'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
...
,p_attribute_03=>'P556_COD_SUCURSAL_AUX,P556_FEC_COMPROBANTE,P556_POLITICA_INVENTARIO,P556_ID_INVENTURY,P556_FECHA_ACTUALIZA,P556_USUARIO_CREADOR,P556_USUARIO_CIERRE,P556_FECHA_CIERRE,P556_SUCURSAL,P556_OBSERVACION,P556_ID_INVENTURY_LOC,P556_INVENTARIOOT,P556_IND_INVE'
||'NTARIO_CPH,P556_IND_ABIERTO,P556_USUARIO,P556_NRO_PLAN_INVENTARIO,P556_NRO_INVENTARIO_RECONTEO,P556_ES_RECONTEO,P556_SER_COMPROBANTE,P556_IND_INVENTARIO_CPH,P556_POLITICA_INVENTARIO'
,p_attribute_04=>'N'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
