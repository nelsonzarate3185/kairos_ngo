...
,p_last_upd_yyyymmddhh24miss=>'20230801114207'
);
...
'	--AND a.NRO_SOLICITUD = 3',
'	AND (a.DEPARTAMENTO = :P573_DEPARTAMENTO_B',
'		OR :P573_DEPARTAMENTO_B IS NULL)',
'	/**/',
'	AND (a.FECHA_CREACION = :P573_FECHA_DESDE OR :P573_FECHA_DESDE IS NULL)',
' 	AND (a.FECHA_CREACION = :P573_FECHA_HASTA OR :P573_FECHA_HASTA IS NULL)',
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(184949166760802513)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(184949996352802512)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(184950376998802512)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(68484167064692747)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(68484253384692748)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(68484382816692749)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(68484401710692750)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(185083452349060702)
...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'EDITAR:TIPO_SOLICITUD:SER_SOLICITUD:NRO_SOLICITUD:FEC_SOLICITUD:ESTADO:OPERACION:TIPO_COMPROBANTE:SERIE:COD_SUC_ENT:COD_SUC_SAL:MOTIVO_DESC:CANTIDAD:COD_ARTICULO:DESCRIPCION:NOMBRE:DOCUMENTO:'
