...
,p_last_upd_yyyymmddhh24miss=>'20230704144738'
);
...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'COD_CLIENTE:NOMBRE:DESCRIPCION_CIUDAD:VENTAS_FECHA_PERIODO:VENTAS_FECHA_PERIODO_ANT:OBJETIVO_VISITA:VISITA_AGENDADA:VISITAS_MARCADAS:FEC_ULTIMA_COMPRA:VENTA_VARIACION:COBERTURA:CODIGO_VENDEDOR:SEGMENTACION:LLAMAR:'
);
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(177717558618599480)
