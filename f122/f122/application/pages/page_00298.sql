...
,p_last_upd_yyyymmddhh24miss=>'20230925081910'
);
...
'',
'OUT_OUT(''P298_TIP_COMPROBANTE_REF ''|| :P298_TIP_COMPROBANTE_REF);',
'OUT_OUT(''P298_SER_COMPROBANTE_REF ''|| :P298_SER_COMPROBANTE_REF);',
'OUT_OUT(''P298_NRO_COMPROBANTE_REF ''|| :P298_NRO_COMPROBANTE_REF);',
'',
'',
'VTPEDAUT.PR_CREAR_COL_ARTICULOS (PI_COD_EMPRESA => :P_COD_EMPRESA,',
'                                 PI_TIP_COMPROBANTE => :P298_TIP_COMPROBANTE,',
