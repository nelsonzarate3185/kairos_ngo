...
,p_ajax_items_to_submit=>'P558_P_COD_ARTICULO,P558_P_BLOQUE,P558_P_SUB_BLOQUE,P558_P_NRO_COMPROBANTE,P558_P_COD_EMPRESA,P558_P_SER_COMPROBANTE,P558_P_TIP_COMPROBANTE'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
...
,p_is_default=>'Y'
,p_display_rows=>10
,p_report_columns=>'COD_SUCURSAL:DESC_SUCURSAL:NRO_COMPROBANTE:COD_ART_CORTO:COD_ARTICULO:DESC_ART:CANTIDAD_SISTEMA:CANTIDAD_INVENTARIO:COSTO_STOCK:COSTO_INVENTARIO:COSTO_PROM:USUARIO:ZONA:'
);
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(187637186307444091)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(187637564934444090)
,p_report_id=>wwv_flow_imp.id(178685587651329149)
...
'                        nvl(conteo4,',
'                            nvl(conteo5, nvl(conteo6, nvl(conteo7, conteo8))))))))',
'           ) CANTIDAD_inventario,NULL CORRESPONDE_BLOQUE',
'  from st_generacion_inventario     g,',
'       st_generacion_inventario_det gd,',
'       V_ARTICULOS_CPH                 a,',
'       sucursales@DBLINK_CPH                   s,',
...
'    order by 1  '))
,p_lov_display_null=>'YES'
,p_lov_cascade_parent_items=>'P558_P_BLOQUE'
,p_ajax_optimize_refresh=>'Y'
,p_cSize=>30
...
,p_attribute_03=>'P558_EJECUTAR_REPORTE_1,P558_EJECUTAR_REPORTE_2,P558_EJECUTAR'
,p_attribute_04=>'N'
