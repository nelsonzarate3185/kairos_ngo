...
,p_column_label=>'Ind Exc Almuerzo'
,p_column_type=>'STRING'
...
'          c006 REL_AUTORIZACION',
'',
'    INTO :P359_OBSERVACION, :P359_COD_EMPLEADO, :P359_COD_MOTIVO, :P359_REL_AUTORIZACION',
'',
'    FROM APEX_COLLECTIONS',
'    WHERE COLLECTION_NAME = ''RH_MOV_PERMISOS''',
...
'        		IF V_IND_DESCUENTO IS NULL THEN',
...
'',
'        END IF;',
'        ELSIF nvl(instr(V_REL_AUTORIZACION, ''*1*'', 1, 1 ), 0) > 0 then',
unistr('            :P359_MENSAJE := ''El movimiento ya fue aprobado en el primer nivel. ''|| 1 ||''Autorizaci\00F3n permisos'';'),
'        END IF;',
'    END IF;',
'',
'',
...
,p_name=>'DA_HABILITAR_PERMISOS'
,p_event_sequence=>60
,p_condition_element=>'P359_IND_AUTORIZA_MOV'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(101172151545670844)
,p_event_id=>wwv_flow_imp.id(101171936388670842)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(101172244674670845)
,p_event_id=>wwv_flow_imp.id(101171936388670842)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
