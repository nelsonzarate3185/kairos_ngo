...
,p_last_upd_yyyymmddhh24miss=>'20230920112937'
);
...
'         xfecha    varchar2( 50 ) ;',
'begin',
'   xfecha   := to_char( :P388_FEC_CANCELACION, ''DD/MM/YYYY'' ) ;',
...
'END;'))
,p_attribute_02=>'P388_TIP_COMPROBANTE,P_COD_EMPRESA,P388_IND_CHEQUE,P388_COD_BANCO'
...
'END;'))
,p_attribute_02=>'P388_CANT_CUOTAS,P388_INTERVALO,P388_FEC_INICIAL'
