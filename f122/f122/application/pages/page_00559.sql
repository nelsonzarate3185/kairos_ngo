...
,p_last_upd_yyyymmddhh24miss=>'20230807153714'
);
...
'round( ARTICULOS_CONTADOS_DIST*100/ARTICULOS_INVENTARIOS_DIS ,2)',
'else 0',
'  end   ',
' avance_sku , ',
' ',
' case when nvl(ARTICULOS_INVENTARIOS_CANT,0)>0 then ',
'round( ARTICULOS_CONTADOS_CANT*100/ARTICULOS_INVENTARIOS_CANT ,2)',
'else 0',
'  end  ',
'avance_cantidades',
'FROM(',
...
'  WHERE G.FEC_COMPROBANTE>SYSDATE-360',
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(188211381966298011)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(188211494452298012)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(188211510969298013)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(188211630643298014)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(188211758508298015)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(188211873270298016)
,p_db_column_name=>'AVANCE_CANTIDADES'
,p_display_order=>350
,p_column_identifier=>'AI'
,p_column_label=>'Avance Stock'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_format_mask=>'999G999G999G999G990D00'
,p_use_as_row_header=>'N'
