...
,p_name=>'Pedidos de Repuestos STA - CAREPSTA'
,p_alias=>'CAREPSTA'
,p_step_title=>'Pedidos de Repuestos STA'
...
,p_last_upd_yyyymmddhh24miss=>'20230111151849'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(76490556189626944)
,p_plug_name=>'Pedidos de Repuestos STA'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(77390696770894704)
...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'VER:SER_COMPROBANTE:NRO_COMPROBANTE:VNOM_CLIENTE:OBSERVACION:VCOD_ARTICULO:VDESC_GARANTIA:FEC_COMPROBANTE:HORA_ALTA:VESTADO_PREPA:IND_PICKEAR:P:'
);
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(78366392116948587)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(78366781226948587)
,p_report_id=>wwv_flow_imp.id(77407604745912785)
,p_name=>'CONFIRMADO'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(78367149673948588)
,p_report_id=>wwv_flow_imp.id(77407604745912785)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(78367571805948588)
,p_report_id=>wwv_flow_imp.id(77407604745912785)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(78367936545948588)
,p_report_id=>wwv_flow_imp.id(77407604745912785)
,p_name=>'PREPARADO'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(78368340563948588)
,p_report_id=>wwv_flow_imp.id(77407604745912785)
...
'',
'   where cp.cod_empresa = :P315_COD_EMPRESA  ',
...
,p_prompt=>'Retira de'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>'STATIC2:ARTIGAS;ARTIGAS,CDE;CDE,SLO;SLO'
,p_cHeight=>1
,p_begin_on_new_line=>'N'
,p_colspan=>3
,p_field_template=>wwv_flow_imp.id(40186634462263678)
...
'    CAREPSTA.PR_CARGA_COLECCION_PARAM(PI_COD_EMPRESA     => :P315_COD_EMPRESA,',
...
'END IF;',
''))
,p_attribute_02=>'P315_COD_EMPRESA,P315_CONDICION,P315_IND_DEVUELTO,P315_RETIRA,P315_TIPO_RETIRA,P315_PROVEEDOR,P315_ZONA,P315_ESTADO,P315_FECHA_INI,P315_FECHA_FIN,P315_ID_PICKING'
...
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'CAREPSTA.PR_CARGA_COLECCION_DETALLE(PI_COD_EMPRESA => :P315_COD_EMPRESA, ',
...
'                    PI_COD_EMPRESA => :P315_COD_EMPRESA);'))
...
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
':P315_TIT_REPORTE := CAREPSTA.cf_empresaFormula (PI_COD_EMPRESA => :P315_COD_EMPRESA);',
...
'BEGIN',
'    SELECT C013, C006, C021',
'      INTO VTIPO, VNRO_COMPROBANTE, VSER_COMPROBANTE',
'      FROM APEX_COLLECTIONS',
'     WHERE COLLECTION_NAME = ''PARAMETRO_CAREPSTA''',
'       AND SEQ_ID = :P315_PRS; ',
'',
...
'                                p_items  => ''P298_NRO_COMPROBANTE,P298_SER_COMPROBANTE'',',
'                                p_values => (''''||VNRO_COMPROBANTE||'',''||VSER_COMPROBANTE||'''')) f_url_1',
'          INTO :P315_URL',
'          FROM DUAL;',
'    END IF;',
'EXCEPTION',
'    WHEN OTHERS THEN',
'        APEX_dEBUG.ERROR(''Error al redireccioar desde PRS: ''||SQLERRM);  ',
'END;',
'',
''))
...
'             -- ''VTCONMAR'' ',
'            SELECT APEX_PAGE.GET_URL (  p_page   => 325,',
'                                        p_items  => ''P325_NRO_COMPROBANTE,P325_SER_COMPROBANTE'',',
'                                        p_values => (''''||VNRO_COMPROBANTE||'',''||VSER_COMPROBANTE||'''')) f_url_1',
'              INTO :P315_URL',
'              FROM DUAL;',
'          ',
...
'declare',
'   reloj    timer ;',
'   un_seg   number(7) := 640000 ;',
'begin',
'   reloj := find_timer( ''my_timer'' ) ;',
'   if id_null( reloj ) then',
'      reloj := create_timer( ''my_timer'', un_seg, repeat ) ;',
'   end if ;',
'end ;',
' */',
':P315_IND_DEVUELTO:=''N'';',
...
' 	a varchar2(500); ',
'BEGIN ',
' 	sp_inserta_PICKING_tmp(:P315_COD_EMPRESA, null, null, null, null, null, null, null, NULL, a,:P315_ID_PICKING);',
'END;',
'',
'CAREPSTA.PR_CARGA_COLECCION_PARAM(PI_COD_EMPRESA     => :P315_COD_EMPRESA,',
'                                  PI_CONDICION       => :P315_CONDICION,',
