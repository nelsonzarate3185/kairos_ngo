...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(206316049734015500)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(206316462987015499)
,p_report_id=>wwv_flow_imp.id(77407604745912785)
,p_name=>'CONFIRMADO'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(206316896059015499)
,p_report_id=>wwv_flow_imp.id(77407604745912785)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(206317200722015499)
,p_report_id=>wwv_flow_imp.id(77407604745912785)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(206317638542015498)
,p_report_id=>wwv_flow_imp.id(77407604745912785)
,p_name=>'PREPARADO'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(206318033273015498)
,p_report_id=>wwv_flow_imp.id(77407604745912785)
...
'BEGIN',
'    SELECT C013, C006, C021, C024 TIP_COMPROBANTE_REF, C025 SER_COMPROBANTE_REF,  C026 NRO_COMPROBANTE_REF',
'      INTO VTIPO, VNRO_COMPROBANTE, VSER_COMPROBANTE, V_TIP_COMPROBANTE_REF,V_SER_COMPROBANTE_REF,V_NRO_COMPROBANTE_REF',
'      FROM APEX_COLLECTIONS',
'     WHERE COLLECTION_NAME = ''PARAMETRO_CAREPSTA''',
'       AND SEQ_ID = :P315_PRS; ',
'',
