...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'CLIENTE:NRO_ORDEN:FEC_COMPROBANTE:TIPO_COMPROBANTE:SERIE:NRO_DOCUMENTO:SUCURSAL:TOTAL_COMPROBANTE:VER:IMPRIMIR:'
,p_sort_column_1=>'NRO_ORDEN'
,p_sort_direction_1=>'ASC'
,p_break_on=>'CLIENTE'
,p_break_enabled_on=>'CLIENTE'
);
