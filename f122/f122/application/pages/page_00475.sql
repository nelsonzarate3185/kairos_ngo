...
,p_last_upd_yyyymmddhh24miss=>'20230510090432'
);
...
,p_is_default=>'Y'
,p_display_rows=>10
,p_report_columns=>'EDITAR:ARTICULO:COD_ARTICULO:COD_SUCURSAL:COD_POSICION:COD_BLOQUE:COD_SUB_BLOQUE:COD_ESTANTE:COD_CUERPO:COD_NIVEL:ELIMINAR:'
);
wwv_flow_imp_page.create_page_plug(
...
'       a.cod_articulo R',
'from st_articulos a, ST_UBIC_ARTICULOS u',
...
'                apex_debug.error(''There is no data ''||sqlerrm);',
'        when others then',
...
,p_affected_elements=>'P475_COD_ARTICULO,P475_COD_POSICION,P475_NEW_COD_SUCURSAL,P475_COD_BLOQUE,P475_COD_SUB_BLOQUE,P475_COD_ESTANTE,P475_COD_CUERPO,P475_COD_NIVEL'
);
wwv_flow_imp_page.create_page_da_action(
...
'            when others then',
'                    apex_debug.error(''Error Desc_sucursal''||sqlerrm);',
'END;'))
...
'',
'            when no_data_found then',
'                    apex_debug.error(''Sucursal: ''||:P475_NEW_COD_SUCURSAL||'' Posicion ''||:P475_COD_POSICION||',
...
'           ',
'            when others then',
'                    apex_debug.error(''Error al enviar datos del cod_posicion ''||sqlerrm);',
'',
' END;',
''))
