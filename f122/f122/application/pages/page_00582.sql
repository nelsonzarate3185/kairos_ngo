...
,p_query_type=>'TABLE'
,p_query_table=>'RH_MOV_PERMISOS'
,p_query_where=>'cod_empleado = :P582_COD_EMPLEADO and cod_empresa = :P_COD_EMPRESA'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(93764216661731849)
...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'COD_EMPRESA:NRO_MOVIMIENTO:COD_EMPLEADO:IND_TIPO:COD_MOTIVO:FEC_INICIAL:FEC_FINAL:CANT_DIAS:HORA_INICIAL:HORA_FINAL:CANT_HORAS:OBSERVACION:IND_DESCUENTO:REL_AUTORIZACION:REL_RECHAZO:ESTADO:IND_EXC_ALMUERZO:PERIODO:COD_USR_INS:FEC_HOR_INS:COD_USR_UPD:'
||'FEC_HOR_UPD'
);
wwv_flow_imp_page.create_page_plug(
