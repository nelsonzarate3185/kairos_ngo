...
,p_last_upd_yyyymmddhh24miss=>'20230103172041'
);
...
,p_name=>'P282_SUCURSAL'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(118773533759770239)
,p_prompt=>'SUCURSAL'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select s.descripcion||''(''||s.cod_sucursal||'')'' suc, s.cod_sucursal',
'from sucursales s',
'where s.cod_empresa=''1''',
'and exists (',
'select distinct ''1''',
'from cp_vales c',
'where c.cod_empresa=s.cod_empresa',
...
,p_name=>'P282_CUENTA_CONTABLE'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(118773533759770239)
,p_prompt=>'Cuenta Contable'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  select referencia , S.NRO_CUENTA',
'         from cc_cuentas_bancarias S',
...
'                                  p_cuenta => :P282_CUENTA_CONTABLE,',
'                                  p_sucursal => :p282_sucursal,',
...
'end;',
' '))
,p_attribute_02=>'P282_SUCURSAL,P282_TIPO,P282_FECHA_INI,P282_ESTADO,P282_FECHA_FIN,P282_CUENTA_CONTABLE,P282_PERSONA'
...
,p_affected_elements=>'P282_SUCURSAL,P282_TIPO,P282_ESTADO,P282_FECHA_FIN,P282_FECHA_INI,P282_CUENTA_CONTABLE,P282_PERSONA,P282_SER_SOLICITUD,P282_NRO_SOLICITUD'
);
