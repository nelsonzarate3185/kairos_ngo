...
,p_last_upd_yyyymmddhh24miss=>'20230914150431'
);
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(204753744262882345)
...
,p_column_label=>'M'
,p_column_link=>'f?p=&APP_ID.:370:&SESSION.::&DEBUG.:370:P370_P_NRO_SERVICIO_PARAM,P370_P_TIP_SERVICIO_PARAM,P370_COD_CLIENTE,P370_COD_DISTRIBUIDOR:#NRO_PLANILLA#,''SU'',#CI_CLIENTE#,#COD_DISTRIBUIDOR#'
...
,p_column_label=>'P'
,p_column_link=>'f?p=&APP_ID.:329:&SESSION.::&DEBUG.:Y,329:P329_COD_CLIENTE:#COD_DISTRIBUIDOR#'
...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'VER:EDITAR:NRO_PLANILLA:FEC_PLANILLA:V_DISTRIBUIDOR:TELEFONO:CATEGORIA_PRODUCTO:V_FECHA_OT:FECHA_VISITA:ESTADO:MAINTENANCE:VISITAS:PROMOTORA:RETIRO:'
);
wwv_flow_imp_page.create_page_plug(
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(106965453435997921)
,p_plug_name=>'PIE_3'
,p_region_template_options=>'#DEFAULT#:t-Region--removeHeader:t-Region--noBorder:t-Region--scrollBody'
,p_plug_template=>wwv_flow_imp.id(40125238939263661)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(106965660858997923)
,p_plug_name=>'Datos de OT'
,p_parent_plug_id=>wwv_flow_imp.id(106965453435997921)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(106967750761997944)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(106965514524997922)
,p_plug_name=>'PIE_2'
,p_region_template_options=>'#DEFAULT#:t-Region--removeHeader:t-Region--noBorder:t-Region--scrollBody'
,p_plug_template=>wwv_flow_imp.id(40125238939263661)
...
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(106965453435997921)
...
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(106965514524997922)
...
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(106965660858997923)
,p_prompt=>'Serie'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_field_template=>wwv_flow_imp.id(40186634462263678)
...
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(106967750761997944)
,p_prompt=>'Fecha'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_begin_on_new_line=>'N'
...
,p_cSize=>30
,p_field_template=>wwv_flow_imp.id(40186634462263678)
,p_item_icon_css_classes=>'fa-alarm-times'
,p_item_template_options=>'#DEFAULT#'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
...
,p_read_only_when_type=>'ALWAYS'
,p_field_template=>wwv_flow_imp.id(40186634462263678)
,p_item_icon_css_classes=>'fa-calendar-edit'
,p_item_template_options=>'#DEFAULT#'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
...
'    EXCEPTION',
'        when OTHERS then',
'        APEX_DEBUG.ERROR (''DA_REFRESH: ''||SQLERRM);',
'END;'))
