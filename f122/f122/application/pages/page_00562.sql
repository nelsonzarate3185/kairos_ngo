...
,p_last_upd_yyyymmddhh24miss=>'20230801151136'
);
...
'               NULL HORARIO,',
'               NULL ZONA,',
'               NULL COSTO_INVENTARIO,',
'               NULL CANTIDAD_inventario,',
'               null estado_ot,',
'               null fecha_ingreso,',
'               null fecha_cierre,',
'               null fecha_entrega,',
...
'                                         g.cod_sucursal,',
'                                         TO_CHAR(NVL(G.FECHA_ACTUALIZA,',
'                                                     g.fec_comprobante),',
'                                                 ''DD/MM/YYYY HH24:MI:SS''),',
'                                         TO_CHAR(nvl(g.fecha_cierre,',
'                                                     trunc(sysdate)),',
'                                                 ''DD/MM/YYYY HH24:MI:SS''),',
'                                         gd.cod_articulo)',
'                 ELSE',
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(187366777028765317)
,p_db_column_name=>'C2'
,p_display_order=>420
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(187366805422765318)
,p_db_column_name=>'C3'
,p_display_order=>430
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(187366959512765319)
,p_db_column_name=>'C4'
,p_display_order=>440
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(187367022410765320)
,p_db_column_name=>'C5'
,p_display_order=>450
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(187367192698765321)
,p_db_column_name=>'C6'
,p_display_order=>460
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(187367221477765322)
,p_db_column_name=>'C7'
,p_display_order=>470
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(187367386512765323)
,p_db_column_name=>'C8'
,p_display_order=>480
...
,p_is_default=>'Y'
,p_display_rows=>5
,p_report_columns=>'DESC_SUCURSAL:COD_SUCURSAL:COD_ARTICULO:DESC_ART:CANTIDAD_SISTEMA:C1:CU:COSTO_STOCK:NRO_COMPROBANTE:SUCURSAL:COD_ART_CORTO:NRO_OT:ENTRADA:SALIDA:COSTO_PROM:OBSERVACION:USUARIO:ZONA:COSTO_INVENTARIO:CANTIDAD_INVENTARIO:ESTADO_OT:FECHA_INGRESO:FECHA_CI'
||'ERRE:FECHA_ENTREGA:ANTIGUEDAD:GARANTIA_OT:UBICACION:CONDICION:DEPARTAMENTO:CIUDAD:TIPO_CIERE:SNC'
);
wwv_flow_imp_page.create_page_plug(
