...
,p_last_upd_yyyymmddhh24miss=>'20230918104541'
);
...
'IF  TRIM(:P141_NRO_REF) IS NULL AND TRIM(:P141_GARANTIA) IS NULL  THEN',
'        RETURN '' Debe cargar el Nro OT y/o Nro Garantia'';',
'END IF;'))
,p_validation2=>'PLSQL'
,p_validation_type=>'FUNC_BODY_RETURNING_ERR_TEXT'
,p_always_execute=>'Y'
,p_validation_condition=>'P141_CAMPANIA'
,p_validation_condition2=>'15'
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_imp.id(19649697720538234)
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(195731906495446447)
,p_validation_name=>'VA_FEC_PROX_CONTACTO'
,p_validation_sequence=>70
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'IF nvl(to_date(:P141_PROXIMO_CONTACTO,''DD/MM/YYYY''),sysdate)<trunc(sysdate) THEN',
'    RETURN ''Fecha de Proxima Visita debe cargar correctamente.'';',
'END IF;'))
,p_validation2=>'PLSQL'
,p_validation_type=>'FUNC_BODY_RETURNING_ERR_TEXT'
,p_always_execute=>'Y'
,p_when_button_pressed=>wwv_flow_imp.id(19649697720538234)
,p_associated_item=>wwv_flow_imp.id(19647389673538232)
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(195732048456446448)
,p_validation_name=>'va_fecha_compra'
,p_validation_sequence=>80
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'IF nvl(to_date(:P141_FECHA_COMPRA,''DD/MM/YYYY''),sysdate+1)>trunc(sysdate) THEN',
'    RETURN ''Debe cargar correctamente la Fecha de Compra.'';',
'END IF;'))
,p_validation2=>'PLSQL'
,p_validation_type=>'FUNC_BODY_RETURNING_ERR_TEXT'
,p_validation_condition=>'P141_FECHA_COMPRA'
,p_validation_condition_type=>'ITEM_IS_NOT_NULL'
,p_associated_item=>wwv_flow_imp.id(118930252905854127)
