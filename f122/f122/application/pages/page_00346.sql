...
'        INTO :P346_COD_CUSTODIO_FAC, :P346_DESCRIPCION_CUSTODIO_FAC',
'        FROM usuarios u, cc_custodios c',
'       WHERE u.cod_empresa = :P_COD_EMPRESA',
'         AND u.cod_usuario = :P346_COD_USUARIO',
...
'       AND nvl(codigo_usuario,:P346_COD_USUARIO) = :P346_COD_USUARIO',
...
'END;',
''))
,p_attribute_02=>'P346_SEQ_ID_PLANILLA_DETALLE,P346_COD_SUCURSAL_REPARTO,P_COD_EMPRESA,APP_USER,P346_P_TIPO_ENTREGA,P346_COD_USUARIO,P_COD_SUCURSAL'
...
||'AL_FAC,P346_DESCRIPCION_CUSTODIO_FAC,P346_P_TIPO_PEDIDO,P346_ESTADO_PLANILLA'
,p_attribute_04=>'N'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
