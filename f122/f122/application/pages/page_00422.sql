...
,p_last_upd_yyyymmddhh24miss=>'20230314125201'
);
...
'AND CC.NRO_COMPROBANTE_REF=VP.NRO_COMPROBANTE ),''N'')GUARDA',
...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'COD_SUC_SAL:DESC_SUC_SAL:COD_ARTICULO:DESC_ARTICULO:CANTIDAD:COD_CLIENTE:NOMBRE:FEC_COMPROBANTE:TIP_COMPROBANTE:SER_COMPROBANTE:NRO_COMPROBANTE:NRO_OT:CANT_FACT:SERIE_FACTURA:NUMERO_FACTURA:TIP_COMPROBANTE_REF:COD_RUBRO:GUARDA'
);
wwv_flow_imp_page.create_page_plug(
