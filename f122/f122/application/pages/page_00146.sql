...
,p_last_upd_yyyymmddhh24miss=>'20230629150725'
);
...
'              AND( S.cod_rubro in (''DP'',''PU'',''PMO'',''RPG'') or s.cod_articulo=''00''))',
...
||'ADMINISTRACION;ADMINISTRACION,OPERACIONES;OPERACIONES,ALMACENAMIENTO;ALMACENAMIENTO,TIC;TIC'
,p_lov_display_extra=>false
,p_lov_display_null=>true
,p_enable_filter=>true
,p_filter_operators=>'C:S:CASE_INSENSITIVE:REGEXP'
...
,p_column_link=>'f?p=&APP_ID.:146:&SESSION.::&DEBUG.::P146_ROWID_B,P146_ACCION:#ROWID#,BSMENSAJ'
...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'EDITAR:TIPO_SOLICITUD:SER_SOLICITUD:NRO_SOLICITUD:FEC_SOLICITUD:ESTADO:OPERACION:TIPO_COMPROBANTE:SERIE:COD_SUC_ENT:COD_SUC_SAL:MOTIVO_DESC:'
...
,p_button_plug_id=>wwv_flow_imp.id(19174019260232420)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(20085725939992230)
,p_name=>'P146_ROWID_B'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(19176273702232442)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_item(
...
'       A.COD_MOTIVO',
'  FROM PROBLEMAS_CONFORMIDAD A, ',
'       CA_DEPARTAMENTO_MOTIVO_SNC Z',
' WHERE A.COD_EMPRESA = ''1''',
'   AND A.COD_EMPRESA = Z.COD_EMPRESA',
'   AND NVL(ESTADO, ''N'') = ''S''',
'   AND ''ADMINISTRACION'' = Z.COD_AREA',
...
'	   AND NVL(ESTADO,''N'')=''S''',
'     AND :P146_TIPO_COMPROBANTE != ''OT'''))
,p_lov_cascade_parent_items=>'P146_TIPO_COMPROBANTE'
...
' WHERE R.COD_EMPRESA = 1--:VARIABLES.COD_EMPRESA',
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(21757783751052313)
,p_name=>'Cambiar_Rowid_B'
,p_event_sequence=>40
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P146_ROWID_B'
,p_bind_type=>'bind'
,p_bind_event_type=>'change'
,p_display_when_type=>'NEVER'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(21757823752052314)
,p_event_id=>wwv_flow_imp.id(21757783751052313)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SUBMIT_PAGE'
...
'',
'                                  :P146_COSTO_REV_DET := TO_CHAR(D.COSTO_REV,''999G999G999G999G999G999G990'');',
'                                  :P146_PRECIO_ARTICULO := TO_CHAR(D.COSTO_ART,''999G999G999G999G999G999G990'');',
...
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
,p_attribute_01=>':P146_SEQ_ID_DET := :SEQ_ID;'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(52978841238988131)
...
'IF :P146_IND_DETALLE =''N'' and :P146_ESTADO not in (''RECHAZADO'')THEN  	',
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(48372122762792520)
...
'  set  C.TIPO_SOLICITUD        = :P146_TIPO_SOLICITUD,',
'       C.SER_SOLICITUD         = :P146_SER_SOLICITUD,',
'       C.NRO_SOLICITUD         = :P146_NRO_SOLICITUD,',
'       C.COD_SUCURSAL          = nvl(:P146_COD_SUCURSAL,:P146_COD_SUCURSAL_AUX),',
