...
,p_last_upd_yyyymmddhh24miss=>'20230918111833'
);
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(195730396262446431)
,p_button_sequence=>120
,p_button_plug_id=>wwv_flow_imp.id(56175561042949580)
,p_button_name=>'VER_OT'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#:t-Button--large:t-Button--gapTop'
,p_button_template_id=>wwv_flow_imp.id(40187078917263678)
,p_button_image_alt=>'Ver OT'
,p_button_redirect_url=>'f?p=&APP_ID.:588:&SESSION.::&DEBUG.::P588_NRO_COMPROBANTE:&P145_NRO_ORT.'
...
'IF :P145_BLOQUEADO=''N'' THEN',
'    IF :P145_USER_AREA=:P145_AREA_DERIVADA OR :P145_USER_COD_EMP = :P145_EMPLEADO_DERIVADO THEN',
'        RETURN TRUE;',
'    ELSE',
'        RETURN FALSE;',
'    END IF;',
...
,p_ajax_items_to_submit=>'P145_SUCURSAL_DERIVADA'
...
,p_ajax_items_to_submit=>'P145_COD_EMPRESA,P145_SUCURSAL_DERIVADA,P145_AREA_DERIVADA'
,p_ajax_optimize_refresh=>'Y'
,p_cSize=>30
,p_begin_on_new_line=>'N'
,p_colspan=>3
...
,p_ajax_items_to_submit=>'P_COD_EMPRESA,P145_SUCURSAL_DERIVADA,P145_AREA_DERIVADA,P145_DPTO_DERIVADO'
,p_ajax_optimize_refresh=>'Y'
,p_cSize=>30
,p_cMaxlength=>10
,p_begin_on_new_line=>'N'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(195730864269446436)
,p_name=>'P145_USER_AREA'
,p_item_sequence=>20
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(195730968907446437)
,p_name=>'P145_USER_COD_EMP'
,p_item_sequence=>30
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
...
,p_when_button_pressed=>wwv_flow_imp.id(19678283389549335)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(195730479853446432)
,p_name=>'da_load'
,p_event_sequence=>20
,p_condition_element=>'P145_ROWID'
,p_triggering_condition_type=>'NOT_NULL'
,p_bind_type=>'bind'
,p_bind_event_type=>'ready'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(195730534394446433)
,p_event_id=>wwv_flow_imp.id(195730479853446432)
,p_event_result=>'TRUE'
...
' ',
'$(''#P145_SUCURSAL_DERIVADA_CONTAINER'').css(''pointer-events'',''none''); ',
'$(''#P145_AREA_DERIVADA_CONTAINER'').css(''pointer-events'',''none''); ',
'$(''#P145_DPTO_DERIVADO_CONTAINER'').css(''pointer-events'',''none'');',
'$(''#P145_EMPLEADO_DERIVADO_CONTAINER'').css(''pointer-events'',''none'');'))
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(195731261161446440)
,p_event_id=>wwv_flow_imp.id(195730479853446432)
...
'                  and    c.cod_campania=''15''',
'                 ;',
' ',
' ',
'exception',
'    when others then',
'        :P145_SUCURSAL_DERIVADA:=null;',
'        :P145_AREA_DERIVADA :=null;',
'        :P145_DPTO_DERIVADO :=null;',
'        :P145_EMPLEADO_DERIVADO :=null;',
'        :P145_MOTIVO_DERIVACION :=null;',
'        :P145_AREA_DERIVA :=null;',
'        :P145_RESPONSABLE :=null;',
'        :P145_NRO_ORT :=null;',
'        :P145_GARANTIA :=null;',
' end; '))
,p_attribute_02=>'P145_ID_CASO'
,p_attribute_03=>'P145_SUCURSAL_DERIVADA,P145_AREA_DERIVADA,P145_DPTO_DERIVADO,P145_EMPLEADO_DERIVADO, P145_MOTIVO_DERIVACION,P145_AREA_DERIVA, P145_RESPONSABLE,P145_NRO_ORT, P145_GARANTIA'
,p_attribute_04=>'N'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(195731339754446441)
,p_event_id=>wwv_flow_imp.id(195730479853446432)
,p_event_result=>'FALSE'
,p_action_sequence=>30
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_attribute_01=>'document.getElementById("P145_OBS_REC").readOnly=true;'
);
...
'',
'Begin',
'    UPDATE CRM_DERIVACIONES_CONTACTO',
'    SET OPERADOR_REC = :APP_USER,',
'        FECHA_REC = SYSDATE ,',
'        ESTADO = 3',
'    where id_caso= :P145_ID_CASO',
'    and id_contacto= :P145_ID_CONTACTO',
...
,p_process_when_type=>'REQUEST_IN_CONDITION'
,p_process_success_message=>'Indique los datos a derivar.'
);
...
' ',
' begin',
'    SELECT E.COD_EMPLEADO,E.COD_AREA   ',
'    into   :P145_USER_COD_EMP  ,   :P145_USER_AREA           ',
...
' exception',
'    when others then',
'        :P145_USER_AREA :=:app_user;',
'        :P145_USER_COD_EMP:=:P_COD_EMPRESA;',
' end;'))
,p_process_clob_language=>'PLSQL'
);
wwv_flow_imp.component_end;
