...
,p_last_upd_yyyymmddhh24miss=>'20230913170203'
);
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(195732193881446449)
,p_name=>'P442_CAMPANIA'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_imp.id(354766283281606385)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
...
'                            :P442_RESPONSABLE,:P442_COD_ARTICULO, ',
'                            :P442_GARANTIA, :P442_OBSERVACION, :P442_CONDICION',
'                            ,:P442_NRO_BOLETA_AMARILLA, :P442_TELEFONO',
...
,p_attribute_03=>'P442_COD_CLIENTE, P442_CLIENTE,P442_FECHA,P442_HORA,P442_OBSERVACION,P442_NRO_BOLETA_AMARILLA,P442_TELEFONO,P442_DIRECCION,P442_REFERENCIA_UBI,P442_DESC_ARTICULO, P442_COD_DISTRIBUIDOR,P442_NCI,P442_COD_ARTICULO,P442_CAMPANIA'
,p_attribute_04=>'N'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
...
'$(''#P442_RESPONSABLE_CONTAINER'').css(''pointer-events'',''none'');'))
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(195732214034446450)
,p_name=>'da_servtec'
,p_event_sequence=>160
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P442_CAMPANIA'
,p_condition_element=>'P442_CAMPANIA'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(205930564009706801)
,p_event_id=>wwv_flow_imp.id(195732214034446450)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
