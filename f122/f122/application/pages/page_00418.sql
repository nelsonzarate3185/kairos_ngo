...
,p_last_upd_yyyymmddhh24miss=>'20230308171504'
);
...
'select vt.TIP_COMPROBANTE,vt.SER_COMPROBANTE,vt.NRO_COMPROBANTE,vt.FEC_COMPROBANTE,(SELECT DESCRIPCION',
'FROM SUCURSALES',
...
,p_column_link=>'f?p=&APP_ID.:371:&SESSION.::&DEBUG.:RP,371:P371_NRO_COMPROBANTE,P371_SER,P371_COMPROBANTE:#NRO_COMPROBANTE#,#SER_COMPROBANTE#,#TIP_COMPROBANTE#'
