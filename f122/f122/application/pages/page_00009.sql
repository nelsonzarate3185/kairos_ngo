...
,p_last_upd_yyyymmddhh24miss=>'20230927153418'
);
...
'       NULL ELIMINAR,',
'       (inv.vtpedido.fn_agrega_estilos(p_ser_comprobante    => :P9_SER_COMPROBANTE_CAB,',
'                                              p_nro_comprobante   => :P9_NRO_COMPROBANTE,',
'                                              p_cod_articulo       => C001,',
'                                              p_cantidad           => to_number(replace(c002,  ''.'')),',
'                                              p_cab_estado         => :P9_ESTADO,',
'                                              p_cod_motivo_anu     => c028,',
'                                              p_cantidad_facturada => to_number(replace(c002,  ''.'')))) situ',
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(64603600005457135)
,p_db_column_name=>'SITU'
,p_display_order=>120
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(64603786890457136)
,p_name=>'P9_ESTADO'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(41221509928563115)
,p_display_as=>'NATIVE_HIDDEN'
...
unistr('            raise_application_error(-20000, ''El cliente debe estar ACTIVO. Favor comun\00EDquese con el departamento de Riesgos para solicitar el cambio de estado del cliente. '');'),
'		end if;',
'		--',
'		begin',
'			select d.detalle,',
...
'                                     VALUES(:P9_COD_EMPRESA_CAB,:P9_COD_SUCURSAL,:P9_COD_SUCURSAL_ENT,:P9_TIP_COMPROBANTE,:P9_SER_COMPROBANTE_CAB,',
...
'                                        VALUES(:P9_COD_EMPRESA_CAB,:P9_TIP_COMPROBANTE,:P9_SER_COMPROBANTE_CAB,TO_NUMBER(:P9_NRO_COMPROBANTE),CC.COD_ARTICULO,:P9_DESCRIPCION,TO_NUMBER(CC.CANTIDAD),TO_NUMBER(CC.PRECIO_UNITARIO),TO_NUMBER(CC.PORC_DESCU'
||'ENTO),TO_NUMBER(CC.MONTO_TOTAL),CC.IND_OFERTA,CC.IND_PROMO,TO_NUMBER(CC.NRO_PROMO)); ',
'        END LOOP;        ',
'        :P0_MENSAJE := ''El Nro. de Pedido generado es: ''||:P9_NRO_COMPROBANTE;',
'    ELSIF VNROCOMPROBANTE = 1 THEN',
'        :P0_MENSAJE := ''Se ha modificado el Nro. de Pedido: ''||:P9_NRO_COMPROBANTE;',
...
'          AND COD_EMPRESA = :P9_COD_EMPRESA_VA;',
'',
...
'        LOOP            ',
'            INSERT INTO VT_PEDIDOS_DETALLE_REP(COD_EMPRESA,TIP_COMPROBANTE,SER_COMPROBANTE,NRO_COMPROBANTE,COD_ARTICULO,DESCRIPCION,CANTIDAD,PRECIO_UNITARIO,PORC_DESCUENTO,MONTO_TOTAL,IND_OFERTA,IND_PROMO,NRO_PROMO)',
'                                        VALUES(:P9_COD_EMPRESA_CAB,:P9_TIP_COMPROBANTE,:P9_SER_COMPROBANTE_CAB,:P9_NRO_COMPROBANTE,CC.COD_ARTICULO,:P9_DESCRIPCION,CC.CANTIDAD,CC.PRECIO_UNITARIO,CC.PORC_DESCUENTO,CC.MONTO_TOTAL,CC.IND_OFERTA,CC.IND_PR'
||'OMO,CC.NRO_PROMO); ',
'        END LOOP;      ',
'                   ',
'     END IF;',
