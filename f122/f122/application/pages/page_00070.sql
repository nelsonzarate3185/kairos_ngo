...
,p_last_upd_yyyymmddhh24miss=>'20230721092819'
);
...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'TIPO:VENTA:COSTO_TOTAL:UTILIDAD:MARGEN:MARKUP:'
);
wwv_flow_imp_page.create_page_plug(
...
,p_is_default=>'Y'
,p_view_mode=>'REPORT'
,p_report_columns=>'FEC_FACTURA:TIP_COMPROBANTE:SER_COMPROBANTE:NRO_COMPROBANTE:FEC_PEDIDO:NRO_PEDIDO:COD_CLIENTE:NOMBRE:COD_ART_CORTO:COD_ARTICULO:DESC_ARTICULO:CANTIDAD:MONTO:MONTO_TOTAL_C_IVA:VOLUMEN:COD_VENDEDOR:NOMBRE_VENDEDOR:'
,p_chart_type=>'bar'
...
wwv_flow_imp_page.create_worksheet_group_by(
 p_id=>wwv_flow_imp.id(107206673342604374)
...
wwv_flow_imp_page.create_worksheet_pivot_sort(
 p_id=>wwv_flow_imp.id(107207703687604375)
,p_pivot_id=>wwv_flow_imp.id(107206957154604375)
,p_sort_seq=>1
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(13059761761503091)
...
,p_triggering_button_id=>wwv_flow_imp.id(13059761761503091)
,p_bind_type=>'bind'
