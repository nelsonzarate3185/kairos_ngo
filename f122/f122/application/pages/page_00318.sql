...
,p_last_upd_yyyymmddhh24miss=>'20230109102552'
);
...
'AND cod_empresa = :P318_COD_EMPRESA',
...
'       (:P318_VISUAL=''M'' and TO_CHAR(aa.fec_visita,''MM'')=TO_CHAR(sysdate,''MM'')) or   ',
'       (:P318_VISUAL=''S'' and TO_CHAR(aa.fec_visita,''WW'')=TO_CHAR(sysdate,''WW'')) or ',
'       (:P318_VISUAL=''T'') ',
'    )',
'',
'AND ( ',
...
'    )',
'',
'AND (FEC_VISITA >= TO_DATE(:P318_FECHA_INI,''DD/MM/YYYY'') OR :P318_FECHA_INI IS NULL )',
'AND (FEC_VISITA <= TO_DATE(:P318_FECHA_FIN,''DD/MM/YYYY'') OR :P318_FECHA_FIN IS NULL )',
...
,p_ajax_items_to_submit=>'P318_ZONA, P318_SER_OT, P318_CLIENTE,P318_VER_REAG, P318_FECHA_FIN, P318_FECHA_INI, P318_COD_ESTADO, P318_VISUAL,P318_COD_TECNICO, P318_COD_EMPRESA,P318_EJECUTAR_REPORTE,P318_ESTADO'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(78061950781098212)
,p_db_column_name=>'TO_CHAR(FEC_VISITA,''DAY'')'
,p_display_order=>20
...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'VER:FEC_VISITA:TO_CHAR(FEC_VISITA,''DAY''):HORA_VISITA:TIP_COMPROBANTE:SER_COMPROBANTE:NRO_COMPROBANTE:COD_CLIENTE:MOTIVO_VISITA:DETALLE:DIR:ENCUESTA:'
);
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(79289000429524366)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(79289468849524367)
,p_report_id=>wwv_flow_imp.id(77611528485724276)
,p_name=>'Pendiente'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(79289866624524367)
,p_report_id=>wwv_flow_imp.id(77611528485724276)
,p_name=>'Finalizado'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
