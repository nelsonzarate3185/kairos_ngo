...
,p_last_upd_yyyymmddhh24miss=>'20230904104408'
);
...
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'SER_RECIBO:NRO_RECIBO:FEC_RECIBO:COD_CLIENTE:NOM_CLIENTE:TOT_RECIBO:'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(201021310521310108)
,p_plug_name=>'Planilla Monedas'
,p_parent_plug_id=>wwv_flow_imp.id(199542487007478407)
,p_region_template_options=>'#DEFAULT#:t-Region--removeHeader:t-Region--scrollBody'
,p_plug_template=>wwv_flow_imp.id(40125238939263661)
...
,p_display_as=>'NATIVE_POPUP_LOV'
,p_named_lov=>'LV_CLIENTES_CCAUTREC'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(199542570204478408)
